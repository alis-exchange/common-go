...
type Service struct {
	...
	Types []*protobuf.Type `protobuf:"bytes,4,rep,name=types,proto3" json:"types,omitempty"`
	...
	Enums []*protobuf.Enum `protobuf:"bytes,5,rep,name=enums,proto3" json:"enums,omitempty"`
	...
	ConfigVersion *protobuf.UInt32Value `protobuf:"bytes,20,opt,name=config_version,json=configVersion,proto3" json:"config_version,omitempty"`
...
func (x *Service) GetApis() []*protobuf.Api {
	if x != nil {
		return x.Apis
	}
	return nil
...
func (x *Service) GetTypes() []*protobuf.Type {
	if x != nil {
		return x.Types
	}
	return nil
...
func (x *Service) GetEnums() []*protobuf.Enum {
	if x != nil {
		return x.Enums
	}
	return nil
...
func (x *Service) GetConfigVersion() *protobuf.UInt32Value {
	if x != nil {
...
const file_google_api_service_proto_rawDesc = "" +
	...
	"publishing\x12C\n" +
	"\x0econfig_version\x18\x14 \x01(\v2\x1c.google.protobuf.UInt32ValueR\rconfigVersionBH\n" +
	"\x0ecom.google.apiB\fServiceProtoP\x01Z\x1fgo.alis.build/common/google/api\xa2\x02\x04GAPIb\x06proto3"
...
var file_google_api_service_proto_goTypes = []any{
	...
	(*protobuf.Api)(nil),                // 1: google.protobuf.Api
	(*protobuf.Type)(nil),               // 2: google.protobuf.Type
	(*protobuf.Enum)(nil),               // 3: google.protobuf.Enum
	...
	(*protobuf.UInt32Value)(nil),        // 22: google.protobuf.UInt32Value
}
