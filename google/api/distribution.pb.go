...
type Distribution_Exemplar struct {
	...
	Timestamp *protobuf.Timestamp `protobuf:"bytes,2,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
	...
	Attachments   []*protobuf.Any `protobuf:"bytes,3,rep,name=attachments,proto3" json:"attachments,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Distribution_Exemplar) GetTimestamp() *protobuf.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *Distribution_Exemplar) GetAttachments() []*protobuf.Any {
	if x != nil {
...
const file_google_api_distribution_proto_rawDesc = "" +
	...
	"\vattachments\x18\x03 \x03(\v2\x14.google.protobuf.AnyR\vattachmentsBM\n" +
	"\x0ecom.google.apiB\x11DistributionProtoP\x01Z\x1fgo.alis.build/common/google/api\xa2\x02\x04GAPIb\x06proto3"
