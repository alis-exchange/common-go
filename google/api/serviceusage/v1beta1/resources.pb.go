...
const file_google_api_serviceusage_v1beta1_resources_proto_rawDesc = "" +
	...
	"\rquota_buckets\x18\t \x03(\v2,.google.api.serviceusage.v1beta1.QuotaBucketR\fquotaBuckets\"\x89\x04\n" +
	"\vQuotaBucket\x12'\n" +
	...
	"\x0eadmin_override\x18\x05 \x01(\v2..google.api.serviceusage.v1beta1.QuotaOverrideR\radminOverride\x12\\\n" +
	"\n" +
	...
	"\toverrides\x18\x01 \x03(\v2..google.api.serviceusage.v1beta1.QuotaOverrideR\toverrides\"\xb5\x02\n" +
	...
	"\"LIMIT_DECREASE_PERCENTAGE_TOO_HIGH\x10\x02B\xd6\x01\n" +
	"#com.google.api.serviceusage.v1beta1B\x0eResourcesProtoP\x01Z4go.alis.build/common/google/api/serviceusage/v1beta1\xaa\x02\x1fGoogle.Api.ServiceUsage.V1Beta1\xca\x02\x1fGoogle\\Api\\ServiceUsage\\V1beta1\xea\x02\"Google::Api::ServiceUsage::V1beta1b\x06proto3"
...
var file_google_api_serviceusage_v1beta1_resources_proto_goTypes = []any{
	...
	(*protobuf.Api)(nil),                    // 16: google.protobuf.Api
	(*api.Documentation)(nil),               // 17: google.api.Documentation
	(*api.Quota)(nil),                       // 18: google.api.Quota
	(*api.Authentication)(nil),              // 19: google.api.Authentication
	(*api.Usage)(nil),                       // 20: google.api.Usage
	(*api.Endpoint)(nil),                    // 21: google.api.Endpoint
	(*api.MonitoredResourceDescriptor)(nil), // 22: google.api.MonitoredResourceDescriptor
	(*api.Monitoring)(nil),                  // 23: google.api.Monitoring
}
