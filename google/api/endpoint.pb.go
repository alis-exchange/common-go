...
const file_google_api_endpoint_proto_rawDesc = "" +
	...
	"\aaliases\x18\x02 \x03(\tB\x02\x18\x01R\aaliases\x12\x16\n" +
	"\x06target\x18e \x01(\tR\x06target\x12\x1d\n" +
	"\n" +
	"allow_cors\x18\x05 \x01(\bR\tallowCorsBI\n" +
	"\x0ecom.google.apiB\rEndpointProtoP\x01Z\x1fgo.alis.build/common/google/api\xa2\x02\x04GAPIb\x06proto3"
