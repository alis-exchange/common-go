...
const file_google_api_expr_v1beta1_decl_proto_rawDesc = "" +
	...
	"returnType\x12+\n" +
	"\x11receiver_function\x18\x03 \x01(\bR\x10receiverFunctionB[\n" +
	"\x1bcom.google.api.expr.v1beta1B\tDeclProtoP\x01Z,go.alis.build/common/google/api/expr/v1beta1\xf8\x01\x01b\x06proto3"
