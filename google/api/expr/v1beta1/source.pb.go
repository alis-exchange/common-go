...
const file_google_api_expr_v1beta1_source_proto_rawDesc = "" +
	...
	"\x06column\x18\x04 \x01(\x05R\x06columnB]\n" +
	"\x1bcom.google.api.expr.v1beta1B\vSourceProtoP\x01Z,go.alis.build/common/google/api/expr/v1beta1\xf8\x01\x01b\x06proto3"
