...
func (x *Constant) GetNullValue() protobuf.NullValue {
	if x != nil {
		if x, ok := x.ConstantKind.(*Constant_NullValue); ok {
			return x.NullValue
		}
	}
	return protobuf.NullValue(0)
}
...
func (x *Constant) GetDurationValue() *protobuf.Duration {
	if x != nil {
...
// Deprecated: Marked as deprecated in google/api/expr/v1alpha1/syntax.proto.
func (x *Constant) GetTimestampValue() *protobuf.Timestamp {
	if x != nil {
...
type Constant_NullValue struct {
	// null value.
	NullValue protobuf.NullValue `protobuf:"varint,1,opt,name=null_value,json=nullValue,proto3,enum=google.protobuf.NullValue,oneof"`
}
...
type Constant_DurationValue struct {
	...
	//
	// Deprecated: Marked as deprecated in google/api/expr/v1alpha1/syntax.proto.
	DurationValue *protobuf.Duration `protobuf:"bytes,8,opt,name=duration_value,json=durationValue,proto3,oneof"`
}
...
type Constant_TimestampValue struct {
	...
	//
	// Deprecated: Marked as deprecated in google/api/expr/v1alpha1/syntax.proto.
	TimestampValue *protobuf.Timestamp `protobuf:"bytes,9,opt,name=timestamp_value,json=timestampValue,proto3,oneof"`
}
...
const file_google_api_expr_v1alpha1_syntax_proto_rawDesc = "" +
	...
	"\x06column\x18\x04 \x01(\x05R\x06columnB_\n" +
	"\x1ccom.google.api.expr.v1alpha1B\vSyntaxProtoP\x01Z-go.alis.build/common/google/api/expr/v1alpha1\xf8\x01\x01b\x06proto3"
...
var file_google_api_expr_v1alpha1_syntax_proto_goTypes = []any{
	...
	(protobuf.NullValue)(0),         // 14: google.protobuf.NullValue
