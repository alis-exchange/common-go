...
func (x *Value) GetNullValue() protobuf.NullValue {
	if x != nil {
...
func (x *Value) GetObjectValue() *protobuf.Any {
	if x != nil {
...
type Value_ObjectValue struct {
	...
	ObjectValue *protobuf.Any `protobuf:"bytes,10,opt,name=object_value,json=objectValue,proto3,oneof"`
}
...
const file_google_api_expr_v1alpha1_value_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v2\x1f.google.api.expr.v1alpha1.ValueR\x05valueB^\n" +
	"\x1ccom.google.api.expr.v1alpha1B\n" +
	"ValueProtoP\x01Z-go.alis.build/common/google/api/expr/v1alpha1\xf8\x01\x01b\x06proto3"
...
var file_google_api_expr_v1alpha1_value_proto_goTypes = []any{
	...
	(protobuf.NullValue)(0), // 5: google.protobuf.NullValue
