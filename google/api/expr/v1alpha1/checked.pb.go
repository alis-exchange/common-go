...
func (x *Type) GetDyn() *protobuf.Empty {
	if x != nil {
...
func (x *Type) GetNull() protobuf.NullValue {
	if x != nil {
...
func (x *Type) GetError() *protobuf.Empty {
	if x != nil {
...
type Type_Dyn struct {
	// Dynamic type.
	Dyn *protobuf.Empty `protobuf:"bytes,1,opt,name=dyn,proto3,oneof"`
}

type Type_Null struct {
	// Null value.
	Null protobuf.NullValue `protobuf:"varint,2,opt,name=null,proto3,enum=google.protobuf.NullValue,oneof"`
}
...
type Type_Error struct {
	...
	Error *protobuf.Empty `protobuf:"bytes,12,opt,name=error,proto3,oneof"`
}
...
const file_google_api_expr_v1alpha1_checked_proto_rawDesc = "" +
	...
	"overloadId\x128\n" +
	"\x05value\x18\x04 \x01(\v2\".google.api.expr.v1alpha1.ConstantR\x05valueB]\n" +
	"\x1ccom.google.api.expr.v1alpha1B\tDeclProtoP\x01Z-go.alis.build/common/google/api/expr/v1alpha1\xf8\x01\x01b\x06proto3"
...
var file_google_api_expr_v1alpha1_checked_proto_goTypes = []any{
	...
	(*protobuf.Empty)(nil),             // 17: google.protobuf.Empty
	(protobuf.NullValue)(0),            // 18: google.protobuf.NullValue
