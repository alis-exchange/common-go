...
import (
	...
	v1alpha1 "go.alis.build/common/google/api/expr/v1alpha1"
...
func (x *ParseResponse) GetIssues() []*rpc.Status {
	if x != nil {
		return x.Issues
	}
	return nil
...
func (x *CheckResponse) GetIssues() []*rpc.Status {
	if x != nil {
		return x.Issues
	}
	return nil
...
func (x *EvalResponse) GetIssues() []*rpc.Status {
	if x != nil {
		return x.Issues
	}
	return nil
...
const file_google_api_expr_conformance_v1alpha1_conformance_service_proto_rawDesc = "" +
	...
	"\x04Eval\x121.google.api.expr.conformance.v1alpha1.EvalRequest\x1a2.google.api.expr.conformance.v1alpha1.EvalResponse\"\x00\x1a\x15\xcaA\x12cel.googleapis.comB\x83\x01\n" +
	"(com.google.api.expr.conformance.v1alpha1B\x17ConformanceServiceProtoP\x01Z9go.alis.build/common/google/api/expr/conformance/v1alpha1\xf8\x01\x01b\x06proto3"
...
var file_google_api_expr_conformance_v1alpha1_conformance_service_proto_goTypes = []any{
	...
	(*rpc.Status)(nil),           // 11: google.rpc.Status
