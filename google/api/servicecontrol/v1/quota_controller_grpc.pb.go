...
func (c *quotaControllerClient) AllocateQuota(ctx context.Context, in *AllocateQuotaRequest, opts ...grpc.CallOption) (*AllocateQuotaResponse, error) {
	...
	err := c.cc.Invoke(ctx, QuotaController_AllocateQuota_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations must embed UnimplementedQuotaControllerServer
...
// UnimplementedQuotaControllerServer must be embedded to have
...
func (UnimplementedQuotaControllerServer) AllocateQuota(context.Context, *AllocateQuotaRequest) (*AllocateQuotaResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AllocateQuota not implemented")
}
func (UnimplementedQuotaControllerServer) mustEmbedUnimplementedQuotaControllerServer() {}
func (UnimplementedQuotaControllerServer) testEmbeddedByValue()                         {}
...
func RegisterQuotaControllerServer(s grpc.ServiceRegistrar, srv QuotaControllerServer) {
	// If the following call panics, it indicates UnimplementedQuotaControllerServer was
