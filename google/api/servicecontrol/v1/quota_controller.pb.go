...
func (x *QuotaError) GetStatus() *rpc.Status {
	if x != nil {
		return x.Status
	}
	return nil
...
const file_google_api_servicecontrol_v1_quota_controller_proto_rawDesc = "" +
	...
	"\rAllocateQuota\x122.google.api.servicecontrol.v1.AllocateQuotaRequest\x1a3.google.api.servicecontrol.v1.AllocateQuotaResponse\"4\x82\xd3\xe4\x93\x02.:\x01*\")/v1/services/{service_name}:allocateQuota\x1a\x80\x01\xcaA\x1dservicecontrol.googleapis.com\xd2A]https://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/servicecontrolB\xd6\x01\n" +
	" com.google.api.servicecontrol.v1B\x14QuotaControllerProtoP\x01Z1go.alis.build/common/google/api/servicecontrol/v1\xf8\x01\x01\xaa\x02\x1eGoogle.Cloud.ServiceControl.V1\xca\x02\x1eGoogle\\Cloud\\ServiceControl\\V1\xea\x02!Google::Cloud::ServiceControl::V1b\x06proto3"
