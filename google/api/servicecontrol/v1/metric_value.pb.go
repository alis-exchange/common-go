...
type MetricValue struct {
	...
	StartTime *protobuf.Timestamp `protobuf:"bytes,2,opt,name=start_time,json=startTime,proto3" json:"start_time,omitempty"`
	// The end of the time period over which this metric value's measurement
	// applies.  If not specified,
	// [google.api.servicecontrol.v1.Operation.end_time][google.api.servicecontrol.v1.Operation.end_time] will be used.
	EndTime *protobuf.Timestamp `protobuf:"bytes,3,opt,name=end_time,json=endTime,proto3" json:"end_time,omitempty"`
...
func (x *MetricValue) GetStartTime() *protobuf.Timestamp {
	if x != nil {
		return x.StartTime
	}
	return nil
...
func (x *MetricValue) GetEndTime() *protobuf.Timestamp {
	if x != nil {
		return x.EndTime
	}
	return nil
...
const file_google_api_servicecontrol_v1_metric_value_proto_rawDesc = "" +
	...
	"metricName\x12N\n" +
	"\rmetric_values\x18\x02 \x03(\v2).google.api.servicecontrol.v1.MetricValueR\fmetricValuesB\xd5\x01\n" +
	" com.google.api.servicecontrol.v1B\x13MetricValueSetProtoP\x01Z1go.alis.build/common/google/api/servicecontrol/v1\xf8\x01\x01\xaa\x02\x1eGoogle.Cloud.ServiceControl.V1\xca\x02\x1eGoogle\\Cloud\\ServiceControl\\V1\xea\x02!Google::Cloud::ServiceControl::V1b\x06proto3"
