...
type Operation struct {
	...
	EndTime *protobuf.Timestamp `protobuf:"bytes,5,opt,name=end_time,json=endTime,proto3" json:"end_time,omitempty"`
	...
	// Unimplemented.
	Extensions    []*protobuf.Any `protobuf:"bytes,16,rep,name=extensions,proto3" json:"extensions,omitempty"`
...
func (x *Operation) GetStartTime() *protobuf.Timestamp {
	if x != nil {
		return x.StartTime
	}
	return nil
...
func (x *Operation) GetEndTime() *protobuf.Timestamp {
	if x != nil {
		return x.EndTime
	}
	return nil
...
func (x *Operation) GetExtensions() []*protobuf.Any {
	if x != nil {
		return x.Extensions
	}
	return nil
...
const file_google_api_servicecontrol_v1_operation_proto_rawDesc = "" +
	...
	"\x04HIGH\x10\x01B\xd0\x01\n" +
	" com.google.api.servicecontrol.v1B\x0eOperationProtoP\x01Z1go.alis.build/common/google/api/servicecontrol/v1\xf8\x01\x01\xaa\x02\x1eGoogle.Cloud.ServiceControl.V1\xca\x02\x1eGoogle\\Cloud\\ServiceControl\\V1\xea\x02!Google::Cloud::ServiceControl::V1b\x06proto3"
