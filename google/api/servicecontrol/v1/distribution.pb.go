...
type Distribution struct {
	...
	Exemplars     []*api.Distribution_Exemplar `protobuf:"bytes,10,rep,name=exemplars,proto3" json:"exemplars,omitempty"`
...
func (x *Distribution) GetExemplars() []*api.Distribution_Exemplar {
	if x != nil {
		return x.Exemplars
	}
	return nil
...
const file_google_api_servicecontrol_v1_distribution_proto_rawDesc = "" +
	...
	"\rbucket_optionB\xd3\x01\n" +
	" com.google.api.servicecontrol.v1B\x11DistributionProtoP\x01Z1go.alis.build/common/google/api/servicecontrol/v1\xf8\x01\x01\xaa\x02\x1eGoogle.Cloud.ServiceControl.V1\xca\x02\x1eGoogle\\Cloud\\ServiceControl\\V1\xea\x02!Google::Cloud::ServiceControl::V1b\x06proto3"
...
var file_google_api_servicecontrol_v1_distribution_proto_goTypes = []any{
	...
	(*api.Distribution_Exemplar)(nil),       // 4: google.api.Distribution.Exemplar
}
