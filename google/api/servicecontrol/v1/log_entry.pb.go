...
type LogEntry struct {
	...
	Timestamp *protobuf.Timestamp `protobuf:"bytes,11,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
...
func (x *LogEntry) GetStructPayload() *protobuf.Struct {
	if x != nil {
...
type LogEntry_StructPayload struct {
	...
	StructPayload *protobuf.Struct `protobuf:"bytes,6,opt,name=struct_payload,json=structPayload,proto3,oneof"`
}
...
const file_google_api_servicecontrol_v1_log_entry_proto_rawDesc = "" +
	...
	"\bfunction\x18\x03 \x01(\tR\bfunctionB\xcc\x01\n" +
	" com.google.api.servicecontrol.v1B\rLogEntryProtoP\x01Z1go.alis.build/common/google/api/servicecontrol/v1\xaa\x02\x1eGoogle.Cloud.ServiceControl.V1\xca\x02\x1eGoogle\\Cloud\\ServiceControl\\V1\xea\x02!Google::Cloud::ServiceControl::V1b\x06proto3"
...
var file_google_api_servicecontrol_v1_log_entry_proto_goTypes = []any{
	...
	(*protobuf.Any)(nil),           // 7: google.protobuf.Any
	(*protobuf.Struct)(nil),        // 8: google.protobuf.Struct
}
