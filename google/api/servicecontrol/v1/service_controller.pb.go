...
func (x *ReportResponse_ReportError) GetStatus() *rpc.Status {
	if x != nil {
		return x.Status
	}
	return nil
...
const file_google_api_servicecontrol_v1_service_controller_proto_rawDesc = "" +
	...
	"\n" +
	"check_info\x18\x06 \x01(\v25.google.api.servicecontrol.v1.CheckResponse.CheckInfoR\tcheckInfo\x1a\x95\x01\n" +
	"\tCheckInfo\x12)\n" +
	"\x10unused_arguments\x18\x01 \x03(\tR\x0funusedArguments\x12]\n" +
	"\rconsumer_info\x18\x02 \x01(\v28.google.api.servicecontrol.v1.CheckResponse.ConsumerInfoR\fconsumerInfo\x1a\xa9\x02\n" +
	"\fConsumerInfo\x12%\n" +
	...
	" com.google.api.servicecontrol.v1B\x16ServiceControllerProtoP\x01Z1go.alis.build/common/google/api/servicecontrol/v1\xf8\x01\x01\xa2\x02\x04GASC\xaa\x02\x1eGoogle.Cloud.ServiceControl.V1\xca\x02\x1eGoogle\\Cloud\\ServiceControl\\V1\xea\x02!Google::Cloud::ServiceControl::V1b\x06proto3"
...
var file_google_api_servicecontrol_v1_service_controller_proto_goTypes = []any{
	...
	(*rpc.Status)(nil),                           // 10: google.rpc.Status
}
