...
func (x *CheckError) GetStatus() *rpc.Status {
	if x != nil {
		return x.Status
	}
	return nil
...
const file_google_api_servicecontrol_v1_check_error_proto_rawDesc = "" +
	...
	"*CLOUD_RESOURCE_MANAGER_BACKEND_UNAVAILABLE\x10\xb1\x02B\xd1\x01\n" +
	" com.google.api.servicecontrol.v1B\x0fCheckErrorProtoP\x01Z1go.alis.build/common/google/api/servicecontrol/v1\xf8\x01\x01\xaa\x02\x1eGoogle.Cloud.ServiceControl.V1\xca\x02\x1eGoogle\\Cloud\\ServiceControl\\V1\xea\x02!Google::Cloud::ServiceControl::V1b\x06proto3"
