...
type MonitoredResourceMetadata struct {
	...
	//	  "spot_instance": false }
	SystemLabels *protobuf.Struct `protobuf:"bytes,1,opt,name=system_labels,json=systemLabels,proto3" json:"system_labels,omitempty"`
...
func (x *MonitoredResourceMetadata) GetSystemLabels() *protobuf.Struct {
	if x != nil {
...
const file_google_api_monitored_resource_proto_rawDesc = "" +
	...
	"\x0ecom.google.apiB\x16MonitoredResourceProtoP\x01Z\x1fgo.alis.build/common/google/api\xf8\x01\x01\xa2\x02\x04GAPIb\x06proto3"
