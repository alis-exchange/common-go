...
type Key struct {
	...
	// this must be empty.
	DeleteTime *protobuf.Timestamp `protobuf:"bytes,7,opt,name=delete_time,json=deleteTime,proto3" json:"delete_time,omitempty"`
...
func (x *Key) GetCreateTime() *protobuf.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *Key) GetUpdateTime() *protobuf.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
func (x *Key) GetDeleteTime() *protobuf.Timestamp {
	if x != nil {
		return x.DeleteTime
	}
	return nil
...
const file_google_api_apikeys_v2_resources_proto_rawDesc = "" +
	"\n" +
	"%google/api/apikeys/v2/resources.proto\x12\x15google.api.apikeys.v2\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x9d\x05\n" +
	"\x03Key\x12\x18\n" +
	"\x04name\x18\x01 \x01(\tB\x04\xe2A\x01\x03R\x04name\x12\x16\n" +
	"\x03uid\x18\x05 \x01(\tB\x04\xe2A\x01\x03R\x03uid\x12!\n" +
	"\fdisplay_name\x18\x02 \x01(\tR\vdisplayName\x12#\n" +
	"\n" +
	"key_string\x18\x03 \x01(\tB\x04\xe2A\x01\x03R\tkeyString\x12A\n" +
	...
	"\frestrictions\x18\t \x01(\v2#.google.api.apikeys.v2.RestrictionsR\frestrictions\x12\x18\n" +
	"\x04etag\x18\v \x01(\tB\x04\xe2A\x01\x03R\x04etag\x1a>\n" +
	...
	"\x12allowed_bundle_ids\x18\x01 \x03(\tR\x10allowedBundleIds\"E\n" +
	"\tApiTarget\x12\x18\n" +
	"\aservice\x18\x01 \x01(\tR\aservice\x12\x1e\n" +
	"\amethods\x18\x02 \x03(\tB\x04\xe2A\x01\x01R\amethodsB\xaa\x01\n" +
	"\x19com.google.api.apikeys.v2B\x0eResourcesProtoP\x01Z*go.alis.build/common/google/api/apikeys/v2\xaa\x02\x17Google.Cloud.ApiKeys.V2\xca\x02\x17Google\\Cloud\\ApiKeys\\V2\xea\x02\x1aGoogle::Cloud::ApiKeys::V2b\x06proto3"
