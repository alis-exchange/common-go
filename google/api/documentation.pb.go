...
const file_google_api_documentation_proto_rawDesc = "" +
	...
	"\bsubpages\x18\x03 \x03(\v2\x10.google.api.PageR\bsubpagesBN\n" +
	"\x0ecom.google.apiB\x12DocumentationProtoP\x01Z\x1fgo.alis.build/common/google/api\xa2\x02\x04GAPIb\x06proto3"
