...
type ListServiceConfigsResponse struct {
	...
	ServiceConfigs []*api.Service `protobuf:"bytes,1,rep,name=service_configs,json=serviceConfigs,proto3" json:"service_configs,omitempty"`
...
func (x *ListServiceConfigsResponse) GetServiceConfigs() []*api.Service {
	if x != nil {
...
type CreateServiceConfigRequest struct {
	...
	ServiceConfig *api.Service `protobuf:"bytes,2,opt,name=service_config,json=serviceConfig,proto3" json:"service_config,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateServiceConfigRequest) GetServiceConfig() *api.Service {
	if x != nil {
...
type SubmitConfigSourceResponse struct {
	...
	ServiceConfig *api.Service `protobuf:"bytes,1,opt,name=service_config,json=serviceConfig,proto3" json:"service_config,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SubmitConfigSourceResponse) GetServiceConfig() *api.Service {
	if x != nil {
		return x.ServiceConfig
	}
	return nil
...
type GenerateConfigReportRequest struct {
	...
	NewConfig *protobuf.Any `protobuf:"bytes,1,opt,name=new_config,json=newConfig,proto3" json:"new_config,omitempty"`
	// Optional. Service configuration against which the comparison will be done.
	// For this version of API, the supported types are
	// [google.api.servicemanagement.v1.ConfigRef][google.api.servicemanagement.v1.ConfigRef],
	// [google.api.servicemanagement.v1.ConfigSource][google.api.servicemanagement.v1.ConfigSource],
	// and [google.api.Service][google.api.Service]
	OldConfig     *protobuf.Any `protobuf:"bytes,2,opt,name=old_config,json=oldConfig,proto3" json:"old_config,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GenerateConfigReportRequest) GetNewConfig() *protobuf.Any {
	if x != nil {
		return x.NewConfig
	}
	return nil
...
func (x *GenerateConfigReportRequest) GetOldConfig() *protobuf.Any {
	if x != nil {
		return x.OldConfig
	}
	return nil
...
const file_google_api_servicemanagement_v1_servicemanager_proto_rawDesc = "" +
	...
	"\fservice_name\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\vserviceName\"g\n" +
	"\x14CreateServiceRequest\x12O\n" +
	"\aservice\x18\x01 \x01(\v2/.google.api.servicemanagement.v1.ManagedServiceB\x04\xe2A\x01\x02R\aservice\"?\n" +
	"\x14DeleteServiceRequest\x12'\n" +
	"\fservice_name\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\vserviceName\"A\n" +
	"\x16UndeleteServiceRequest\x12'\n" +
	"\fservice_name\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\vserviceName\"d\n" +
	"\x17UndeleteServiceResponse\x12I\n" +
	"\aservice\x18\x01 \x01(\v2/.google.api.servicemanagement.v1.ManagedServiceR\aservice\"\xe1\x01\n" +
	"\x17GetServiceConfigRequest\x12'\n" +
	"\fservice_name\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\vserviceName\x12!\n" +
	"\tconfig_id\x18\x02 \x01(\tB\x04\xe2A\x01\x02R\bconfigId\x12W\n" +
	...
	"\x04FULL\x10\x01\"\x80\x01\n" +
	"\x19ListServiceConfigsRequest\x12'\n" +
	"\fservice_name\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\vserviceName\x12\x1d\n" +
	"\n" +
	...
	"\fservice_name\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\vserviceName\x12@\n" +
	"\x0eservice_config\x18\x02 \x01(\v2\x13.google.api.ServiceB\x04\xe2A\x01\x02R\rserviceConfig\"\xc9\x01\n" +
	"\x19SubmitConfigSourceRequest\x12'\n" +
	"\fservice_name\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\vserviceName\x12X\n" +
	"\rconfig_source\x18\x02 \x01(\v2-.google.api.servicemanagement.v1.ConfigSourceB\x04\xe2A\x01\x02R\fconfigSource\x12)\n" +
	"\rvalidate_only\x18\x03 \x01(\bB\x04\xe2A\x01\x01R\fvalidateOnly\"X\n" +
	"\x1aSubmitConfigSourceResponse\x12:\n" +
	"\x0eservice_config\x18\x01 \x01(\v2\x13.google.api.ServiceR\rserviceConfig\"\x90\x01\n" +
	"\x1bCreateServiceRolloutRequest\x12'\n" +
	"\fservice_name\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\vserviceName\x12H\n" +
	"\arollout\x18\x02 \x01(\v2(.google.api.servicemanagement.v1.RolloutB\x04\xe2A\x01\x02R\arollout\"\x9f\x01\n" +
	"\x1aListServiceRolloutsRequest\x12'\n" +
	"\fservice_name\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\vserviceName\x12\x1d\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tR\tpageToken\x12\x1b\n" +
	"\tpage_size\x18\x03 \x01(\x05R\bpageSize\x12\x1c\n" +
	"\x06filter\x18\x04 \x01(\tB\x04\xe2A\x01\x02R\x06filter\"\x8b\x01\n" +
	...
	"\fservice_name\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\vserviceName\x12#\n" +
	"\n" +
	"rollout_id\x18\x02 \x01(\tB\x04\xe2A\x01\x02R\trolloutId\"\x93\x01\n" +
	"\x1bGenerateConfigReportRequest\x129\n" +
	"\n" +
	"new_config\x18\x01 \x01(\v2\x14.google.protobuf.AnyB\x04\xe2A\x01\x02R\tnewConfig\x129\n" +
	"\n" +
	"old_config\x18\x02 \x01(\v2\x14.google.protobuf.AnyB\x04\xe2A\x01\x01R\toldConfig\"\xf6\x01\n" +
	...
	"\x14GenerateConfigReport\x12<.google.api.servicemanagement.v1.GenerateConfigReportRequest\x1a=.google.api.servicemanagement.v1.GenerateConfigReportResponse\"D\xdaA\x15new_config,old_config\x82\xd3\xe4\x93\x02&:\x01*\"!/v1/services:generateConfigReport\x1a\xfd\x01\xcaA servicemanagement.googleapis.com\xd2A\xd6\x01https://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/cloud-platform.read-only,https://www.googleapis.com/auth/service.management,https://www.googleapis.com/auth/service.management.readonlyB\xe8\x01\n" +
	"#com.google.api.servicemanagement.v1B\x13ServiceManagerProtoP\x01Z4go.alis.build/common/google/api/servicemanagement/v1\xa2\x02\x04GASM\xaa\x02!Google.Cloud.ServiceManagement.V1\xca\x02!Google\\Cloud\\ServiceManagement\\V1\xea\x02$Google::Cloud::ServiceManagement::V1b\x06proto3"
