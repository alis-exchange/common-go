...
type OperationMetadata struct {
	...
	StartTime     *protobuf.Timestamp `protobuf:"bytes,4,opt,name=start_time,json=startTime,proto3" json:"start_time,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *OperationMetadata) GetStartTime() *protobuf.Timestamp {
	if x != nil {
		return x.StartTime
	}
	return nil
...
type ChangeReport struct {
	...
	ConfigChanges []*api.ConfigChange `protobuf:"bytes,1,rep,name=config_changes,json=configChanges,proto3" json:"config_changes,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ChangeReport) GetConfigChanges() []*api.ConfigChange {
	if x != nil {
...
func (x *Rollout) GetCreateTime() *protobuf.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
const file_google_api_servicemanagement_v1_resources_proto_rawDesc = "" +
	...
	"\fChangeReport\x12?\n" +
	"\x0econfig_changes\x18\x01 \x03(\v2\x18.google.api.ConfigChangeR\rconfigChanges\"\xf9\x06\n" +
	"\aRollout\x12#\n" +
	"\n" +
	"rollout_id\x18\x01 \x01(\tB\x04\xe2A\x01\x01R\trolloutId\x12;\n" +
	...
	"\n" +
	"\bstrategyB\xe3\x01\n" +
	"#com.google.api.servicemanagement.v1B\x0eResourcesProtoP\x01Z4go.alis.build/common/google/api/servicemanagement/v1\xa2\x02\x04GASM\xaa\x02!Google.Cloud.ServiceManagement.V1\xca\x02!Google\\Cloud\\ServiceManagement\\V1\xea\x02$Google::Cloud::ServiceManagement::V1b\x06proto3"
...
var file_google_api_servicemanagement_v1_resources_proto_goTypes = []any{
	...
	(*protobuf.Timestamp)(nil),             // 16: google.protobuf.Timestamp
	(*api.ConfigChange)(nil),               // 17: google.api.ConfigChange
}
