...
type MetricDescriptor_MetricDescriptorMetadata struct {
	...
	SamplePeriod *protobuf.Duration `protobuf:"bytes,2,opt,name=sample_period,json=samplePeriod,proto3" json:"sample_period,omitempty"`
	// The delay of data points caused by ingestion. Data points older than this
	// age are guaranteed to be ingested and available to be read, excluding
	// data loss due to errors.
	IngestDelay   *protobuf.Duration `protobuf:"bytes,3,opt,name=ingest_delay,json=ingestDelay,proto3" json:"ingest_delay,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MetricDescriptor_MetricDescriptorMetadata) GetSamplePeriod() *protobuf.Duration {
	if x != nil {
...
func (x *MetricDescriptor_MetricDescriptorMetadata) GetIngestDelay() *protobuf.Duration {
	if x != nil {
...
const file_google_api_metric_proto_rawDesc = "" +
	...
	"google.api\x1a\x16google/api/label.proto\x1a\x1dgoogle/api/launch_stage.proto\x1a\x1egoogle/protobuf/duration.proto\"\xc1\a\n" +
	...
	"\fingest_delay\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\vingestDelay\"O\n" +
	"\n" +
	"MetricKind\x12\x1b\n" +
	...
	"\x0ecom.google.apiB\vMetricProtoP\x01Z\x1fgo.alis.build/common/google/api\xa2\x02\x04GAPIb\x06proto3"
