...
type MethodSettings_LongRunning struct {
	...
	InitialPollDelay *protobuf.Duration `protobuf:"bytes,1,opt,name=initial_poll_delay,json=initialPollDelay,proto3" json:"initial_poll_delay,omitempty"`
	...
	MaxPollDelay *protobuf.Duration `protobuf:"bytes,3,opt,name=max_poll_delay,json=maxPollDelay,proto3" json:"max_poll_delay,omitempty"`
	// Total polling timeout.
	// Default value: 5 minutes.
	TotalPollTimeout *protobuf.Duration `protobuf:"bytes,4,opt,name=total_poll_timeout,json=totalPollTimeout,proto3" json:"total_poll_timeout,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *MethodSettings_LongRunning) GetInitialPollDelay() *protobuf.Duration {
	if x != nil {
...
func (x *MethodSettings_LongRunning) GetMaxPollDelay() *protobuf.Duration {
	if x != nil {
...
func (x *MethodSettings_LongRunning) GetTotalPollTimeout() *protobuf.Duration {
	if x != nil {
...
const file_google_api_client_proto_rawDesc = "" +
	...
	"\x10library_settings\x18m \x03(\v2!.google.api.ClientLibrarySettingsR\x0flibrarySettings\"\x9a\x02\n" +
	"\fJavaSettings\x12'\n" +
	...
	"\n" +
	"GoSettings\x12:\n" +
	"\x06common\x18\x01 \x01(\v2\".google.api.CommonLanguageSettingsR\x06common\"\x8e\x03\n" +
	"\x0eMethodSettings\x12\x1a\n" +
	"\bselector\x18\x01 \x01(\tR\bselector\x12I\n" +
	"\flong_running\x18\x02 \x01(\v2&.google.api.MethodSettings.LongRunningR\vlongRunning\x1a\x94\x02\n" +
	"\vLongRunning\x12G\n" +
	...
	"\x12total_poll_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\x10totalPollTimeout*y\n" +
	...
	"\foauth_scopes\x12\x1f.google.protobuf.ServiceOptions\x18\x9a\b \x01(\tR\voauthScopesBG\n" +
	"\x0ecom.google.apiB\vClientProtoP\x01Z\x1fgo.alis.build/common/google/api\xa2\x02\x04GAPIb\x06proto3"
...
var file_google_api_client_proto_goTypes = []any{
	...
	(*protobuf.Duration)(nil),          // 17: google.protobuf.Duration
	(*protobuf.MethodOptions)(nil),     // 18: google.protobuf.MethodOptions
	(*protobuf.ServiceOptions)(nil),    // 19: google.protobuf.ServiceOptions
}
