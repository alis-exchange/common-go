...
type Color struct {
	...
	Alpha         *protobuf.FloatValue `protobuf:"bytes,4,opt,name=alpha,proto3" json:"alpha,omitempty"`
...
func (x *Color) GetAlpha() *protobuf.FloatValue {
	if x != nil {
		return x.Alpha
	}
	return nil
...
const file_google_type_color_proto_rawDesc = "" +
	...
	"\x05alpha\x18\x04 \x01(\v2\x1b.google.protobuf.FloatValueR\x05alphaBJ\n" +
	"\x0fcom.google.typeB\n" +
	"ColorProtoP\x01Z go.alis.build/common/google/type\xf8\x01\x01\xa2\x02\x03GTPb\x06proto3"
...
var file_google_type_color_proto_goTypes = []any{
	...
	(*protobuf.FloatValue)(nil), // 1: google.protobuf.FloatValue
}
