...
const file_google_type_postal_address_proto_rawDesc = "" +
	...
	" \x03(\tR\n" +
	"recipients\x12\"\n" +
	"\forganization\x18\v \x01(\tR\forganizationBR\n" +
	"\x0fcom.google.typeB\x12PostalAddressProtoP\x01Z go.alis.build/common/google/type\xf8\x01\x01\xa2\x02\x03GTPb\x06proto3"
