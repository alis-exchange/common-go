...
func (x *Interval) GetStartTime() *protobuf.Timestamp {
	if x != nil {
		return x.StartTime
	}
	return nil
...
func (x *Interval) GetEndTime() *protobuf.Timestamp {
	if x != nil {
		return x.EndTime
	}
	return nil
...
const file_google_type_interval_proto_rawDesc = "" +
	...
	"\bend_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\aendTimeBM\n" +
	"\x0fcom.google.typeB\rIntervalProtoP\x01Z go.alis.build/common/google/type\xf8\x01\x01\xa2\x02\x03GTPb\x06proto3"
