...
func (x *DateTime) GetUtcOffset() *protobuf.Duration {
	if x != nil {
...
type DateTime_UtcOffset struct {
	...
	// { seconds: -14400 }.
	UtcOffset *protobuf.Duration `protobuf:"bytes,8,opt,name=utc_offset,json=utcOffset,proto3,oneof"`
}
...
const file_google_type_datetime_proto_rawDesc = "" +
	...
	"\aversion\x18\x02 \x01(\tR\aversionBM\n" +
	"\x0fcom.google.typeB\rDateTimeProtoP\x01Z go.alis.build/common/google/type\xf8\x01\x01\xa2\x02\x03GTPb\x06proto3"
...
var file_google_type_datetime_proto_goTypes = []any{
	...
	(*protobuf.Duration)(nil), // 2: google.protobuf.Duration
}
