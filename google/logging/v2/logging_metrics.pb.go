...
type LogMetric struct {
	...
	// their description.
	MetricDescriptor *api.MetricDescriptor `protobuf:"bytes,5,opt,name=metric_descriptor,json=metricDescriptor,proto3" json:"metric_descriptor,omitempty"`
	...
	BucketOptions *api.Distribution_BucketOptions `protobuf:"bytes,8,opt,name=bucket_options,json=bucketOptions,proto3" json:"bucket_options,omitempty"`
...
func (x *LogMetric) GetMetricDescriptor() *api.MetricDescriptor {
	if x != nil {
...
func (x *LogMetric) GetBucketOptions() *api.Distribution_BucketOptions {
	if x != nil {
...
func (x *LogMetric) GetCreateTime() *protobuf.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *LogMetric) GetUpdateTime() *protobuf.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
const file_google_logging_v2_logging_metrics_proto_rawDesc = "" +
	...
	"\bdisabled\x18\f \x01(\bB\x04\xe2A\x01\x01R\bdisabled\x12O\n" +
	"\x11metric_descriptor\x18\x05 \x01(\v2\x1c.google.api.MetricDescriptorB\x04\xe2A\x01\x01R\x10metricDescriptor\x12-\n" +
	"\x0fvalue_extractor\x18\x06 \x01(\tB\x04\xe2A\x01\x01R\x0evalueExtractor\x12b\n" +
	"\x10label_extractors\x18\a \x03(\v21.google.logging.v2.LogMetric.LabelExtractorsEntryB\x04\xe2A\x01\x01R\x0flabelExtractors\x12S\n" +
	"\x0ebucket_options\x18\b \x01(\v2&.google.api.Distribution.BucketOptionsB\x04\xe2A\x01\x01R\rbucketOptions\x12A\n" +
	...
	"\tpage_size\x18\x03 \x01(\x05B\x04\xe2A\x01\x01R\bpageSize\"x\n" +
	...
	"\vmetric_name\x18\x01 \x01(\tB)\xe2A\x01\x02\xfaA\"\n" +
	" logging.googleapis.com/LogMetricR\n" +
	"metricName\"\x97\x01\n" +
	"\x16CreateLogMetricRequest\x12A\n" +
	"\x06parent\x18\x01 \x01(\tB)\xe2A\x01\x02\xfaA\"\x12 logging.googleapis.com/LogMetricR\x06parent\x12:\n" +
	"\x06metric\x18\x02 \x01(\v2\x1c.google.logging.v2.LogMetricB\x04\xe2A\x01\x02R\x06metric\"\xa0\x01\n" +
	"\x16UpdateLogMetricRequest\x12J\n" +
	"\vmetric_name\x18\x01 \x01(\tB)\xe2A\x01\x02\xfaA\"\n" +
	" logging.googleapis.com/LogMetricR\n" +
	"metricName\x12:\n" +
	"\x06metric\x18\x02 \x01(\v2\x1c.google.logging.v2.LogMetricB\x04\xe2A\x01\x02R\x06metric\"d\n" +
	"\x16DeleteLogMetricRequest\x12J\n" +
	"\vmetric_name\x18\x01 \x01(\tB)\xe2A\x01\x02\xfaA\"\n" +
	" logging.googleapis.com/LogMetricR\n" +
	"metricName2\xae\b\n" +
	...
	"\x0fDeleteLogMetric\x12).google.logging.v2.DeleteLogMetricRequest\x1a\x16.google.protobuf.Empty\"<\xdaA\vmetric_name\x82\xd3\xe4\x93\x02(*&/v2/{metric_name=projects/*/metrics/*}\x1a\x8d\x02\xcaA\x16logging.googleapis.com\xd2A\xf0\x01https://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/cloud-platform.read-only,https://www.googleapis.com/auth/logging.admin,https://www.googleapis.com/auth/logging.read,https://www.googleapis.com/auth/logging.writeB\xaa\x01\n" +
	"\x15com.google.logging.v2B\x13LoggingMetricsProtoP\x01Z&go.alis.build/common/google/logging/v2\xf8\x01\x01\xaa\x02\x17Google.Cloud.Logging.V2\xca\x02\x17Google\\Cloud\\Logging\\V2\xea\x02\x1aGoogle::Cloud::Logging::V2b\x06proto3"
...
var file_google_logging_v2_logging_metrics_proto_goTypes = []any{
	...
	(*api.MetricDescriptor)(nil),           // 9: google.api.MetricDescriptor
	(*api.Distribution_BucketOptions)(nil), // 10: google.api.Distribution.BucketOptions
	(*protobuf.Timestamp)(nil),             // 11: google.protobuf.Timestamp
	(*protobuf.Empty)(nil),                 // 12: google.protobuf.Empty
}
