...
import (
	api "go.alis.build/common/google/api"
...
type WriteLogEntriesRequest struct {
	...
	Resource *api.MonitoredResource `protobuf:"bytes,2,opt,name=resource,proto3" json:"resource,omitempty"`
...
func (x *WriteLogEntriesRequest) GetResource() *api.MonitoredResource {
	if x != nil {
		return x.Resource
	}
	return nil
...
type WriteLogEntriesPartialErrors struct {
	...
	// per-entry errors.
	LogEntryErrors map[int32]*rpc.Status `protobuf:"bytes,1,rep,name=log_entry_errors,json=logEntryErrors,proto3" json:"log_entry_errors,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *WriteLogEntriesPartialErrors) GetLogEntryErrors() map[int32]*rpc.Status {
	if x != nil {
...
type ListMonitoredResourceDescriptorsResponse struct {
	...
	ResourceDescriptors []*api.MonitoredResourceDescriptor `protobuf:"bytes,1,rep,name=resource_descriptors,json=resourceDescriptors,proto3" json:"resource_descriptors,omitempty"`
	// If there might be more results than those appearing in this response, then
	// `nextPageToken` is included.  To get the next set of results, call this
	// method again using the value of `nextPageToken` as `pageToken`.
	NextPageToken string `protobuf:"bytes,2,opt,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
...
func (x *ListMonitoredResourceDescriptorsResponse) GetResourceDescriptors() []*api.MonitoredResourceDescriptor {
	if x != nil {
...
type TailLogEntriesRequest struct {
	...
	// milliseconds.
	BufferWindow  *protobuf.Duration `protobuf:"bytes,3,opt,name=buffer_window,json=bufferWindow,proto3" json:"buffer_window,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TailLogEntriesRequest) GetBufferWindow() *protobuf.Duration {
	if x != nil {
...
const file_google_logging_v2_logging_proto_rawDesc = "" +
	"\n" +
	"\x1fgoogle/logging/v2/logging.proto\x12\x11google.logging.v2\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a#google/api/monitored_resource.proto\x1a\x19google/api/resource.proto\x1a!google/logging/v2/log_entry.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x17google/rpc/status.proto\"R\n" +
	"\x10DeleteLogRequest\x12>\n" +
	"\blog_name\x18\x01 \x01(\tB#\xe2A\x01\x02\xfaA\x1c\n" +
	"\x1alogging.googleapis.com/LogR\alogName\"\xb4\x03\n" +
	"\x16WriteLogEntriesRequest\x12>\n" +
	"\blog_name\x18\x01 \x01(\tB#\xe2A\x01\x01\xfaA\x1c\n" +
	"\x1alogging.googleapis.com/LogR\alogName\x12?\n" +
	"\bresource\x18\x02 \x01(\v2\x1d.google.api.MonitoredResourceB\x04\xe2A\x01\x01R\bresource\x12S\n" +
	"\x06labels\x18\x03 \x03(\v25.google.logging.v2.WriteLogEntriesRequest.LabelsEntryB\x04\xe2A\x01\x01R\x06labels\x12;\n" +
	"\aentries\x18\x04 \x03(\v2\x1b.google.logging.v2.LogEntryB\x04\xe2A\x01\x02R\aentries\x12-\n" +
	"\x0fpartial_success\x18\x05 \x01(\bB\x04\xe2A\x01\x01R\x0epartialSuccess\x12\x1d\n" +
	"\adry_run\x18\x06 \x01(\bB\x04\xe2A\x01\x01R\x06dryRun\x1a9\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x12.google.rpc.StatusR\x05value:\x028\x01\"\xea\x01\n" +
	"\x15ListLogEntriesRequest\x12J\n" +
	"\x0eresource_names\x18\b \x03(\tB#\xe2A\x01\x02\xfaA\x1c\x12\x1alogging.googleapis.com/LogR\rresourceNames\x12\x1c\n" +
	"\x06filter\x18\x02 \x01(\tB\x04\xe2A\x01\x01R\x06filter\x12\x1f\n" +
	"\border_by\x18\x03 \x01(\tB\x04\xe2A\x01\x01R\aorderBy\x12!\n" +
	"\tpage_size\x18\x04 \x01(\x05B\x04\xe2A\x01\x01R\bpageSize\x12#\n" +
	"\n" +
	"page_token\x18\x05 \x01(\tB\x04\xe2A\x01\x01R\tpageToken\"w\n" +
	...
	"\n" +
	"page_token\x18\x02 \x01(\tB\x04\xe2A\x01\x01R\tpageToken\"\xae\x01\n" +
	...
	"\x06parent\x18\x01 \x01(\tB#\xe2A\x01\x02\xfaA\x1c\x12\x1alogging.googleapis.com/LogR\x06parent\x12!\n" +
	"\tpage_size\x18\x02 \x01(\x05B\x04\xe2A\x01\x01R\bpageSize\x12#\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tB\x04\xe2A\x01\x01R\tpageToken\x12J\n" +
	"\x0eresource_names\x18\b \x03(\tB#\xe2A\x01\x01\xfaA\x1c\x12\x1alogging.googleapis.com/LogR\rresourceNames\"W\n" +
	...
	"\x0eresource_names\x18\x01 \x03(\tB\x04\xe2A\x01\x02R\rresourceNames\x12\x1c\n" +
	"\x06filter\x18\x02 \x01(\tB\x04\xe2A\x01\x01R\x06filter\x12D\n" +
	"\rbuffer_window\x18\x03 \x01(\v2\x19.google.protobuf.DurationB\x04\xe2A\x01\x01R\fbufferWindow\"\x92\x03\n" +
	...
	"\bListLogs\x12\".google.logging.v2.ListLogsRequest\x1a#.google.logging.v2.ListLogsResponse\"\xb2\x01\xdaA\x06parent\x82\xd3\xe4\x93\x02\xa2\x01Z\x1e\x12\x1c/v2/{parent=projects/*}/logsZ#\x12!/v2/{parent=organizations/*}/logsZ\x1d\x12\x1b/v2/{parent=folders/*}/logsZ%\x12#/v2/{parent=billingAccounts/*}/logs\x12\x15/v2/{parent=*/*}/logs\x12\x86\x01\n" +
	"\x0eTailLogEntries\x12(.google.logging.v2.TailLogEntriesRequest\x1a).google.logging.v2.TailLogEntriesResponse\"\x1b\x82\xd3\xe4\x93\x02\x15:\x01*\"\x10/v2/entries:tail(\x010\x01\x1a\x8d\x02\xcaA\x16logging.googleapis.com\xd2A\xf0\x01https://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/cloud-platform.read-only,https://www.googleapis.com/auth/logging.admin,https://www.googleapis.com/auth/logging.read,https://www.googleapis.com/auth/logging.writeB\xa3\x01\n" +
	"\x15com.google.logging.v2B\fLoggingProtoP\x01Z&go.alis.build/common/google/logging/v2\xf8\x01\x01\xaa\x02\x17Google.Cloud.Logging.V2\xca\x02\x17Google\\Cloud\\Logging\\V2\xea\x02\x1aGoogle::Cloud::Logging::V2b\x06proto3"
...
var file_google_logging_v2_logging_proto_goTypes = []any{
	...
	(*api.MonitoredResource)(nil),                      // 16: google.api.MonitoredResource
	(*LogEntry)(nil),                                   // 17: google.logging.v2.LogEntry
	(*api.MonitoredResourceDescriptor)(nil),            // 18: google.api.MonitoredResourceDescriptor
	(*protobuf.Duration)(nil),                          // 19: google.protobuf.Duration
	(*rpc.Status)(nil),                                 // 20: google.rpc.Status
	(*protobuf.Empty)(nil),                             // 21: google.protobuf.Empty
}
