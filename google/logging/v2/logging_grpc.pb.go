...
type LoggingServiceV2Client interface {
	...
	DeleteLog(ctx context.Context, in *DeleteLogRequest, opts ...grpc.CallOption) (*protobuf.Empty, error)
...
func (c *loggingServiceV2Client) DeleteLog(ctx context.Context, in *DeleteLogRequest, opts ...grpc.CallOption) (*protobuf.Empty, error) {
...
type LoggingServiceV2Server interface {
	...
	// the delete operation might not be deleted. Entries received after the
	// delete operation with a timestamp before the operation will be deleted.
	DeleteLog(context.Context, *DeleteLogRequest) (*protobuf.Empty, error)
	// Writes log entries to Logging. This API method is the
	// only way to send log entries to Logging. This method
	// is used, directly or indirectly, by the Logging agent
	// (fluentd) and all logging libraries configured to use Logging.
...
func (UnimplementedLoggingServiceV2Server) DeleteLog(context.Context, *DeleteLogRequest) (*protobuf.Empty, error) {
