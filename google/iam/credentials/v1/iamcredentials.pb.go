...
const file_google_iam_credentials_v1_iamcredentials_proto_rawDesc = "" +
	...
	"\aSignJwt\x12).google.iam.credentials.v1.SignJwtRequest\x1a*.google.iam.credentials.v1.SignJwtResponse\"S\xdaA\x16name,delegates,payload\x82\xd3\xe4\x93\x024:\x01*\"//v1/{name=projects/*/serviceAccounts/*}:signJwt\x1aQ\xcaA\x1diamcredentials.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xb3\x01\n" +
	"#com.google.cloud.iam.credentials.v1B\x13IAMCredentialsProtoP\x01Z.go.alis.build/common/google/iam/credentials/v1\xf8\x01\x01\xaa\x02\x1fGoogle.Cloud.Iam.Credentials.V1\xca\x02\x1fGoogle\\Cloud\\Iam\\Credentials\\V1b\x06proto3"
