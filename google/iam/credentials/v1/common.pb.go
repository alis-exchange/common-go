...
type GenerateAccessTokenRequest struct {
	...
	// hour.
	Lifetime      *protobuf.Duration `protobuf:"bytes,7,opt,name=lifetime,proto3" json:"lifetime,omitempty"`
...
func (x *GenerateAccessTokenRequest) GetLifetime() *protobuf.Duration {
	if x != nil {
		return x.Lifetime
	}
	return nil
...
type GenerateAccessTokenResponse struct {
	...
	ExpireTime    *protobuf.Timestamp `protobuf:"bytes,3,opt,name=expire_time,json=expireTime,proto3" json:"expire_time,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GenerateAccessTokenResponse) GetExpireTime() *protobuf.Timestamp {
	if x != nil {
		return x.ExpireTime
	}
	return nil
...
const file_google_iam_credentials_v1_common_proto_rawDesc = "" +
	...
	"\x05scope\x18\x04 \x03(\tB\x04\xe2A\x01\x02R\x05scope\x125\n" +
	...
	"\apayload\x18\x05 \x01(\fB\x04\xe2A\x01\x02R\apayload\"J\n" +
	...
	"!iam.googleapis.com/ServiceAccountR\x04name\x12\x1c\n" +
	"\tdelegates\x18\x03 \x03(\tR\tdelegates\x12\x1e\n" +
	"\apayload\x18\x05 \x01(\tB\x04\xe2A\x01\x02R\apayload\"G\n" +
	...
	"\baudience\x18\x03 \x01(\tB\x04\xe2A\x01\x02R\baudience\x12#\n" +
	"\rinclude_email\x18\x04 \x01(\bR\fincludeEmail\"/\n" +
	"\x17GenerateIdTokenResponse\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05tokenB\x95\x02\xeaAY\n" +
	"!iam.googleapis.com/ServiceAccount\x124projects/{project}/serviceAccounts/{service_account}\n" +
	"#com.google.cloud.iam.credentials.v1B\x19IAMCredentialsCommonProtoP\x01Z.go.alis.build/common/google/iam/credentials/v1\xf8\x01\x01\xaa\x02\x1fGoogle.Cloud.Iam.Credentials.V1\xca\x02\x1fGoogle\\Cloud\\Iam\\Credentials\\V1b\x06proto3"
...
var file_google_iam_credentials_v1_common_proto_goTypes = []any{
	...
	(*protobuf.Duration)(nil),           // 8: google.protobuf.Duration
