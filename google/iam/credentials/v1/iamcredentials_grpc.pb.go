...
func (c *iAMCredentialsClient) GenerateAccessToken(ctx context.Context, in *GenerateAccessTokenRequest, opts ...grpc.CallOption) (*GenerateAccessTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, IAMCredentials_GenerateAccessToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *iAMCredentialsClient) GenerateIdToken(ctx context.Context, in *GenerateIdTokenRequest, opts ...grpc.CallOption) (*GenerateIdTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, IAMCredentials_GenerateIdToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *iAMCredentialsClient) SignBlob(ctx context.Context, in *SignBlobRequest, opts ...grpc.CallOption) (*SignBlobResponse, error) {
	...
	err := c.cc.Invoke(ctx, IAMCredentials_SignBlob_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *iAMCredentialsClient) SignJwt(ctx context.Context, in *SignJwtRequest, opts ...grpc.CallOption) (*SignJwtResponse, error) {
	...
	err := c.cc.Invoke(ctx, IAMCredentials_SignJwt_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations must embed UnimplementedIAMCredentialsServer
...
// UnimplementedIAMCredentialsServer must be embedded to have
...
func (UnimplementedIAMCredentialsServer) GenerateIdToken(context.Context, *GenerateIdTokenRequest) (*GenerateIdTokenResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GenerateIdToken not implemented")
}
...
func (UnimplementedIAMCredentialsServer) mustEmbedUnimplementedIAMCredentialsServer() {}
func (UnimplementedIAMCredentialsServer) testEmbeddedByValue()                        {}
...
func RegisterIAMCredentialsServer(s grpc.ServiceRegistrar, srv IAMCredentialsServer) {
	// If the following call panics, it indicates UnimplementedIAMCredentialsServer was
