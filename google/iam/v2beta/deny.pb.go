...
type DenyRule struct {
	...
	DenialCondition *_type.Expr `protobuf:"bytes,5,opt,name=denial_condition,json=denialCondition,proto3" json:"denial_condition,omitempty"`
...
func (x *DenyRule) GetDenialCondition() *_type.Expr {
	if x != nil {
...
const file_google_iam_v2beta_deny_proto_rawDesc = "" +
	"\n" +
	"\x1cgoogle/iam/v2beta/deny.proto\x12\x11google.iam.v2beta\x1a\x16google/type/expr.proto\"\x8c\x02\n" +
	"\bDenyRule\x12+\n" +
	...
	"\x10denial_condition\x18\x05 \x01(\v2\x11.google.type.ExprR\x0fdenialConditionB\x84\x01\n" +
	"\x15com.google.iam.v2betaB\rDenyRuleProtoP\x01Z&go.alis.build/common/google/iam/v2beta\xaa\x02\x17Google.Cloud.Iam.V2Beta\xca\x02\x17Google\\Cloud\\Iam\\V2betab\x06proto3"

var (
	file_google_iam_v2beta_deny_proto_rawDescOnce sync.Once
	file_google_iam_v2beta_deny_proto_rawDescData []byte
)

func file_google_iam_v2beta_deny_proto_rawDescGZIP() []byte {
	file_google_iam_v2beta_deny_proto_rawDescOnce.Do(func() {
		file_google_iam_v2beta_deny_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_iam_v2beta_deny_proto_rawDesc), len(file_google_iam_v2beta_deny_proto_rawDesc)))
	})
...
var file_google_iam_v2beta_deny_proto_goTypes = []any{
	...
	(*_type.Expr)(nil), // 1: google.type.Expr
}
...
func file_google_iam_v2beta_deny_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_iam_v2beta_deny_proto_rawDesc), len(file_google_iam_v2beta_deny_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
