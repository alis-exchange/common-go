...
func (x *SetIamPolicyRequest) GetUpdateMask() *protobuf.FieldMask {
	if x != nil {
		return x.UpdateMask
	}
	return nil
...
const file_google_iam_v1_iam_policy_proto_rawDesc = "" +
	"\n" +
	"\x1egoogle/iam/v1/iam_policy.proto\x12\rgoogle.iam.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1bgoogle/iam/v1/options.proto\x1a\x1agoogle/iam/v1/policy.proto\x1a google/protobuf/field_mask.proto\"\xaf\x01\n" +
	"\x13SetIamPolicyRequest\x12&\n" +
	"\bresource\x18\x01 \x01(\tB\n" +
	"\xe2A\x01\x02\xfaA\x03\n" +
	"\x01*R\bresource\x123\n" +
	"\x06policy\x18\x02 \x01(\v2\x15.google.iam.v1.PolicyB\x04\xe2A\x01\x02R\x06policy\x12;\n" +
	...
	"\x12TestIamPermissions\x12(.google.iam.v1.TestIamPermissionsRequest\x1a).google.iam.v1.TestIamPermissionsResponse\"/\x82\xd3\xe4\x93\x02):\x01*\"$/v1/{resource=**}:testIamPermissions\x1a\x1e\xcaA\x1biam-meta-api.googleapis.comBx\n" +
	"\x11com.google.iam.v1B\x0eIamPolicyProtoP\x01Z\"go.alis.build/common/google/iam/v1\xf8\x01\x01\xaa\x02\x13Google.Cloud.Iam.V1\xca\x02\x13Google\\Cloud\\Iam\\V1b\x06proto3"
...
var file_google_iam_v1_iam_policy_proto_goTypes = []any{
	...
	(*protobuf.FieldMask)(nil),         // 5: google.protobuf.FieldMask
