...
const file_google_iam_v1_policy_proto_rawDesc = "" +
	...
	"\n" +
	"\x06REMOVE\x10\x02Bu\n" +
	"\x11com.google.iam.v1B\vPolicyProtoP\x01Z\"go.alis.build/common/google/iam/v1\xf8\x01\x01\xaa\x02\x13Google.Cloud.Iam.V1\xca\x02\x13Google\\Cloud\\Iam\\V1b\x06proto3"
