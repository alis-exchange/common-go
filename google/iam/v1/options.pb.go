...
const file_google_iam_v1_options_proto_rawDesc = "" +
	...
	"\x18requested_policy_version\x18\x01 \x01(\x05R\x16requestedPolicyVersionBv\n" +
	"\x11com.google.iam.v1B\fOptionsProtoP\x01Z\"go.alis.build/common/google/iam/v1\xf8\x01\x01\xaa\x02\x13Google.Cloud.Iam.V1\xca\x02\x13Google\\Cloud\\Iam\\V1b\x06proto3"
