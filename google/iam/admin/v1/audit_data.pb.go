...
const file_google_iam_admin_v1_audit_data_proto_rawDesc = "" +
	...
	"\x13removed_permissions\x18\x02 \x03(\tR\x12removedPermissionsB\x8d\x01\n" +
	"\x17com.google.iam.admin.v1B\x0eAuditDataProtoP\x01Z(go.alis.build/common/google/iam/admin/v1\xaa\x02\x19Google.Cloud.Iam.Admin.V1\xca\x02\x19Google\\Cloud\\Iam\\Admin\\V1b\x06proto3"
