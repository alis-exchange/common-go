...
const file_google_iam_v2_policy_proto_rawDesc = "" +
	"\n" +
	"\x1agoogle/iam/v2/policy.proto\x12\rgoogle.iam.v2\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x18google/iam/v2/deny.proto\x1a#google/longrunning/operations.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc4\x04\n" +
	"\x06Policy\x12\x18\n" +
	...
	"deleteTime\x12/\n" +
	"\x05rules\x18\n" +
	" \x03(\v2\x19.google.iam.v2.PolicyRuleR\x05rules\x123\n" +
	"\x12managing_authority\x18\v \x01(\tB\x04\xe2A\x01\x05R\x11managingAuthority\x1a>\n" +
	...
	"\x04name\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\x04name\"\x85\x01\n" +
	"\x13CreatePolicyRequest\x12\x1c\n" +
	"\x06parent\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\x06parent\x123\n" +
	"\x06policy\x18\x02 \x01(\v2\x15.google.iam.v2.PolicyB\x04\xe2A\x01\x02R\x06policy\x12\x1b\n" +
	"\tpolicy_id\x18\x03 \x01(\tR\bpolicyId\"J\n" +
	"\x13UpdatePolicyRequest\x123\n" +
	"\x06policy\x18\x01 \x01(\v2\x15.google.iam.v2.PolicyB\x04\xe2A\x01\x02R\x06policy\"I\n" +
	...
	"\x06Policy\x12\x17PolicyOperationMetadata\xdaA\x04name\x82\xd3\xe4\x93\x02\x1b*\x19/v2/{name=policies/*/*/*}\x1aF\xcaA\x12iam.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformBr\n" +
	"\x11com.google.iam.v2B\vPolicyProtoP\x01Z\"go.alis.build/common/google/iam/v2\xaa\x02\x13Google.Cloud.Iam.V2\xca\x02\x13Google\\Cloud\\Iam\\V2b\x06proto3"
