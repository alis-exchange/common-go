...
const file_google_iam_v2_deny_proto_rawDesc = "" +
	...
	"\x10denial_condition\x18\x05 \x01(\v2\x11.google.type.ExprR\x0fdenialConditionBt\n" +
	"\x11com.google.iam.v2B\rDenyRuleProtoP\x01Z\"go.alis.build/common/google/iam/v2\xaa\x02\x13Google.Cloud.Iam.V2\xca\x02\x13Google\\Cloud\\Iam\\V2b\x06proto3"
