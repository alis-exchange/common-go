...
type AuditContext struct {
	...
	ScrubbedRequest *protobuf.Struct `protobuf:"bytes,2,opt,name=scrubbed_request,json=scrubbedRequest,proto3" json:"scrubbed_request,omitempty"`
	// An API response message that is scrubbed based on the method annotation.
	// This field should only be filled if audit_log field is present.
	// Service Control will use this to assemble a complete log for Cloud Audit
	// Logs and Google internal audit logs.
	ScrubbedResponse *protobuf.Struct `protobuf:"bytes,3,opt,name=scrubbed_response,json=scrubbedResponse,proto3" json:"scrubbed_response,omitempty"`
...
func (x *AuditContext) GetScrubbedRequest() *protobuf.Struct {
	if x != nil {
...
func (x *AuditContext) GetScrubbedResponse() *protobuf.Struct {
	if x != nil {
...
const file_google_rpc_context_audit_context_proto_rawDesc = "" +
	...
	"\x0ftarget_resource\x18\x05 \x01(\tR\x0etargetResourceBY\n" +
	"\x16com.google.rpc.contextB\x11AuditContextProtoP\x01Z'go.alis.build/common/google/rpc/context\xf8\x01\x01b\x06proto3"
...
var file_google_rpc_context_audit_context_proto_goTypes = []any{
	...
	(*protobuf.Struct)(nil), // 1: google.protobuf.Struct
}
