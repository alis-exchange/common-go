...
type AttributeContext struct {
	...
	Extensions    []*protobuf.Any `protobuf:"bytes,8,rep,name=extensions,proto3" json:"extensions,omitempty"`
...
func (x *AttributeContext) GetExtensions() []*protobuf.Any {
	if x != nil {
		return x.Extensions
	}
	return nil
...
type AttributeContext_Auth struct {
	...
	// dependent structure.
	Claims *protobuf.Struct `protobuf:"bytes,4,opt,name=claims,proto3" json:"claims,omitempty"`
...
func (x *AttributeContext_Auth) GetClaims() *protobuf.Struct {
	if x != nil {
		return x.Claims
	}
	return nil
...
type AttributeContext_Request struct {
	...
	// the request.
	Time *protobuf.Timestamp `protobuf:"bytes,9,opt,name=time,proto3" json:"time,omitempty"`
...
func (x *AttributeContext_Request) GetTime() *protobuf.Timestamp {
	if x != nil {
		return x.Time
	}
	return nil
...
type AttributeContext_Response struct {
	...
	// the response.
	Time *protobuf.Timestamp `protobuf:"bytes,4,opt,name=time,proto3" json:"time,omitempty"`
	// The amount of time it takes the backend service to fully respond to a
	// request. Measured from when the destination service starts to send the
	// request to the backend until when the destination service receives the
	// complete response from the backend.
	BackendLatency *protobuf.Duration `protobuf:"bytes,5,opt,name=backend_latency,json=backendLatency,proto3" json:"backend_latency,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *AttributeContext_Response) GetTime() *protobuf.Timestamp {
	if x != nil {
		return x.Time
	}
	return nil
...
func (x *AttributeContext_Response) GetBackendLatency() *protobuf.Duration {
	if x != nil {
...
type AttributeContext_Resource struct {
	...
	CreateTime *protobuf.Timestamp `protobuf:"bytes,8,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`
	// Output only. The timestamp when the resource was last updated. Any
	// change to the resource made by users must refresh this value.
	// Changes to a resource made by the service should refresh this value.
	UpdateTime *protobuf.Timestamp `protobuf:"bytes,9,opt,name=update_time,json=updateTime,proto3" json:"update_time,omitempty"`
	// Output only. The timestamp when the resource was deleted.
	// If the resource is not deleted, this must be empty.
	DeleteTime *protobuf.Timestamp `protobuf:"bytes,10,opt,name=delete_time,json=deleteTime,proto3" json:"delete_time,omitempty"`
...
func (x *AttributeContext_Resource) GetCreateTime() *protobuf.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *AttributeContext_Resource) GetUpdateTime() *protobuf.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
func (x *AttributeContext_Resource) GetDeleteTime() *protobuf.Timestamp {
	if x != nil {
		return x.DeleteTime
	}
	return nil
...
const file_google_rpc_context_attribute_context_proto_rawDesc = "" +
	...
	"\x16com.google.rpc.contextB\x15AttributeContextProtoP\x01Z'go.alis.build/common/google/rpc/context\xf8\x01\x01b\x06proto3"
...
var file_google_rpc_context_attribute_context_proto_goTypes = []any{
	...
	(*protobuf.Struct)(nil),           // 13: google.protobuf.Struct
	(*protobuf.Timestamp)(nil),        // 14: google.protobuf.Timestamp
	(*protobuf.Duration)(nil),         // 15: google.protobuf.Duration
}
