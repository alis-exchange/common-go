...
type RetryInfo struct {
	...
	RetryDelay    *protobuf.Duration `protobuf:"bytes,1,opt,name=retry_delay,json=retryDelay,proto3" json:"retry_delay,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RetryInfo) GetRetryDelay() *protobuf.Duration {
	if x != nil {
		return x.RetryDelay
	}
	return nil
...
const file_google_rpc_error_details_proto_rawDesc = "" +
	...
	"\x0ecom.google.rpcB\x11ErrorDetailsProtoP\x01Z\x1fgo.alis.build/common/google/rpc\xa2\x02\x03RPCb\x06proto3"
