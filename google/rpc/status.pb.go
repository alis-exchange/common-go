...
type Status struct {
	...
	Details       []*protobuf.Any `protobuf:"bytes,3,rep,name=details,proto3" json:"details,omitempty"`
...
func (x *Status) GetDetails() []*protobuf.Any {
	if x != nil {
		return x.Details
	}
	return nil
...
const file_google_rpc_status_proto_rawDesc = "" +
	...
	"\adetails\x18\x03 \x03(\v2\x14.google.protobuf.AnyR\adetailsBI\n" +
	"\x0ecom.google.rpcB\vStatusProtoP\x01Z\x1fgo.alis.build/common/google/rpc\xf8\x01\x01\xa2\x02\x03RPCb\x06proto3"
