...
func (x *WaitOperationRequest) GetTimeout() *protobuf.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
const file_google_longrunning_operations_proto_rawDesc = "" +
	...
	"\x0eoperation_info\x12\x1e.google.protobuf.MethodOptions\x18\x99\b \x01(\v2!.google.longrunning.OperationInfoR\roperationInfoB\x81\x01\n" +
	"\x16com.google.longrunningB\x0fOperationsProtoP\x01Z'go.alis.build/common/google/longrunning\xf8\x01\x01\xaa\x02\x12Google.LongRunning\xca\x02\x12Google\\LongRunningb\x06proto3"
...
var file_google_longrunning_operations_proto_goTypes = []any{
	...
	(*protobuf.Any)(nil),           // 8: google.protobuf.Any
	(*rpc.Status)(nil),             // 9: google.rpc.Status
	(*protobuf.Duration)(nil),      // 10: google.protobuf.Duration
	(*protobuf.MethodOptions)(nil), // 11: google.protobuf.MethodOptions
