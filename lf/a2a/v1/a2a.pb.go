...
func (x *Part) GetData() *protobuf.Value {
	if x != nil {
...
type Part_Data struct {
	...
	Data *protobuf.Value `protobuf:"bytes,4,opt,name=data,proto3,oneof"`
}
...
// Deprecated: Marked as deprecated in lf/a2a/v1/a2a.proto.
...
type ListTasksRequest struct {
	...
	StatusTimestampAfter *protobuf.Timestamp `protobuf:"bytes,7,opt,name=status_timestamp_after,json=statusTimestampAfter,proto3" json:"status_timestamp_after,omitempty"`
...
func (x *ListTasksRequest) GetStatusTimestampAfter() *protobuf.Timestamp {
	if x != nil {
...
func (x *CancelTaskRequest) GetMetadata() *protobuf.Struct {
	if x != nil {
		return x.Metadata
	}
	return nil
...
const file_lf_a2a_v1_a2a_proto_rawDesc = "" +
	...
	"\x0f_history_length\"\x86\x02\n" +
	"\x04Task\x12\x14\n" +
	"\x02id\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\x02id\x12\x1d\n" +
	"\n" +
	"context_id\x18\x02 \x01(\tR\tcontextId\x123\n" +
	"\x06status\x18\x03 \x01(\v2\x15.lf.a2a.v1.TaskStatusB\x04\xe2A\x01\x02R\x06status\x121\n" +
	...
	"\bmetadata\x18\x06 \x01(\v2\x17.google.protobuf.StructR\bmetadata\"\xa6\x01\n" +
	"\n" +
	"TaskStatus\x120\n" +
	"\x05state\x18\x01 \x01(\x0e2\x14.lf.a2a.v1.TaskStateB\x04\xe2A\x01\x02R\x05state\x12,\n" +
	...
	"\x04role\x18\x04 \x01(\x0e2\x0f.lf.a2a.v1.RoleB\x04\xe2A\x01\x02R\x04role\x12+\n" +
	"\x05parts\x18\x05 \x03(\v2\x0f.lf.a2a.v1.PartB\x04\xe2A\x01\x02R\x05parts\x123\n" +
	"\bmetadata\x18\x06 \x01(\v2\x17.google.protobuf.StructR\bmetadata\x12\x1e\n" +
	"\n" +
	"extensions\x18\a \x03(\tR\n" +
	"extensions\x12,\n" +
	"\x12reference_task_ids\x18\b \x03(\tR\x10referenceTaskIds\"\xe9\x01\n" +
	"\bArtifact\x12%\n" +
	"\vartifact_id\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\n" +
	"artifactId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12+\n" +
	"\x05parts\x18\x04 \x03(\v2\x0f.lf.a2a.v1.PartB\x04\xe2A\x01\x02R\x05parts\x123\n" +
	...
	"\n" +
	"context_id\x18\x02 \x01(\tB\x04\xe2A\x01\x02R\tcontextId\x123\n" +
	"\x06status\x18\x03 \x01(\v2\x15.lf.a2a.v1.TaskStatusB\x04\xe2A\x01\x02R\x06status\x123\n" +
	"\bmetadata\x18\x04 \x01(\v2\x17.google.protobuf.StructR\bmetadata\"\x80\x02\n" +
	"\x17TaskArtifactUpdateEvent\x12\x1d\n" +
	"\atask_id\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\x06taskId\x12#\n" +
	"\n" +
	"context_id\x18\x02 \x01(\tB\x04\xe2A\x01\x02R\tcontextId\x125\n" +
	"\bartifact\x18\x03 \x01(\v2\x13.lf.a2a.v1.ArtifactB\x04\xe2A\x01\x02R\bartifact\x12\x16\n" +
	...
	"\x12AuthenticationInfo\x12\x1c\n" +
	"\x06scheme\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\x06scheme\x12 \n" +
	"\vcredentials\x18\x02 \x01(\tR\vcredentials\"\xa2\x01\n" +
	...
	"\x10protocol_version\x18\x04 \x01(\tB\x04\xe2A\x01\x02R\x0fprotocolVersion\"\xa0\a\n" +
	"\tAgentCard\x12\x18\n" +
	"\x04name\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\x04name\x12&\n" +
	"\vdescription\x18\x02 \x01(\tB\x04\xe2A\x01\x02R\vdescription\x12R\n" +
	"\x14supported_interfaces\x18\x03 \x03(\v2\x19.lf.a2a.v1.AgentInterfaceB\x04\xe2A\x01\x02R\x13supportedInterfaces\x124\n" +
	"\bprovider\x18\x04 \x01(\v2\x18.lf.a2a.v1.AgentProviderR\bprovider\x12\x1e\n" +
	"\aversion\x18\x05 \x01(\tB\x04\xe2A\x01\x02R\aversion\x120\n" +
	"\x11documentation_url\x18\x06 \x01(\tH\x00R\x10documentationUrl\x88\x01\x01\x12F\n" +
	"\fcapabilities\x18\a \x01(\v2\x1c.lf.a2a.v1.AgentCapabilitiesB\x04\xe2A\x01\x02R\fcapabilities\x12T\n" +
	"\x10security_schemes\x18\b \x03(\v2).lf.a2a.v1.AgentCard.SecuritySchemesEntryR\x0fsecuritySchemes\x12S\n" +
	"\x15security_requirements\x18\t \x03(\v2\x1e.lf.a2a.v1.SecurityRequirementR\x14securityRequirements\x124\n" +
	"\x13default_input_modes\x18\n" +
	" \x03(\tB\x04\xe2A\x01\x02R\x11defaultInputModes\x126\n" +
	"\x14default_output_modes\x18\v \x03(\tB\x04\xe2A\x01\x02R\x12defaultOutputModes\x123\n" +
	"\x06skills\x18\f \x03(\v2\x15.lf.a2a.v1.AgentSkillB\x04\xe2A\x01\x02R\x06skills\x12=\n" +
	"\n" +
	...
	"\x03url\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\x03url\x12(\n" +
	"\forganization\x18\x02 \x01(\tB\x04\xe2A\x01\x02R\forganization\"\x97\x02\n" +
	...
	"\x06params\x18\x04 \x01(\v2\x17.google.protobuf.StructR\x06params\"\xb3\x02\n" +
	"\n" +
	"AgentSkill\x12\x14\n" +
	...
	"\x15security_requirements\x18\b \x03(\v2\x1e.lf.a2a.v1.SecurityRequirementR\x14securityRequirements\"\x8d\x01\n" +
	...
	"\x06header\x18\x03 \x01(\v2\x17.google.protobuf.StructR\x06header\"\xd2\x01\n" +
	...
	"\x03url\x18\x04 \x01(\tB\x04\xe2A\x01\x02R\x03url\x12\x14\n" +
	...
	"\rbearer_format\x18\x03 \x01(\tR\fbearerFormat\"\x9b\x01\n" +
	"\x14OAuth2SecurityScheme\x12 \n" +
	"\vdescription\x18\x01 \x01(\tR\vdescription\x121\n" +
	"\x05flows\x18\x02 \x01(\v2\x15.lf.a2a.v1.OAuthFlowsB\x04\xe2A\x01\x02R\x05flows\x12.\n" +
	...
	"refreshUrl\x12O\n" +
	"\x06scopes\x18\x04 \x03(\v21.lf.a2a.v1.AuthorizationCodeOAuthFlow.ScopesEntryB\x04\xe2A\x01\x02R\x06scopes\x12#\n" +
	...
	"refreshUrl\x12O\n" +
	"\x06scopes\x18\x03 \x03(\v21.lf.a2a.v1.ClientCredentialsOAuthFlow.ScopesEntryB\x04\xe2A\x01\x02R\x06scopes\x1a9\n" +
	"\vScopesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\vrefresh_url\x18\x03 \x01(\tR\n" +
	"refreshUrl\x12H\n" +
	"\x06scopes\x18\x04 \x03(\v2*.lf.a2a.v1.DeviceCodeOAuthFlow.ScopesEntryB\x04\xe2A\x01\x02R\x06scopes\x1a9\n" +
	"\vScopesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xe0\x01\n" +
	"\x12SendMessageRequest\x12\x16\n" +
	"\x06tenant\x18\x01 \x01(\tR\x06tenant\x122\n" +
	"\amessage\x18\x02 \x01(\v2\x12.lf.a2a.v1.MessageB\x04\xe2A\x01\x02R\amessage\x12I\n" +
	...
	"\x12_include_artifacts\"\xb6\x01\n" +
	"\x11ListTasksResponse\x12+\n" +
	"\x05tasks\x18\x01 \x03(\v2\x0f.lf.a2a.v1.TaskB\x04\xe2A\x01\x02R\x05tasks\x12,\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tB\x04\xe2A\x01\x02R\rnextPageToken\x12!\n" +
	"\tpage_size\x18\x03 \x01(\x05B\x04\xe2A\x01\x02R\bpageSize\x12#\n" +
	"\n" +
	"total_size\x18\x04 \x01(\x05B\x04\xe2A\x01\x02R\ttotalSize\"v\n" +
	"\x11CancelTaskRequest\x12\x16\n" +
	"\x06tenant\x18\x01 \x01(\tR\x06tenant\x12\x14\n" +
	"\x02id\x18\x02 \x01(\tB\x04\xe2A\x01\x02R\x02id\x123\n" +
	"\bmetadata\x18\x03 \x01(\v2\x17.google.protobuf.StructR\bmetadata\"s\n" +
	"$GetTaskPushNotificationConfigRequest\x12\x16\n" +
	"\x06tenant\x18\x01 \x01(\tR\x06tenant\x12\x1d\n" +
	"\atask_id\x18\x02 \x01(\tB\x04\xe2A\x01\x02R\x06taskId\x12\x14\n" +
	"\x02id\x18\x03 \x01(\tB\x04\xe2A\x01\x02R\x02id\"v\n" +
	"'DeleteTaskPushNotificationConfigRequest\x12\x16\n" +
	"\x06tenant\x18\x01 \x01(\tR\x06tenant\x12\x1d\n" +
	"\atask_id\x18\x02 \x01(\tB\x04\xe2A\x01\x02R\x06taskId\x12\x14\n" +
	"\x02id\x18\x03 \x01(\tB\x04\xe2A\x01\x02R\x02id\"F\n" +
	"\x16SubscribeToTaskRequest\x12\x16\n" +
	"\x06tenant\x18\x01 \x01(\tR\x06tenant\x12\x14\n" +
	"\x02id\x18\x02 \x01(\tB\x04\xe2A\x01\x02R\x02id\"\x9b\x01\n" +
	"&ListTaskPushNotificationConfigsRequest\x12\x16\n" +
	"\x06tenant\x18\x04 \x01(\tR\x06tenant\x12\x1d\n" +
	"\atask_id\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\x06taskId\x12\x1b\n" +
	...
	"task_id,id\x82\xd3\xe4\x93\x02qZ<*:/{tenant}/tasks/{task_id=*}/pushNotificationConfigs/{id=*}*1/tasks/{task_id=*}/pushNotificationConfigs/{id=*}BI\n" +
	"\x14com.google.lf.a2a.v1B\x03A2AP\x01Z\x1ego.alis.build/common/lf/a2a/v1\xaa\x02\tLf.A2a.V1b\x06proto3"
...
var file_lf_a2a_v1_a2a_proto_goTypes = []any{
	...
	(*protobuf.Struct)(nil),    // 53: google.protobuf.Struct
	(*protobuf.Timestamp)(nil), // 54: google.protobuf.Timestamp
	(*protobuf.Value)(nil),     // 55: google.protobuf.Value
	(*protobuf.Empty)(nil),     // 56: google.protobuf.Empty
}
