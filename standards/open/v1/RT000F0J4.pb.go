...
const file_standards_open_v1_RT000F0J4_proto_rawDesc = "" +
	"\n" +
	"!standards/open/v1/RT000F0J4.proto\x12\x11standards.open.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x16google/type/date.proto\"\xe3o\n" +
	"\tRT000F0J4\x12`\n" +
	"\x13dataset_information\x18\x01 \x01(\v2/.standards.open.v1.RT000F0J4.DatasetInformationR\x12datasetInformation\x12o\n" +
	"\x18manufacturer_information\x18\x02 \x01(\v24.standards.open.v1.RT000F0J4.ManufacturerInformationR\x17manufacturerInformation\x12`\n" +
	"\x17per_product_information\x18\x03 \x03(\v2(.standards.open.v1.RT000F0J4.ProductDataR\x15perProductInformation\x1a\xa9\x05\n" +
	"\x12DatasetInformation\x12[\n" +
	"\veet_version\x18\x01 \x01(\x0e2:.standards.open.v1.RT000F0J4.DatasetInformation.EETVersionR\n" +
	"eetVersion\x12#\n" +
	"\rproducer_name\x18\x02 \x01(\tR\fproducerName\x12!\n" +
	"\fproducer_lei\x18\x03 \x01(\tR\vproducerLei\x12%\n" +
	"\x0eproducer_email\x18\x04 \x01(\tR\rproducerEmail\x12V\n" +
	"\x19file_generation_timestamp\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x17fileGenerationTimestamp\x12L\n" +
	"#data_reporting_sfdr_pre_contractual\x18\x06 \x01(\bR\x1fdataReportingSfdrPreContractual\x12?\n" +
	"\x1cdata_reporting_sfdr_periodic\x18\a \x01(\bR\x19dataReportingSfdrPeriodic\x12F\n" +
	" data_reporting_sfdr_entity_level\x18\b \x01(\bR\x1cdataReportingSfdrEntityLevel\x120\n" +
	"\x14data_reporting_mifid\x18\t \x01(\bR\x12dataReportingMifid\x12,\n" +
	"\x12data_reporting_idd\x18\n" +
	" \x01(\bR\x10dataReportingIdd\"8\n" +
	"\n" +
	"EETVersion\x12\x1b\n" +
	"\x17EET_VERSION_UNSPECIFIED\x10\x00\x12\r\n" +
	"\tVERSION_1\x10\x01\x1a\x94\t\n" +
	"\x17ManufacturerInformation\x12+\n" +
	"\x11manufacturer_name\x18\x01 \x01(\tR\x10manufacturerName\x12\x7f\n" +
	"\x16manufacturer_code_type\x18\x02 \x01(\x0e2I.standards.open.v1.RT000F0J4.ManufacturerInformation.ManufacturerCodeTypeR\x14manufacturerCodeType\x12+\n" +
	"\x11manufacturer_code\x18\x03 \x01(\tR\x10manufacturerCode\x12-\n" +
	"\x12manufacturer_email\x18\x04 \x01(\tR\x11manufacturerEmail\x12G\n" +
	"\x16general_reference_date\x18\x05 \x01(\v2\x11.google.type.DateR\x14generalReferenceDate\x12H\n" +
	"!manufacturer_pri_or_prb_signatory\x18\x06 \x01(\bR\x1dmanufacturerPriOrPrbSignatory\x12:\n" +
	"\x19manufacturer_pri_notation\x18\a \x01(\tR\x17manufacturerPriNotation\x12<\n" +
	"\x1amanufacturer_pri_compliant\x18\b \x01(\bR\x18manufacturerPriCompliant\x122\n" +
	"\x15manufacturer_pri_like\x18\t \x01(\bR\x13manufacturerPriLike\x12m\n" +
	"\x11other_commitments\x18\n" +
	" \x01(\x0e2@.standards.open.v1.RT000F0J4.ManufacturerInformation.CommitmentsR\x10otherCommitments\x12~\n" +
	"\x1astewardship_code_signatory\x18\v \x01(\x0e2@.standards.open.v1.RT000F0J4.ManufacturerInformation.CommitmentsR\x18stewardshipCodeSignatory\x12{\n" +
	";manufacturer_website_information_stewardship_and_engagement\x18\f \x01(\tR6manufacturerWebsiteInformationStewardshipAndEngagement\"5\n" +
	"\x14ManufacturerCodeType\x12\x14\n" +
	"\x10TYPE_UNSPECIFIED\x10\x00\x12\a\n" +
	"\x03LEI\x10\x01\"\x8a\x01\n" +
	"\vCommitments\x12\x1b\n" +
	"\x17COMMITMENTS_UNSPECIFIED\x10\x00\x12\n" +
	"\n" +
	"\x06A_TCFD\x10\x01\x12\x11\n" +
	"\rB_NZAMI_NZAOA\x10\x02\x12\x10\n" +
	"\fC_SBT_FOR_FI\x10\x03\x12\x16\n" +
	"\x12D_STEWARDSHIP_CODE\x10\x04\x12\n" +
	"\n" +
	"\x06E_UNGC\x10\x05\x12\t\n" +
	"\x05F_CDP\x10\x06\x1a\xdd^\n" +
	"\vProductData\x12u\n" +
	"\x16product_identification\x18\x01 \x01(\v2>.standards.open.v1.RT000F0J4.ProductData.ProductIdentificationR\x15productIdentification\x12s\n" +
	"\x16esg_screening_criteria\x18\x02 \x01(\v2=.standards.open.v1.RT000F0J4.ProductData.ESGScreeningCriteriaR\x14esgScreeningCriteria\x12l\n" +
	"\x13product_disclosures\x18\x03 \x01(\v2;.standards.open.v1.RT000F0J4.ProductData.ProductDisclosuresR\x12productDisclosures\x1a\xee\x04\n" +
	"\x15ProductIdentification\x12#\n" +
	"\rumbrella_fund\x18\x01 \x01(\tR\fumbrellaFund\x12\x1b\n" +
	"\tfund_name\x18\x02 \x01(\tR\bfundName\x12n\n" +
	"\rshare_classes\x18\x03 \x03(\v2I.standards.open.v1.RT000F0J4.ProductData.ProductIdentification.ShareClassR\fshareClasses\x1a\xa2\x03\n" +
	"\n" +
	"ShareClass\x122\n" +
	"\x15share_class_extension\x18\x01 \x01(\tR\x13shareClassExtension\x12$\n" +
	"\x0eshare_class_id\x18\x02 \x01(\tR\fshareClassId\x12\x92\x01\n" +
	"\x13share_class_id_type\x18\x03 \x01(\x0e2c.standards.open.v1.RT000F0J4.ProductData.ProductIdentification.ShareClass.ShareClassIdentifierTypesR\x10shareClassIdType\"\xa4\x01\n" +
	...
	"\aPERM_ID\x10\n" +
	"\x1a\xe5\f\n" +
	"\x14ESGScreeningCriteria\x12y\n" +
	"\x11sfdr_product_type\x18\a \x01(\x0e2M.standards.open.v1.RT000F0J4.ProductData.ESGScreeningCriteria.SFDRProductTypeR\x0fsfdrProductType\x12e\n" +
	"\n" +
	"esg_labels\x18\b \x03(\x0e2F.standards.open.v1.RT000F0J4.ProductData.ESGScreeningCriteria.ESGLabelR\tesgLabels\x12J\n" +
	"#fund_of_fund_min_exposure_article_8\x18\t \x01(\x01R\x1dfundOfFundMinExposureArticle8\x12J\n" +
	"#fund_of_fund_min_exposure_article_9\x18\n" +
	" \x01(\x01R\x1dfundOfFundMinExposureArticle9\x12r\n" +
	"\x0emain_esg_focus\x18\v \x03(\x0e2L.standards.open.v1.RT000F0J4.ProductData.ESGScreeningCriteria.MainFocusAreasR\fmainEsgFocus\x12%\n" +
	"\x0epai_considered\x18\f \x01(\bR\rpaiConsidered\"\xc6\x01\n" +
	"\x0fSFDRProductType\x12#\n" +
	"\x1fDOES_NOT_FOLLOW_SFDR_GUIDELINES\x10\x00\x12 \n" +
	"\x1cFOLLOWS_ARTICLE_6_GUIDELINES\x10\x01\x12\x12\n" +
	"\x0eARTICLE_8_LIKE\x10\x02\x12\x12\n" +
	"\x0eARTICLE_9_LIKE\x10\x03\x12\x16\n" +
	"\x12NOT_ARTICLE_8_OR_9\x10\x04\x12\x15\n" +
	"\x11ARTICLE_8_PRODUCT\x10\x05\x12\x15\n" +
	"\x11ARTICLE_9_PRODUCT\x10\x06\"\x94\x06\n" +
	"\bESGLabel\x12\x19\n" +
	"\x15ESG_LABEL_UNSPECIFIED\x10\x00\x12 \n" +
	"\x1cA_ICMA_GREEN_BOND_PRINCIPLES\x10\x01\x12\x1c\n" +
	"\x18B_EU_GREEN_BOND_STANDARD\x10\x02\x12(\n" +
	"$C_EU_ECOLABEL_FOR_FINANCIAL_PRODUCTS\x10\x03\x12\x15\n" +
	"\x11D_FNG_SIEGEL_FOND\x10\x04\x12!\n" +
	"\x1dE_CBI_CLIMATE_BONDS_STANDARDS\x10\x05\x12\"\n" +
	"\x1eF_ICMA_SOCIAL_BONDS_PRINCIPLES\x10\x06\x12\x11\n" +
	"\rG_LUXFLAG_ESG\x10\a\x12\x1d\n" +
	"\x19H_LUXFLAG_CLIMATE_FINANCE\x10\b\x12\x19\n" +
	"\x15I_LUXFLAG_ENVIRONMENT\x10\t\x120\n" +
	",J_KEIN_VERSTOSS_GEGEN_ATOMWAFFENSPERRVERTRAG\x10\n" +
	"\x12\t\n" +
	"\x05K_ISR\x10\v\x12\x1c\n" +
	"\x18L_TOWARDS_SUSTAINABILITY\x10\f\x12,\n" +
	...
	"(V_LUXFLAG_SUSTAINABLE_INSURANCE_PRODUCTS\x10\x16\x122\n" +
	".X_CHARTE_ESG_FRANCAISE_DES_PRODUITS_STRUCTURES\x10\x17\x12\v\n" +
	"\aZ_OTHER\x10c\"X\n" +
	"\x0eMainFocusAreas\x12\x15\n" +
	"\x11FOCUS_UNSPECIFIED\x10\x00\x12\x11\n" +
	"\rENVIRONMENTAL\x10\x01\x12\n" +
	"\n" +
	"\x06SOCIAL\x10\x02\x12\x10\n" +
	"\fGOVERNMENTAL\x10\x03\x1a\x89\x05\n" +
	"\x12ProductDisclosures\x12\x1c\n" +
	"\tlanguages\x18\x01 \x03(\tR\tlanguages\x12\xc5\x01\n" +
	"7pre_contractual_disclosure_for_financial_products_links\x18\x02 \x03(\v2Q.standards.open.v1.RT000F0J4.ProductData.ProductDisclosures.ProductDisclosureLinkR1preContractualDisclosureForFinancialProductsLinks\x12\x8d\x01\n" +
	"\x19periodic_disclosure_links\x18\x03 \x03(\v2Q.standards.open.v1.RT000F0J4.ProductData.ProductDisclosures.ProductDisclosureLinkR\x17periodicDisclosureLinks\x12w\n" +
	"0end_of_reporting_period_for_periodic_disclosures\x18\x04 \x01(\v2\x11.google.type.DateR*endOfReportingPeriodForPeriodicDisclosures\x1a\x83\x01\n" +
	"\x15ProductDisclosureLink\x12\x1a\n" +
	"\blanguage\x18\x01 \x01(\tR\blanguage\x12\x12\n" +
	"\x04link\x18\x02 \x01(\tR\x04link\x12:\n" +
	"\x0fproduction_date\x18\x03 \x01(\v2\x11.google.type.DateR\x0eproductionDate\x1a\x8eE\n" +
	"\x1bArticle8Article9Information\x12m\n" +
	"5does_article_8_fund_invest_in_sustainable_investments\x18\x01 \x01(\bR.doesArticle8FundInvestInSustainableInvestments\x12{\n" +
	...
	">does_article_8_min_investments_include_eu_taxonomy_investments\x18\x03 \x01(\bR6doesArticle8MinInvestmentsIncludeEuTaxonomyInvestments\x12\x85\x01\n" +
	"Bdoes_article_8_min_investments_include_non_eu_taxonomy_investments\x18\x04 \x01(\bR9doesArticle8MinInvestmentsIncludeNonEuTaxonomyInvestments\x12\x7f\n" +
	">does_min_investments_include_investments_with_social_objective\x18\x05 \x01(\bR7doesMinInvestmentsIncludeInvestmentsWithSocialObjective\x12\x7f\n" +
	...
	">does_article_9_min_investments_include_eu_taxonomy_investments\x18\a \x01(\bR6doesArticle9MinInvestmentsIncludeEuTaxonomyInvestments\x12\x85\x01\n" +
	"Bdoes_article_9_min_investments_include_non_eu_taxonomy_investments\x18\b \x01(\bR9doesArticle9MinInvestmentsIncludeNonEuTaxonomyInvestments\x12q\n" +
	...
	" \x01(\bR\x10thematicApproach\x12\x8b\x01\n" +
	"\x14environmental_themes\x18\v \x03(\x0e2X.standards.open.v1.RT000F0J4.ProductData.Article8Article9Information.EnvironmentalThemesR\x13environmentalThemes\x12v\n" +
	"\rsocial_themes\x18\f \x03(\x0e2Q.standards.open.v1.RT000F0J4.ProductData.Article8Article9Information.SocialThemesR\fsocialThemes\x12\x82\x01\n" +
	"\x11governance_themes\x18\r \x03(\x0e2U.standards.open.v1.RT000F0J4.ProductData.Article8Article9Information.GovernanceThemesR\x10governanceThemes\x12\xb2\x01\n" +
	"#TargetedSustainableDevelopmentGoals\x18\x0e \x03(\x0e2`.standards.open.v1.RT000F0J4.ProductData.Article8Article9Information.SustainableDevelopmentGoalsR#TargetedSustainableDevelopmentGoals\x126\n" +
	"\x17weight_eligible_issuers\x18\x0f \x01(\x01R\x15weightEligibleIssuers\x126\n" +
	"\x17number_eligible_issuers\x18\x10 \x01(\x05R\x15numberEligibleIssuers\x124\n" +
	"\x16weight_covered_issuers\x18\x11 \x01(\x01R\x14weightCoveredIssuers\x124\n" +
	"\x16number_covered_issuers\x18\x12 \x01(\x05R\x14numberCoveredIssuers\x124\n" +
	"\x16weight_engaged_issuers\x18\x13 \x01(\x01R\x14weightEngagedIssuers\x124\n" +
	"\x16number_engaged_issuers\x18\x14 \x01(\x05R\x14numberEngagedIssuers\x12#\n" +
	"\resg_benchmark\x18\x15 \x01(\bR\fesgBenchmark\x12,\n" +
	"\x12esg_benchmark_name\x18\x16 \x01(\tR\x10esgBenchmarkName\x12(\n" +
	"\x10esg_benchmark_id\x18\x17 \x01(\tR\x0eesgBenchmarkId\x12\x90\x01\n" +
	"\x15esg_benchmark_id_type\x18\x18 \x01(\x0e2].standards.open.v1.RT000F0J4.ProductData.Article8Article9Information.BenchmarkIdentifierTypesR\x12esgBenchmarkIdType\x12]\n" +
	"\"minimum_or_planned_allocation_date\x18\x19 \x01(\v2\x11.google.type.DateR\x1eminimumOrPlannedAllocationDate\x12\x98\x01\n" +
	...
	"-sustainable_investment_calculation_approaches\x18\x1b \x03(\x0e2o.standards.open.v1.RT000F0J4.ProductData.Article8Article9Information.SustainableInvestmentCalculationApproachesR*sustainableInvestmentCalculationApproaches\x12Z\n" +
	...
	"\x1dlast_reported_allocation_date\x18\" \x01(\v2\x11.google.type.DateR\x1alastReportedAllocationDate\x12\x9d\x01\n" +
	...
	"'reduction_in_carbon_emissions_objective\x18+ \x01(\bR#reductionInCarbonEmissionsObjective\x12?\n" +
	"\x1caligned_with_paris_agreement\x18, \x01(\bR\x19alignedWithParisAgreement\x12b\n" +
	".consider_end_client_sustainability_preferences\x18- \x01(\bR*considerEndClientSustainabilityPreferences\x12\x82\x01\n" +
	...
	"\x1dsubject_to_third_party_review\x180 \x01(\bR\x19subjectToThirdPartyReview\x12\xe1\x01\n" +
	"6methodology_used_for_eu_taxonomy_alignment_calculation\x181 \x01(\x0e2o.standards.open.v1.RT000F0J4.ProductData.Article8Article9Information.SustainableInvestmentCalculationApproachesR0methodologyUsedForEuTaxonomyAlignmentCalculation\x12Q\n" +
	"%minimum_share_transitional_activities\x182 \x01(\x01R\"minimumShareTransitionalActivities\x12I\n" +
	"!minimum_share_enabling_activities\x183 \x01(\x01R\x1eminimumShareEnablingActivities\x12i\n" +
	"2percentage_taxonomy_aligned_incl_sovereign_revenue\x184 \x01(\x01R-percentageTaxonomyAlignedInclSovereignRevenue\x12e\n" +
	"0percentage_taxonomy_aligned_incl_sovereign_capex\x185 \x01(\x01R+percentageTaxonomyAlignedInclSovereignCapex\x12c\n" +
	"/percentage_taxonomy_aligned_incl_sovereign_opex\x186 \x01(\x01R*percentageTaxonomyAlignedInclSovereignOpex\x12i\n" +
	"2percentage_taxonomy_aligned_excl_sovereign_revenue\x187 \x01(\x01R-percentageTaxonomyAlignedExclSovereignRevenue\x12e\n" +
	"0percentage_taxonomy_aligned_excl_sovereign_capex\x188 \x01(\x01R+percentageTaxonomyAlignedExclSovereignCapex\x12c\n" +
	"/percentage_taxonomy_aligned_excl_sovereign_opex\x189 \x01(\x01R*percentageTaxonomyAlignedExclSovereignOpex\x12o\n" +
	...
	"8percentage_taxonomy_aligned_share_of_enabling_activities\x18A \x01(\x01R2percentageTaxonomyAlignedShareOfEnablingActivities\"\xff\x01\n" +
	"\x13EnvironmentalThemes\x12#\n" +
	"\x1fENVIRONMENTAL_THEME_UNSPECIFIED\x10\x00\x12\f\n" +
	"\bA_ENERGY\x10\x01\x12\x16\n" +
	"\x12B_RENEWABLE_ENERGY\x10\x02\x12\x13\n" +
	"\x0fC_RAW_MATERIALS\x10\x03\x12\x14\n" +
	"\x10D_WATER_AND_LAND\x10\x04\x12\v\n" +
	"\aE_WASTE\x10\x05\x12\x1e\n" +
	"\x1aF_GREENHOUSE_GAS_EMISSIONS\x10\x06\x12\x12\n" +
	"\x0eG_BIODIVERSITY\x10\a\x12\x16\n" +
	"\x12H_CIRCULAR_ECONOMY\x10\b\x12\x19\n" +
	"\x15I_ENVIRONMENTAL_OTHER\x10\t\"\xf8\x01\n" +
	"\fSocialThemes\x12\x1c\n" +
	"\x18SOCIAL_THEME_UNSPECIFIED\x10\x00\x12\x10\n" +
	"\fA_INEQUALITY\x10\x01\x12\x15\n" +
	"\x11B_SOCIAL_COHESION\x10\x02\x12\x18\n" +
	"\x14C_SOCIAL_INTEGRATION\x10\x03\x12\x16\n" +
	"\x12D_LABOUR_RELATIONS\x10\x04\x12!\n" +
	"\x1dE_INVESTMENT_IN_HUMAN_CAPITAL\x10\x05\x128\n" +
	"4F_ECONOMICALLY_OR_SOCIALLY_DISADVANTAGED_COMMUNITIES\x10\x06\x12\x12\n" +
	"\x0eG_SOCIAL_OTHER\x10\a\"\xbb\x01\n" +
	"\x10GovernanceThemes\x12 \n" +
	"\x1cGOVERNANCE_THEME_UNSPECIFIED\x10\x00\x12!\n" +
	"\x1dA_SOUND_MANAGEMENT_STRUCTURES\x10\x01\x12\x18\n" +
	"\x14B_EMPLOYEE_RELATIONS\x10\x02\x12\x1b\n" +
	"\x17C_RENUMERATION_OF_STAFF\x10\x03\x12\x14\n" +
	"\x10D_TAX_COMPLIANCE\x10\x04\x12\x15\n" +
	"\x11E_GOVERANCE_OTHER\x10\x05\"\xc6\x04\n" +
	"\x1bSustainableDevelopmentGoals\x12\x13\n" +
	"\x0fSDG_UNSPECIFIED\x10\x00\x12\x10\n" +
	"\fA_NO_POVERTY\x10\x01\x12\x0f\n" +
	"\vB_NO_HUNGER\x10\x02\x12\x1f\n" +
	"\x1bC_GOOD_HEALTH_AND_WELLBEING\x10\x03\x12\x17\n" +
	"\x13D_QUALITY_EDUCATION\x10\x04\x12\x15\n" +
	"\x11E_GENDER_EQUALITY\x10\x05\x12 \n" +
	"\x1cF_CLEAN_WATER_AND_SANITATION\x10\x06\x12!\n" +
	"\x1dG_AFFORDABLE_AND_CLEAN_ENERGY\x10\a\x12%\n" +
	"!H_DECENT_WORK_AND_ECONOMIC_GROWTH\x10\b\x12,\n" +
	"(I_INDUSTRY_INNOVATION_AND_INFRASTRUCTURE\x10\t\x12\x18\n" +
	"\x14J_REDUCED_INEQUALITY\x10\n" +
	"\x12(\n" +
	"$K_SUSTAINABLE_CITIES_AND_COMMUNITIES\x10\v\x12,\n" +
	"(L_RESPONSIBLE_CONSUMPTION_AND_PRODUCTION\x10\f\x12\x14\n" +
	...
	"\x18BenchmarkIdentifierTypes\x12\x1a\n" +
	"\x16IDENTIFIER_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04ISIN\x10\x01\x12\a\n" +
	"\x03RIC\x10\x02\x12\b\n" +
	"\x04FIGI\x10\x03\x12\v\n" +
	"\aPERM_ID\x10\x04\"t\n" +
	"*SustainableInvestmentCalculationApproaches\x12$\n" +
	" CALCULATION_APPROACH_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aREVENUE\x10\x01\x12\t\n" +
	"\x05CAPEX\x10\x02\x12\b\n" +
	"\x04OPEX\x10\x03\"K\n" +
	"\x0fRT000F0J4_batch\x128\n" +
	"\bresponse\x18\x01 \x03(\v2\x1c.standards.open.v1.RT000F0J4R\bresponseB(Z&go.alis.build/common/standards/open/v1b\x06proto3"

var (
	file_standards_open_v1_RT000F0J4_proto_rawDescOnce sync.Once
	file_standards_open_v1_RT000F0J4_proto_rawDescData []byte
)

func file_standards_open_v1_RT000F0J4_proto_rawDescGZIP() []byte {
	file_standards_open_v1_RT000F0J4_proto_rawDescOnce.Do(func() {
		file_standards_open_v1_RT000F0J4_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_standards_open_v1_RT000F0J4_proto_rawDesc), len(file_standards_open_v1_RT000F0J4_proto_rawDesc)))
	})
...
var file_standards_open_v1_RT000F0J4_proto_goTypes = []any{
...
func file_standards_open_v1_RT000F0J4_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_standards_open_v1_RT000F0J4_proto_rawDesc), len(file_standards_open_v1_RT000F0J4_proto_rawDesc)),
			NumEnums:      13,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
