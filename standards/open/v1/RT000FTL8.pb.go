...
const file_standards_open_v1_RT000FTL8_proto_rawDesc = "" +
	"\n" +
	"!standards/open/v1/RT000FTL8.proto\x12\x11standards.open.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x19google/api/resource.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x17google/type/month.proto\x1a\x16google/type/date.proto\x1a\x1bstandards/open/v1/rag.proto\"\xe1{\n" +
	"\tRT000FTL8\x12=\n" +
	"\ametrics\x18\x14 \x03(\v2#.standards.open.v1.RT000FTL8.MetricR\ametrics\x12\\\n" +
	"\x10net_asset_values\x183 \x03(\v22.standards.open.v1.RT000FTL8.NetAssetValueSnapshotR\x0enetAssetValues\x12i\n" +
	"\x17security_pricing_errors\x185 \x03(\v21.standards.open.v1.RT000FTL8.SecurityPricingErrorR\x15securityPricingErrors\x12U\n" +
	"\x10stale_securities\x186 \x03(\v2*.standards.open.v1.RT000FTL8.StaleSecurityR\x0fstaleSecurities\x12J\n" +
	"\fstock_breaks\x187 \x03(\v2'.standards.open.v1.RT000FTL8.StockBreakR\vstockBreaks\x12G\n" +
	"\vcash_breaks\x188 \x03(\v2&.standards.open.v1.RT000FTL8.CashBreakR\n" +
	"cashBreaks\x12`\n" +
	"\x14total_expense_ratios\x189 \x03(\v2..standards.open.v1.RT000FTL8.TotalExpenseRatioR\x12totalExpenseRatios\x12M\n" +
	"\x0frecent_invoices\x18: \x03(\v2$.standards.open.v1.RT000FTL8.InvoiceR\x0erecentInvoices\x12`\n" +
	"\x14swing_pricing_events\x18; \x03(\v2..standards.open.v1.RT000FTL8.SwingPricingEventR\x12swingPricingEvents\x12q\n" +
	"\x1eper_share_class_nav_historical\x18< \x03(\v2-.standards.open.v1.RT000FTL8.PerShareClassNAVR\x1aperShareClassNavHistorical\x12q\n" +
	"\x16nav_calculation_errors\x18= \x03(\v2;.standards.open.v1.RT000FTL8.NAVCalculationErrorInformationR\x14navCalculationErrors\x12^\n" +
	"\x13investment_breaches\x18> \x03(\v2-.standards.open.v1.RT000FTL8.InvestmentBreachR\x12investmentBreaches\x1a\xca\x15\n" +
	"\x06Metric\x12:\n" +
	...
	"\tmetric_id\x18\b \x01(\x0e2,.standards.open.v1.RT000FTL8.Metric.MetricIDR\bmetricId\x12L\n" +
	"\n" +
	"value_type\x18\t \x01(\x0e2-.standards.open.v1.RT000FTL8.Metric.ValueTypeR\tvalueType\x12#\n" +
	"\rcurrency_code\x18\n" +
	" \x01(\tR\fcurrencyCode\x12\x16\n" +
	"\x06metric\x18\v \x01(\x01R\x06metric\x12[\n" +
	"\x0fevaluation_type\x18\f \x01(\x0e22.standards.open.v1.RT000FTL8.Metric.EvaluationTypeR\x0eevaluationType\x122\n" +
	...
	"\bcomments\x18c \x01(\tR\bcomments\"\xf1\f\n" +
	"\bMetricID\x12\x19\n" +
	...
	"\bMINIMISE\x10\x02\x1a\xc9\x02\n" +
	"\x15NetAssetValueSnapshot\x128\n" +
	"\x0eeffective_date\x18\x01 \x01(\v2\x11.google.type.DateR\reffectiveDate\x12\x1d\n" +
	"\n" +
	...
	"\x11aum_base_currency\x18\f \x01(\x01R\x0faumBaseCurrency\x12-\n" +
	"\x12reporting_currency\x18\r \x01(\tR\x11reportingCurrency\x124\n" +
	"\x16aum_reporting_currency\x18\x0e \x01(\x01R\x14aumReportingCurrency\x1a\xd4\v\n" +
	"\x14SecurityPricingError\x128\n" +
	"\x0ereporting_date\x18\x01 \x01(\v2\x11.google.type.DateR\rreportingDate\x120\n" +
	"\n" +
	"error_date\x18\x02 \x01(\v2\x11.google.type.DateR\terrorDate\x12B\n" +
	"\x13identification_date\x18\x03 \x01(\v2\x11.google.type.DateR\x12identificationDate\x12:\n" +
	"\x0fresolution_date\x18\x04 \x01(\v2\x11.google.type.DateR\x0eresolutionDate\x128\n" +
	"\x18umbrella_fund_identifier\x18\x05 \x01(\tR\x16umbrellaFundIdentifier\x12#\n" +
	"\rumbrella_fund\x18\x06 \x01(\tR\fumbrellaFund\x12'\n" +
	"\x0ffund_identifier\x18\a \x01(\tR\x0efundIdentifier\x12\x12\n" +
	"\x04fund\x18\b \x01(\tR\x04fund\x12'\n" +
	"\x0fcase_identifier\x18\t \x01(\tR\x0ecaseIdentifier\x12#\n" +
	"\rsecurity_name\x182 \x01(\tR\fsecurityName\x12\x12\n" +
	"\x04isin\x184 \x01(\tR\x04isin\x12\x14\n" +
	"\x05cusip\x185 \x01(\tR\x05cusip\x12\x14\n" +
	"\x05sedol\x186 \x01(\tR\x05sedol\x12\x1d\n" +
	"\n" +
	"bbg_ticker\x187 \x01(\tR\tbbgTicker\x12\x10\n" +
	"\x03ric\x188 \x01(\tR\x03ric\x12\x12\n" +
	"\x04figi\x189 \x01(\tR\x04figi\x12\x17\n" +
	"\aperm_id\x18: \x01(\tR\x06permId\x12\x10\n" +
	"\x03wkn\x18; \x01(\tR\x03wkn\x12\x10\n" +
	"\x03lei\x18< \x01(\tR\x03lei\x12/\n" +
	"\x13producer_identifier\x18= \x01(\tR\x12producerIdentifier\x12-\n" +
	"\x12primary_identifier\x18G \x01(\tR\x11primaryIdentifier\x12\x87\x01\n" +
	"\x17primary_identifier_type\x18H \x01(\x0e2O.standards.open.v1.RT000FTL8.SecurityPricingError.FinancialInstrumentIdentifierR\x15primaryIdentifierType\x12]\n" +
	"\vasset_class\x18\n" +
	" \x01(\x0e2<.standards.open.v1.RT000FTL8.SecurityPricingError.AssetClassR\n" +
	"assetClass\x12 \n" +
	"\vmateriality\x18\v \x01(\x01R\vmateriality\x12\x14\n" +
	"\x05cause\x18\f \x01(\tR\x05cause\x12 \n" +
	"\vremediation\x18\r \x01(\tR\vremediation\x12\x1a\n" +
	"\bcomments\x18\x0e \x01(\tR\bcomments\"\xa8\x01\n" +
	...
	"\n" +
	"AssetClass\x12\x1b\n" +
	"\x17ASSET_CLASS_UNSPECIFIED\x10\x00\x12\r\n" +
	...
	"\x04MTGE\x10\b\x12\b\n" +
	"\x04MUNI\x10\t\x12\x15\n" +
	"\x11TOTAL_RETURN_SWAP\x10\n" +
	"\x1a\x81\x0e\n" +
	"\rStaleSecurity\x128\n" +
	"\x0ereporting_date\x18\x01 \x01(\v2\x11.google.type.DateR\rreportingDate\x128\n" +
	"\x18umbrella_fund_identifier\x18\x02 \x01(\tR\x16umbrellaFundIdentifier\x12#\n" +
	"\rumbrella_fund\x18\x03 \x01(\tR\fumbrellaFund\x12'\n" +
	"\x0ffund_identifier\x18\x04 \x01(\tR\x0efundIdentifier\x12\x12\n" +
	"\x04fund\x18\x05 \x01(\tR\x04fund\x12'\n" +
	"\x0fcase_identifier\x18\x06 \x01(\tR\x0ecaseIdentifier\x12#\n" +
	"\rsecurity_name\x182 \x01(\tR\fsecurityName\x12\x12\n" +
	"\x04isin\x184 \x01(\tR\x04isin\x12\x14\n" +
	"\x05cusip\x185 \x01(\tR\x05cusip\x12\x14\n" +
	"\x05sedol\x186 \x01(\tR\x05sedol\x12\x1d\n" +
	...
	"\x03lei\x18< \x01(\tR\x03lei\x12/\n" +
	"\x13producer_identifier\x18= \x01(\tR\x12producerIdentifier\x12-\n" +
	"\x12primary_identifier\x18G \x01(\tR\x11primaryIdentifier\x12\x80\x01\n" +
	"\x17primary_identifier_type\x18H \x01(\x0e2H.standards.open.v1.RT000FTL8.StaleSecurity.FinancialInstrumentIdentifierR\x15primaryIdentifierType\x12V\n" +
	"\vasset_class\x18\a \x01(\x0e25.standards.open.v1.RT000FTL8.StaleSecurity.AssetClassR\n" +
	"assetClass\x122\n" +
	"\vraised_date\x18\x15 \x01(\v2\x11.google.type.DateR\n" +
	"raisedDate\x12=\n" +
	"\x11price_latest_date\x18\x16 \x01(\v2\x11.google.type.DateR\x0fpriceLatestDate\x12\x1f\n" +
	"\vdays_staled\x18\t \x01(\x05R\n" +
	"daysStaled\x12)\n" +
	"\x10pricing_currency\x18\n" +
	" \x01(\tR\x0fpricingCurrency\x12!\n" +
	"\fprice_latest\x18\v \x01(\x01R\vpriceLatest\x12\x1a\n" +
	"\bquantity\x18\f \x01(\x01R\bquantity\x12%\n" +
	"\x0eposition_value\x18\r \x01(\x01R\rpositionValue\x12#\n" +
	"\rfund_currency\x18\x0e \x01(\tR\ffundCurrency\x12?\n" +
	"\x1cposition_value_fund_currency\x18\x0f \x01(\x01R\x19positionValueFundCurrency\x12\x19\n" +
	"\bfund_nav\x18\x10 \x01(\x01R\afundNav\x12 \n" +
	"\vmateriality\x18\x11 \x01(\x01R\vmateriality\x120\n" +
	"\x14primary_price_source\x18\x12 \x01(\tR\x12primaryPriceSource\x124\n" +
	"\x16secondary_price_source\x18\x13 \x01(\tR\x14secondaryPriceSource\x12\x1c\n" +
	"\treasoning\x18\x14 \x01(\tR\treasoning\x12\x1a\n" +
	"\bcomments\x18\x1e \x01(\tR\bcomments\"\xa8\x01\n" +
	"\x1dFinancialInstrumentIdentifier\x12\x1a\n" +
	"\x16IDENTIFIER_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04ISIN\x10\x01\x12\t\n" +
	"\x05CUSIP\x10\x02\x12\t\n" +
	...
	"reportDate\x12B\n" +
	"\x13identification_date\x18\x02 \x01(\v2\x11.google.type.DateR\x12identificationDate\x12:\n" +
	"\x0fresolution_date\x18\x03 \x01(\v2\x11.google.type.DateR\x0eresolutionDate\x128\n" +
	"\x18umbrella_fund_identifier\x18\x04 \x01(\tR\x16umbrellaFundIdentifier\x12#\n" +
	"\rumbrella_fund\x18\x05 \x01(\tR\fumbrellaFund\x12'\n" +
	"\x0ffund_identifier\x18\x06 \x01(\tR\x0efundIdentifier\x12\x12\n" +
	"\x04fund\x18\a \x01(\tR\x04fund\x12'\n" +
	"\x0fcase_identifier\x18\b \x01(\tR\x0ecaseIdentifier\x12#\n" +
	"\rsecurity_name\x182 \x01(\tR\fsecurityName\x12\x12\n" +
	"\x04isin\x184 \x01(\tR\x04isin\x12\x14\n" +
	"\x05cusip\x185 \x01(\tR\x05cusip\x12\x14\n" +
	"\x05sedol\x186 \x01(\tR\x05sedol\x12\x1d\n" +
	...
	"\x03lei\x18< \x01(\tR\x03lei\x12/\n" +
	"\x13producer_identifier\x18= \x01(\tR\x12producerIdentifier\x12-\n" +
	"\x12primary_identifier\x18G \x01(\tR\x11primaryIdentifier\x12}\n" +
	"\x17primary_identifier_type\x18H \x01(\x0e2E.standards.open.v1.RT000FTL8.StockBreak.FinancialInstrumentIdentifierR\x15primaryIdentifierType\x12S\n" +
	"\vasset_class\x18\t \x01(\x0e22.standards.open.v1.RT000FTL8.StockBreak.AssetClassR\n" +
	"assetClass\x128\n" +
	"\x0eeffective_date\x18\n" +
	" \x01(\v2\x11.google.type.DateR\reffectiveDate\x12 \n" +
	"\vmateriality\x18\v \x01(\x01R\vmateriality\x12\x14\n" +
	"\x05cause\x18\f \x01(\tR\x05cause\x12 \n" +
	"\vremediation\x18\r \x01(\tR\vremediation\x12\x18\n" +
	"\acomment\x18\x0e \x01(\tR\acomment\"\xa8\x01\n" +
	"\x1dFinancialInstrumentIdentifier\x12\x1a\n" +
	"\x16IDENTIFIER_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04ISIN\x10\x01\x12\t\n" +
	"\x05CUSIP\x10\x02\x12\t\n" +
	...
	"\x04fund\x18\a \x01(\tR\x04fund\x12'\n" +
	"\x0fcase_identifier\x18\b \x01(\tR\x0ecaseIdentifier\x12 \n" +
	"\vmateriality\x18\t \x01(\x01R\vmateriality\x12\x14\n" +
	"\x05cause\x18\n" +
	" \x01(\tR\x05cause\x12 \n" +
	"\vremediation\x18\v \x01(\tR\vremediation\x12\x18\n" +
	"\acomment\x18\f \x01(\tR\acomment\x1a\xc5\x05\n" +
	"\x11TotalExpenseRatio\x128\n" +
	"\x0ereporting_date\x18\x01 \x01(\v2\x11.google.type.DateR\rreportingDate\x12,\n" +
	"\bter_date\x18\x02 \x01(\v2\x11.google.type.DateR\aterDate\x12$\n" +
	"\x0eshare_class_id\x18\x03 \x01(\tR\fshareClassId\x12w\n" +
	"\x13share_class_id_type\x18\x04 \x01(\x0e2H.standards.open.v1.RT000FTL8.TotalExpenseRatio.ShareClassIdentifierTypesR\x10shareClassIdType\x122\n" +
	...
	"\x1cter_current_month_annualized\x18\a \x01(\x01R\x19terCurrentMonthAnnualized\x12\x17\n" +
	"\ater_ytd\x18\b \x01(\x01R\x06terYtd\x12,\n" +
	"\x12ter_ytd_annualized\x18\t \x01(\x01R\x10terYtdAnnualized\x12\x1a\n" +
	"\bcomments\x18\n" +
	" \x01(\tR\bcomments\"\xa4\x01\n" +
	...
	"\rumbrella_fund\x18\x03 \x01(\tR\fumbrellaFund\x12'\n" +
	"\x0ffund_identifier\x18\x04 \x01(\tR\x0efundIdentifier\x12\x12\n" +
	"\x04fund\x18\x05 \x01(\tR\x04fund\x124\n" +
	"\finvoice_date\x18\x06 \x01(\v2\x11.google.type.DateR\vinvoiceDate\x12@\n" +
	"\x12authorisation_date\x18\a \x01(\v2\x11.google.type.DateR\x11authorisationDate\x124\n" +
	"\fpayment_date\x18\b \x01(\v2\x11.google.type.DateR\vpaymentDate\x12-\n" +
	"\x12invoice_identifier\x18\t \x01(\tR\x11invoiceIdentifier\x12\x1c\n" +
	"\trecipient\x18\n" +
	" \x01(\tR\trecipient\x12\x19\n" +
	"\bfee_type\x18\v \x01(\tR\afeeType\x12'\n" +
	"\x0finvoiced_amount\x18\f \x01(\x01R\x0einvoicedAmount\x120\n" +
	"\x14fund_specific_amount\x18\r \x01(\x01R\x12fundSpecificAmount\x1a\xde\x03\n" +
	"\x11SwingPricingEvent\x128\n" +
	"\x0ereporting_date\x18\x01 \x01(\v2\x11.google.type.DateR\rreportingDate\x128\n" +
	"\x18umbrella_fund_identifier\x18\x02 \x01(\tR\x16umbrellaFundIdentifier\x12#\n" +
	"\rumbrella_fund\x18\x03 \x01(\tR\fumbrellaFund\x12'\n" +
	"\x0ffund_identifier\x18\x04 \x01(\tR\x0efundIdentifier\x12\x12\n" +
	"\x04fund\x18\x05 \x01(\tR\x04fund\x12;\n" +
	"\x10swing_price_date\x18\x06 \x01(\v2\x11.google.type.DateR\x0eswingPriceDate\x12'\n" +
	"\x0fswing_threshold\x18\a \x01(\x01R\x0eswingThreshold\x12!\n" +
	"\fswing_factor\x18\b \x01(\x01R\vswingFactor\x127\n" +
	"\x18nav_without_swing_factor\x18\t \x01(\x01R\x15navWithoutSwingFactor\x121\n" +
	"\x15nav_with_swing_factor\x18\n" +
	" \x01(\x01R\x12navWithSwingFactor\x1a\x83\x06\n" +
	"\x10PerShareClassNAV\x128\n" +
	"\x0ereporting_date\x18\x01 \x01(\v2\x11.google.type.DateR\rreportingDate\x12,\n" +
	"\bnav_date\x18\x02 \x01(\v2\x11.google.type.DateR\anavDate\x12$\n" +
	"\x0eshare_class_id\x18\x03 \x01(\tR\fshareClassId\x12v\n" +
	"\x13share_class_id_type\x18\x04 \x01(\x0e2G.standards.open.v1.RT000FTL8.PerShareClassNAV.ShareClassIdentifierTypesR\x10shareClassIdType\x122\n" +
	"\x15share_class_extension\x18\x05 \x01(\tR\x13shareClassExtension\x12\x14\n" +
	"\x05units\x18\x06 \x01(\x01R\x05units\x12:\n" +
	"\x1anav_per_unit_base_currency\x18\a \x01(\x01R\x16navPerUnitBaseCurrency\x125\n" +
	"\x17total_nav_base_currency\x18\b \x01(\x01R\x14totalNavBaseCurrency\x12D\n" +
	"\x1fnav_per_unit_reporting_currency\x18\t \x01(\x01R\x1bnavPerUnitReportingCurrency\x12?\n" +
	"\x1ctotal_nav_reporting_currency\x18\n" +
	" \x01(\x01R\x19totalNavReportingCurrency\"\xa4\x01\n" +
	"\x19ShareClassIdentifierTypes\x12\x1a\n" +
	"\x16IDENTIFIER_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04ISIN\x10\x01\x12\t\n" +
	"\x05CUSIP\x10\x02\x12\t\n" +
	...
	"\aPERM_ID\x10\n" +
	"\x1a\xbd\x0e\n" +
	"\x1eNAVCalculationErrorInformation\x128\n" +
	"\x0ereporting_date\x18\x01 \x01(\v2\x11.google.type.DateR\rreportingDate\x12!\n" +
	...
	"\x15error_period_end_date\x18\t \x01(\v2\x11.google.type.DateR\x12errorPeriodEndDate\x12:\n" +
	"\x0fresolution_date\x18\n" +
	" \x01(\v2\x11.google.type.DateR\x0eresolutionDate\x12d\n" +
	"\n" +
	"error_type\x18\v \x01(\x0e2E.standards.open.v1.RT000FTL8.NAVCalculationErrorInformation.ErrorTypeR\terrorType\x12\x14\n" +
	"\x05cause\x18\f \x01(\tR\x05cause\x12 \n" +
	"\vremediation\x18\r \x01(\tR\vremediation\x12Z\n" +
	"\x06impact\x18\x0e \x01(\x0e2B.standards.open.v1.RT000FTL8.NAVCalculationErrorInformation.ImpactR\x06impact\x12@\n" +
	"\x1ctotal_indemnification_amount\x18\x0f \x01(\x01R\x1atotalIndemnificationAmount\x12>\n" +
	"\x1bfund_indemnification_amount\x18\x10 \x01(\x01R\x19fundIndemnificationAmount\x12H\n" +
	" investors_indemnification_amount\x18\x11 \x01(\x01R\x1einvestorsIndemnificationAmount\x12%\n" +
	"\x0emaximum_impact\x18\x12 \x01(\x01R\rmaximumImpact\x12,\n" +
	"\x12de_minimis_applied\x18\x13 \x01(\bR\x10deMinimisApplied\x12-\n" +
	"\x13level_of_de_minimis\x18\x14 \x01(\x01R\x10levelOfDeMinimis\x123\n" +
	"\x16currency_of_de_minimis\x18\x15 \x01(\tR\x13currencyOfDeMinimis\x12R\n" +
	"&other_information_regarding_nav_impact\x18\x16 \x01(\tR\"otherInformationRegardingNavImpact\x12S\n" +
	"\x1cindemnification_booking_date\x18\x17 \x01(\v2\x11.google.type.DateR\x1aindemnificationBookingDate\x12S\n" +
	"\x1cindemnification_payment_date\x18\x18 \x01(\v2\x11.google.type.DateR\x1aindemnificationPaymentDate\x12C\n" +
	"\x1eentity_responsible_for_payment\x18\x19 \x01(\tR\x1bentityResponsibleForPayment\x12\x1a\n" +
	"\bcomments\x183 \x01(\tR\bcomments\"\xdb\x01\n" +
	"\tErrorType\x12\x1a\n" +
	"\x16ERROR_TYPE_UNSPECIFIED\x10\x00\x121\n" +
	"-SECURITIES_EXCEPT_DERIVATIVES_VALUATION_ERROR\x10\x01\x12\x14\n" +
	"\x10ACCOUNTING_ERROR\x10\x02\x12\x1b\n" +
	"\x17FEES_AND_ACCRUALS_ERROR\x10\x03\x12\x1a\n" +
	"\x16CORPORATE_ACTION_ERROR\x10\x04\x12\x1f\n" +
	"\x1bDERIVATIVES_VALUATION_ERROR\x10\x05\x12\x0f\n" +
	"\vOTHER_ERROR\x10\x06\"`\n" +
	"\x06Impact\x12\x16\n" +
	"\x12IMPACT_UNSPECIFIED\x10\x00\x12\x12\n" +
	"\x0eWITHOUT_IMPACT\x10\x01\x12\x15\n" +
	"\x11IMMATERIAL_IMPACT\x10\x02\x12\x13\n" +
	"\x0fMATERIAL_IMPACT\x10\x03\x1a\x9d\x0f\n" +
	"\x10InvestmentBreach\x128\n" +
	"\x0ereporting_date\x18\x01 \x01(\v2\x11.google.type.DateR\rreportingDate\x12!\n" +
	"\freference_id\x18\x02 \x01(\tR\vreferenceId\x128\n" +
	"\x18umbrella_fund_identifier\x18\x03 \x01(\tR\x16umbrellaFundIdentifier\x12#\n" +
	"\rumbrella_fund\x18\x04 \x01(\tR\fumbrellaFund\x12'\n" +
	"\x0ffund_identifier\x18\x05 \x01(\tR\x0efundIdentifier\x12\x12\n" +
	"\x04fund\x18\x06 \x01(\tR\x04fund\x128\n" +
	"\x0edetection_date\x18\a \x01(\v2\x11.google.type.DateR\rdetectionDate\x12J\n" +
	"\x18breach_period_start_date\x18\b \x01(\v2\x11.google.type.DateR\x15breachPeriodStartDate\x12F\n" +
	"\x16breach_period_end_date\x18\t \x01(\v2\x11.google.type.DateR\x13breachPeriodEndDate\x12Y\n" +
	"\vbreach_type\x18\n" +
	" \x01(\x0e28.standards.open.v1.RT000FTL8.InvestmentBreach.BreachTypeR\n" +
	"breachType\x12\x14\n" +
	"\x05cause\x18\v \x01(\tR\x05cause\x12/\n" +
	"\x13corrective_measures\x18\f \x01(\tR\x12correctiveMeasures\x12 \n" +
	"\vremediation\x18\r \x01(\tR\vremediation\x12L\n" +
	"\x06impact\x18\x0e \x01(\x0e24.standards.open.v1.RT000FTL8.InvestmentBreach.ImpactR\x06impact\x12#\n" +
	"\rimpact_amount\x18\x0f \x01(\x01R\fimpactAmount\x124\n" +
	"\x16impact_amount_currency\x18\x10 \x01(\tR\x14impactAmountCurrency\x12-\n" +
	"\x12calculation_method\x18\x11 \x01(\tR\x11calculationMethod\x12S\n" +
	"\x1cindemnification_booking_date\x18\x17 \x01(\v2\x11.google.type.DateR\x1aindemnificationBookingDate\x12S\n" +
	"\x1cindemnification_payment_date\x18\x18 \x01(\v2\x11.google.type.DateR\x1aindemnificationPaymentDate\x12C\n" +
	"\x1eentity_responsible_for_payment\x18\x19 \x01(\tR\x1bentityResponsibleForPayment\x12\x1a\n" +
	"\bcomments\x183 \x01(\tR\bcomments\"\x93\x05\n" +
	"\n" +
	"BreachType\x12\x1b\n" +
	"\x17BREACH_TYPE_UNSPECIFIED\x10\x00\x12'\n" +
	"#LUX_ART_41_ELIGIBILITY_REQUIREMENTS\x10\x01\x12,\n" +
	"(LUX_ART_41_10_PERCENT_TS_MMI_TRASH_RATIO\x10\x02\x12 \n" +
	"\x1cLUX_ART_43_10_PERCENT_ISSUER\x10\x03\x12\"\n" +
	"\x1eLUX_ART_43_20_PERCENT_DEPOSITS\x10\x04\x12$\n" +
	" LUX_ART_43_FDI_COUNTERPARTY_RISK\x10\x05\x12\x1c\n" +
	"\x18LUX_ART_43_ISSUER_TS_MMI\x10\x06\x12(\n" +
	"$LUX_ART_43_20_PERCENT_COMBINED_LIMIT\x10\a\x12 \n" +
	"\x1cLUX_ART_43_35_PERCENT_TS_MMI\x10\b\x12#\n" +
	"\x1fLUX_ART_45_100_PERCENT_6_ISSUES\x10\t\x12#\n" +
	"\x1fLUX_ART_46_20_PERCENT_UCITS_UCI\x10\n" +
	"\x12$\n" +
	" LUX_ART_48_SIGNIFICANT_INFLUENCE\x10\v\x12/\n" +
	"+LUX_ART_50_10_PERCENT_BORROWINGS_TEMP_BASIS\x10\f\x12!\n" +
	"\x1dLUX_ART_52_NO_UNCOVERED_SALES\x10\r\x12\x1e\n" +
	"\x1aESMA_GUIDELINES_COLLATERAL\x10\x0e\x12\x1d\n" +
	"\x19LUX_SIF_30_PERCENT_ISSUER\x10\x0f\x12\x1e\n" +
	"\x1aBREACH_OF_PROSPECTUS_RULES\x10\x10\x12\x18\n" +
	"\x14BREACH_OF_OTHER_RULE\x10\x11\"\x84\x01\n" +
	"\x06Impact\x12\x16\n" +
	"\x12IMPACT_UNSPECIFIED\x10\x00\x12\x12\n" +
	"\x0eWITHOUT_IMPACT\x10\x01\x12\x13\n" +
	"\x0fIMMATERIAL_LOSS\x10\x02\x12\x13\n" +
	"\x0fIMMATERIAL_GAIN\x10\x03\x12\x11\n" +
	"\rMATERIAL_LOSS\x10\x04\x12\x11\n" +
	"\rMATERIAL_GAIN\x10\x05\"K\n" +
	"\x0fRT000FTL8_batch\x128\n" +
	"\bresponse\x18\x01 \x03(\v2\x1c.standards.open.v1.RT000FTL8R\bresponseB(Z&go.alis.build/common/standards/open/v1b\x06proto3"

var (
	file_standards_open_v1_RT000FTL8_proto_rawDescOnce sync.Once
	file_standards_open_v1_RT000FTL8_proto_rawDescData []byte
)

func file_standards_open_v1_RT000FTL8_proto_rawDescGZIP() []byte {
	file_standards_open_v1_RT000FTL8_proto_rawDescOnce.Do(func() {
		file_standards_open_v1_RT000FTL8_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_standards_open_v1_RT000FTL8_proto_rawDesc), len(file_standards_open_v1_RT000FTL8_proto_rawDesc)))
	})
...
var file_standards_open_v1_RT000FTL8_proto_goTypes = []any{
...
func file_standards_open_v1_RT000FTL8_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_standards_open_v1_RT000FTL8_proto_rawDesc), len(file_standards_open_v1_RT000FTL8_proto_rawDesc)),
			NumEnums:      15,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   0,
