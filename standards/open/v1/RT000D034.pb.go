...
const file_standards_open_v1_RT000D034_proto_rawDesc = "" +
	"\n" +
	"!standards/open/v1/RT000D034.proto\x12\x11standards.open.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x19google/api/resource.proto\x1a\x17google/type/money.proto\x1a google/type/postal_address.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x16google/type/date.proto\"\xd6\xff\x03\n" +
	"\tRT000D034\x12#\n" +
	"\rumbrella_fund\x18\x01 \x01(\tR\fumbrellaFund\x12\x1b\n" +
	"\tcssf_code\x18\x02 \x01(\tR\bcssfCode\x129\n" +
	"\x19address_street_and_number\x18\x03 \x01(\tR\x16addressStreetAndNumber\x12/\n" +
	"\x14postal_code_and_city\x18\x04 \x01(\tR\x11postalCodeAndCity\x12L\n" +
	"$number_of_staff_dealing_with_aml_cft\x18\x05 \x01(\x05R\x1enumberOfStaffDealingWithAmlCft\x12@\n" +
	"\blicenses\x18\x06 \x03(\x0e2$.standards.open.v1.RT000D034.LicenseR\blicenses\x129\n" +
	"\x0fentity_year_end\x18\a \x01(\v2\x11.google.type.DateR\rentityYearEnd\x12@\n" +
	"\bmanagers\x18\b \x03(\v2$.standards.open.v1.RT000D034.ManagerR\bmanagers\x12d\n" +
	"\x11fund_descriptions\x18\t \x03(\v27.standards.open.v1.RT000D034.DescriptiveFundInformationR\x10fundDescriptions\x12C\n" +
	"\x13subscriptions_value\x18\n" +
	" \x01(\v2\x12.google.type.MoneyR\x12subscriptionsValue\x12?\n" +
	"\x11redemptions_value\x18\v \x01(\v2\x12.google.type.MoneyR\x10redemptionsValue\x12l\n" +
	"\x1cinstrument_types_invested_in\x18\f \x03(\x0e2+.standards.open.v1.RT000D034.InstrumentTypeR\x19instrumentTypesInvestedIn\x12J\n" +
	"\"other_instrument_types_invested_in\x18\r \x03(\tR\x1eotherInstrumentTypesInvestedIn\x12&\n" +
	"\x0finvested_in_spv\x18\x0e \x01(\bR\rinvestedInSpv\x12$\n" +
	"\x0enumber_of_spvs\x18\x0f \x01(\x05R\fnumberOfSpvs\x12M\n" +
	"\forganisation\x18\x10 \x01(\v2).standards.open.v1.RT000D034.OrganisationR\forganisation\x12f\n" +
	"\x15investment_compliance\x18\x11 \x01(\v21.standards.open.v1.RT000D034.InvestmentComplianceR\x14investmentCompliance\x12D\n" +
	"\tvaluation\x18\x12 \x01(\v2&.standards.open.v1.RT000D034.ValuationR\tvaluation\x12[\n" +
	"\x11nav_determination\x18\x13 \x01(\v2..standards.open.v1.RT000D034.NAVDeterminiationR\x10navDetermination\x12^\n" +
	"\x13expenses_and_income\x18\x14 \x01(\v2..standards.open.v1.RT000D034.ExpensesAndIncomeR\x11expensesAndIncome\x12l\n" +
	"\x17depositary_relationship\x18\x15 \x01(\v23.standards.open.v1.RT000D034.DepositaryRelationshipR\x16depositaryRelationship\x1au\n" +
	"\x17FundSpecificExplanation\x12\x1b\n" +
	"\tcssf_code\x18\x01 \x01(\tR\bcssfCode\x12\x1b\n" +
	"\tfund_name\x18\x02 \x01(\tR\bfundName\x12 \n" +
	"\vexplanation\x18\x03 \x01(\tR\vexplanation\x1a\xb7\x01\n" +
	"\fYesNoExplain\x12N\n" +
	"\bresponse\x18\x01 \x01(\x0e22.standards.open.v1.RT000D034.YesNoExplain.ResponseR\bresponse\x12 \n" +
	"\vexplanation\x18\x02 \x01(\tR\vexplanation\"5\n" +
	"\bResponse\x12\x18\n" +
	"\x14RESPONSE_UNSPECIFIED\x10\x00\x12\a\n" +
	"\x03YES\x10\x01\x12\x06\n" +
	"\x02NO\x10\x02\x1a\xbf\x01\n" +
	"\aManager\x12\x1d\n" +
	"\n" +
	...
	"\x14country_of_residence\x18\x05 \x01(\tR\x12countryOfResidence\x1a\xf8\x03\n" +
	"\x1aDescriptiveFundInformation\x12\x1b\n" +
	"\tcssf_code\x18\x01 \x01(\tR\bcssfCode\x12\x1b\n" +
	"\tfund_name\x18\x02 \x01(\tR\bfundName\x12#\n" +
	"\rfund_currency\x18\x04 \x01(\tR\ffundCurrency\x12,\n" +
	"\x12active_during_year\x18\x05 \x01(\bR\x10activeDuringYear\x123\n" +
	"\x15materiality_threshold\x18\x06 \x01(\x01R\x14materialityThreshold\x12+\n" +
	"\x12active_at_year_end\x18\a \x01(\bR\x0factiveAtYearEnd\x12%\n" +
	"\x0ein_liquidation\x18\b \x01(\bR\rinLiquidation\x12\x1d\n" +
	"\n" +
	"open_ended\x18\t \x01(\bR\topenEnded\x12(\n" +
	"\x10in_lockup_period\x18\n" +
	" \x01(\bR\x0einLockupPeriod\x12H\n" +
	"!redemptions_suspended_at_year_end\x18\v \x01(\bR\x1dredemptionsSuspendedAtYearEnd\x121\n" +
	"\x14redemption_frequency\x18\f \x01(\tR\x13redemptionFrequency\x1a\xe03\n" +
	"\fOrganisation\x12o\n" +
	"\x1eextraordinary_general_meetings\x18\x01 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR\x1cextraordinaryGeneralMeetings\x12I\n" +
	"!number_formal_management_meetings\x18\x02 \x01(\x05R\x1enumberFormalManagementMeetings\x12X\n" +
	"\x12documented_minutes\x18\x03 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR\x11documentedMinutes\x12I\n" +
	"!number_of_management_resignations\x18\x04 \x01(\x05R\x1enumberOfManagementResignations\x12\x83\x01\n" +
	"\x1bmanagement_meeting_subjects\x18\x05 \x03(\x0e2C.standards.open.v1.RT000D034.Organisation.ManagementMeetingSubjectsR\x19managementMeetingSubjects\x12I\n" +
	"!other_management_meeting_subjects\x18\x06 \x01(\tR\x1eotherManagementMeetingSubjects\x12\x80\x01\n" +
	"'management_attend_training_professional\x18\a \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR$managementAttendTrainingProfessional\x12n\n" +
	"\x1emanagement_attend_training_aml\x18\b \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR\x1bmanagementAttendTrainingAml\x12a\n" +
	"\x17material_deficiency_ifm\x18\t \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR\x15materialDeficiencyIfm\x12\x86\x01\n" +
	"*material_deficiency_central_administration\x18\n" +
	" \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR'materialDeficiencyCentralAdministration\x12\x8e\x01\n" +
	"/material_deficiency_transfer_or_registrar_agent\x18\v \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR*materialDeficiencyTransferOrRegistrarAgent\x12q\n" +
	"\x1fmaterial_deficiency_distributor\x18\f \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR\x1dmaterialDeficiencyDistributor\x12|\n" +
	"%material_deficiency_portfolio_manager\x18\r \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR\"materialDeficiencyPortfolioManager\x12~\n" +
	"&material_deficiency_investment_advisor\x18\x0e \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR#materialDeficiencyInvestmentAdvisor\x12o\n" +
	"\x1ematerial_deficiency_depository\x18\x0f \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR\x1cmaterialDeficiencyDepository\x12v\n" +
	"\"material_deficiency_other_delegate\x18\x10 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR\x1fmaterialDeficiencyOtherDelegate\x12I\n" +
	"!meet_minimum_capital_requirements\x18\x11 \x01(\bR\x1emeetMinimumCapitalRequirements\x12\xab\x01\n" +
	"Wif_not_meeting_cap_reqs_did_board_convene_extraordinary_general_meeting_and_inform_cssf\x18\x12 \x01(\bRJifNotMeetingCapReqsDidBoardConveneExtraordinaryGeneralMeetingAndInformCssf\x12\x9a\x01\n" +
	"Lreceived_request_from_foreign_competent_authority_concerning_potential_issue\x18\x13 \x01(\bRDreceivedRequestFromForeignCompetentAuthorityConcerningPotentialIssue\x12\x93\x01\n" +
	"Hreceived_request_from_foreign_competent_authority_concerning_wrongdoings\x18\x14 \x01(\bRAreceivedRequestFromForeignCompetentAuthorityConcerningWrongdoings\x12]\n" +
	",fund_received_investor_complaint_during_year\x18\x15 \x01(\bR'fundReceivedInvestorComplaintDuringYear\x12h\n" +
	"2number_of_investor_complaints_received_during_year\x18\x16 \x01(\x05R,numberOfInvestorComplaintsReceivedDuringYear\x12\x8e\x01\n" +
	"0could_any_complaint_have_material_impact_on_fund\x18\x17 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR)couldAnyComplaintHaveMaterialImpactOnFund\x12~\n" +
	"'fund_involved_in_litigation_during_year\x18\x18 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR\"fundInvolvedInLitigationDuringYear\x12{\n" +
	"&any_cases_of_suspected_or_actual_fraud\x18\x19 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR anyCasesOfSuspectedOrActualFraud\x12E\n" +
	"\x1fnotification_of_suspected_fraud\x18\x1a \x01(\bR\x1cnotificationOfSuspectedFraud\x12Y\n" +
	"*number_of_notifications_of_suspected_fraud\x18\x1b \x01(\x05R%numberOfNotificationsOfSuspectedFraud\x12\x91\x01\n" +
	"1notifications_of_suspected_fraud_shared_with_cssf\x18\x1c \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR+notificationsOfSuspectedFraudSharedWithCssf\x12z\n" +
	"%adopted_risk_management_system_of_sif\x18\x1d \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR adoptedRiskManagementSystemOfSif\x12w\n" +
	"1risk_management_system_of_sif_date_of_last_review\x18\x1e \x01(\v2\x11.google.type.DateR)riskManagementSystemOfSifDateOfLastReview\x12b\n" +
	"/effective_conflicts_of_interest_policy_in_place\x18\x1f \x01(\bR)effectiveConflictsOfInterestPolicyInPlace\x12y\n" +
	"$any_conflicts_of_interest_identified\x18  \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR anyConflictsOfInterestIdentified\x12r\n" +
	" register_of_conflicts_maintained\x18! \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR\x1dregisterOfConflictsMaintained\x12?\n" +
	"\x1cnumber_of_conflicts_recorded\x18\" \x01(\x05R\x19numberOfConflictsRecorded\x12v\n" +
	"#procedures_in_place_to_protect_fund\x18# \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR\x1eproceduresInPlaceToProtectFund\x12\xa4\x01\n" +
	"<if_no_procedures_did_management_act_in_interest_of_investors\x18$ \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR3ifNoProceduresDidManagementActInInterestOfInvestors\x12\x96\x01\n" +
	"4if_no_procedure_were_conflicts_reported_to_investors\x18% \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR-ifNoProcedureWereConflictsReportedToInvestors\x12^\n" +
	"-sold_to_retail_investors_on_lookthrough_basis\x18& \x01(\bR'soldToRetailInvestorsOnLookthroughBasis\x12v\n" +
	":number_funds_sold_to_retail_investors_on_lookthrough_basis\x18' \x01(\x05R2numberFundsSoldToRetailInvestorsOnLookthroughBasis\x12u\n" +
	"\x13investor_categories\x18( \x03(\x0e2D.standards.open.v1.RT000D034.Organisation.InformedInvestorCategoriesR\x12investorCategories\x12\x98\x01\n" +
	"5procedures_in_place_to_ensure_investors_well_informed\x18) \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR.proceduresInPlaceToEnsureInvestorsWellInformed\x12\xc3\x01\n" +
	"Lprocedures_in_place_to_ensure_audited_annual_report_complies_with_regulation\x18* \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRBproceduresInPlaceToEnsureAuditedAnnualReportCompliesWithRegulation\x12\xda\x01\n" +
	"Xprocedures_in_place_to_ensure_audited_annual_report_complies_with_constitutive_documents\x18+ \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRMproceduresInPlaceToEnsureAuditedAnnualReportCompliesWithConstitutiveDocuments\x12\xdd\x01\n" +
	"Zprocedures_in_place_to_ensure_audited_annual_report_complies_with_fund_accounting_standard\x18, \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRNproceduresInPlaceToEnsureAuditedAnnualReportCompliesWithFundAccountingStandard\x12\xa3\x01\n" +
	";report_on_activities_included_in_annual_report_and_accurate\x18- \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR3reportOnActivitiesIncludedInAnnualReportAndAccurate\"\xe9\x05\n" +
	"\x19ManagementMeetingSubjects\x12*\n" +
	"&MANAGEMENT_MEETING_SUBJECT_UNSPECIFIED\x10\x00\x12\x1a\n" +
	"\x16DELEGATE_OVERSIGHT_IFM\x10\x01\x12-\n" +
	")DELEGATE_OVERSIGHT_CENTRAL_ADMINISTRATION\x10\x02\x122\n" +
	".DELEGATE_OVERSIGHT_TRANSFER_OR_REGISTRAR_AGENT\x10\x03\x12#\n" +
	"\x1fDELEGATE_OVERSIGHT_DISTRIBUTORS\x10\x04\x12)\n" +
	"%DELEGATE_OVERSIGHT_PORTFOLIO_MANAGERS\x10\x05\x12*\n" +
	"&DELEGATE_OVERSIGHT_INVESTMENT_ADVISORS\x10\x06\x12 \n" +
	"\x1cPORTFOLIO_MANAGEMENT_OF_FUND\x10\a\x12\"\n" +
	"\x1eRISK_MANAGEMENT_AND_FUND_RISKS\x10\b\x12\x16\n" +
	"\x12CYBER_AND_IT_RISKS\x10\t\x12$\n" +
	" FUND_DEVELOPMENT_AND_PERFORMANCE\x10\n" +
	"\x12\x19\n" +
	"\x15INVESTMENT_COMPLIANCE\x10\v\x12#\n" +
	"\x1fVALUATION_AND_NAV_DETERMINATION\x10\f\x12\x15\n" +
	"\x11FEES_AND_EXPENSES\x10\r\x12\x18\n" +
	"\x14CAPITAL_TRANSACTIONS\x10\x0e\x12\x19\n" +
	"\x15CONFLICTS_OF_INTEREST\x10\x0f\x12\v\n" +
	"\aAML_CFT\x10\x10\x12/\n" +
	"+CENTRAL_ADMINISTRATION_OR_ACCOUNTING_ISSUES\x10\x11\x12\r\n" +
	"\tMARKETING\x10\x12\x12 \n" +
	"\x1cRELATIONSHIP_WITH_DEPOSITORY\x10\x13\x12\x1b\n" +
	"\x17REGULATORY_DEVELOPMENTS\x10\x14\x12\t\n" +
	"\x05OTHER\x10\x15\"\xda\x01\n" +
	"\x1aInformedInvestorCategories\x12*\n" +
	"&INFORMED_INVESTOR_CATEGORY_UNSPECIFIED\x10\x00\x12+\n" +
	"'INSTITUTIONAL_OR_PROFESSIONAL_INVESTORS\x10\x01\x12)\n" +
	"%LARGE_AND_CONFIRMED_INFORMED_INVESTOR\x10\x02\x128\n" +
	"4CONFIRMED_INFORMED_AND_ASSESSED_TO_CERTIFY_EXPERTISE\x10\x03\x1a\xf0M\n" +
	"\x14InvestmentCompliance\x12\xa2\x01\n" +
	":pre_trade_investment_compliance_at_portfolio_manager_level\x18\x01 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR3preTradeInvestmentComplianceAtPortfolioManagerLevel\x12\xa4\x01\n" +
	";post_trade_investment_compliance_at_portfolio_manager_level\x18\x02 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR4postTradeInvestmentComplianceAtPortfolioManagerLevel\x12\x95\x01\n" +
	"3delegation_of_ongoing_ex_post_investment_compliance\x18\x03 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR-delegationOfOngoingExPostInvestmentCompliance\x12\xaa\x01\n" +
	"Uex_post_investment_compliance_covers_all_legal_and_regulatory_investment_restrictions\x18\x04 \x01(\bRKexPostInvestmentComplianceCoversAllLegalAndRegulatoryInvestmentRestrictions\x12^\n" +
	",legal_and_regulatory_investment_restrictions\x18\x05 \x03(\tR(legalAndRegulatoryInvestmentRestrictions\x12\xdf\x01\n" +
	"Anot_verified_legal_and_regulatory_investment_restrictions_by_fund\x18\x06 \x03(\v2Y.standards.open.v1.RT000D034.InvestmentCompliance.NotVerifiedInvestmentRestrictionsByFundR9notVerifiedLegalAndRegulatoryInvestmentRestrictionsByFund\x12\x9d\x01\n" +
	"Nex_post_investment_compliance_covers_all_investment_restrictions_in_prospectus\x18\a \x01(\bREexPostInvestmentComplianceCoversAllInvestmentRestrictionsInProspectus\x12Q\n" +
	"%investment_restrictions_in_prospectus\x18\b \x03(\tR\"investmentRestrictionsInProspectus\x12\xcd\x01\n" +
	"7not_verified_prospectus_investment_restrictions_by_fund\x18\t \x03(\v2Y.standards.open.v1.RT000D034.InvestmentCompliance.NotVerifiedInvestmentRestrictionsByFundR1notVerifiedProspectusInvestmentRestrictionsByFund\x12\xbf\x01\n" +
	"aex_post_investment_compliance_covers_all_legal_and_regulatory_investment_restrictions_at_nav_calc\x18\n" +
	" \x01(\bRTexPostInvestmentComplianceCoversAllLegalAndRegulatoryInvestmentRestrictionsAtNavCalc\x12s\n" +
	"8legal_and_regulatory_investment_restrictions_at_nav_calc\x18\v \x03(\tR1legalAndRegulatoryInvestmentRestrictionsAtNavCalc\x12\xf4\x01\n" +
	"Mnot_verified_legal_and_regulatory_investment_restrictions_at_nav_time_by_fund\x18\f \x03(\v2Y.standards.open.v1.RT000D034.InvestmentCompliance.NotVerifiedInvestmentRestrictionsByFundRBnotVerifiedLegalAndRegulatoryInvestmentRestrictionsAtNavTimeByFund\x12\xbc\x01\n" +
	"0legal_and_regulatory_investment_compliance_ucits\x18\r \x01(\v2U.standards.open.v1.RT000D034.InvestmentCompliance.LegalAndRegulatoryRestrictionsUCITSR+legalAndRegulatoryInvestmentComplianceUcits\x12\xb6\x01\n" +
	".legal_and_regulatory_investment_compliance_sif\x18\x0e \x01(\v2S.standards.open.v1.RT000D034.InvestmentCompliance.LegalAndRegulatoryRestrictionsSIFR)legalAndRegulatoryInvestmentComplianceSif\x12\xb6\x01\n" +
	".legal_and_regulatory_investment_compliance_mmf\x18\x0f \x01(\v2S.standards.open.v1.RT000D034.InvestmentCompliance.LegalAndRegulatoryRestrictionsMMFR)legalAndRegulatoryInvestmentComplianceMmf\x12M\n" +
	"#held_investments_in_securitizations\x18\x10 \x01(\bR heldInvestmentsInSecuritizations\x12\x80\x01\n" +
	"'complied_with_securitization_regulation\x18\x11 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR$compliedWithSecuritizationRegulation\x12\x96\x01\n" +
	"3complied_with_investment_restrictions_in_prospectus\x18\x12 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR.compliedWithInvestmentRestrictionsInProspectus\x12\xac\x01\n" +
	"@formalized_policy_in_place_to_handle_active_and_passive_breaches\x18\x13 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR7formalizedPolicyInPlaceToHandleActiveAndPassiveBreaches\x12;\n" +
	"\x1anumber_of_passive_breaches\x18\x14 \x01(\x05R\x17numberOfPassiveBreaches\x12N\n" +
	"$number_of_active_investment_breaches\x18\x15 \x01(\x05R numberOfActiveInvestmentBreaches\x12\x83\x01\n" +
	"*cssf_notified_of_all_prior_active_breaches\x18\x16 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR$cssfNotifiedOfAllPriorActiveBreaches\x1a\xcc\x01\n" +
	"'NotVerifiedInvestmentRestrictionsByFund\x12\x1b\n" +
	"\tcssf_code\x18\x01 \x01(\tR\bcssfCode\x12\x1b\n" +
	"\tfund_name\x18\x02 \x01(\tR\bfundName\x12\x16\n" +
	"\x06active\x18\x04 \x01(\bR\x06active\x12O\n" +
	"$not_verified_investment_restrictions\x18\x05 \x03(\tR!notVerifiedInvestmentRestrictions\x1a\x94\x1f\n" +
	"#LegalAndRegulatoryRestrictionsUCITS\x12\x85\x01\n" +
	"*transferable_securities_no_active_breaches\x18\x01 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR&transferableSecuritiesNoActiveBreaches\x12\x84\x01\n" +
	"*money_market_securities_no_active_breaches\x18\x02 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR%moneyMarketSecuritiesNoActiveBreaches\x12\x92\x01\n" +
	"2shares_or_uints_of_undertakings_no_active_breaches\x18\x03 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR+sharesOrUintsOfUndertakingsNoActiveBreaches\x12h\n" +
	"\x1bdeposits_no_active_breaches\x18\x04 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR\x18depositsNoActiveBreaches\x12\x96\x01\n" +
	"3financial_derivative_investments_no_active_breaches\x18\x05 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR.financialDerivativeInvestmentsNoActiveBreaches\x12\xa6\x01\n" +
	";financial_derivative_investments_compliant_underlying_index\x18\x06 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR6financialDerivativeInvestmentsCompliantUnderlyingIndex\x12\x86\x01\n" +
	"+money_market_investments_no_active_breaches\x18\a \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR&moneyMarketInvestmentsNoActiveBreaches\x12\xa9\x01\n" +
	"=efficient_portfolio_management_instruments_no_active_breaches\x18\b \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR7efficientPortfolioManagementInstrumentsNoActiveBreaches\x12\x7f\n" +
	"'financial_collateral_no_active_breaches\x18\t \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR#financialCollateralNoActiveBreaches\x12]\n" +
	"-trash_ratio_exceeded_five_percent_at_year_end\x18\n" +
	" \x01(\bR&trashRatioExceededFivePercentAtYearEnd\x12\x95\x01\n" +
	"\x13trash_ratio_by_fund\x18\v \x03(\v2f.standards.open.v1.RT000D034.InvestmentCompliance.LegalAndRegulatoryRestrictionsUCITS.TrashRatioByFundR\x10trashRatioByFund\x12\x84\x01\n" +
	"*trash_ratio_investments_no_active_breaches\x18\f \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR%trashRatioInvestmentsNoActiveBreaches\x12\xb5\x01\n" +
	"Epre_trade_controls_in_place_to_identify_and_monitor_trash_instruments\x18\r \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR;preTradeControlsInPlaceToIdentifyAndMonitorTrashInstruments\x12\x9a\x01\n" +
	"5complied_with_global_exposure_investment_restrictions\x18\x0e \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR0compliedWithGlobalExposureInvestmentRestrictions\x12\x9e\x01\n" +
	"7complied_with_issuer_limitation_investment_restrictions\x18\x0f \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR2compliedWithIssuerLimitationInvestmentRestrictions\x12\xb2\x01\n" +
	"Bcomplied_with_twenty_percent_deposit_limit_investment_restrictions\x18\x10 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR;compliedWithTwentyPercentDepositLimitInvestmentRestrictions\x12\xa7\x01\n" +
	"<complied_with_otc_counterparty_limit_investment_restrictions\x18\x11 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR6compliedWithOtcCounterpartyLimitInvestmentRestrictions\x12\x9f\x01\n" +
	"8complied_with_issuer_limit_limit_investment_restrictions\x18\x12 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR2compliedWithIssuerLimitLimitInvestmentRestrictions\x12\xb4\x01\n" +
	"Ccomplied_with_combined_twenty_percent_limit_investment_restrictions\x18\x13 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR<compliedWithCombinedTwentyPercentLimitInvestmentRestrictions\x12\xad\x01\n" +
	"@complied_with_target_uci_and_ucits_limit_investment_restrictions\x18\x14 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR8compliedWithTargetUciAndUcitsLimitInvestmentRestrictions\x12\xa2\x01\n" +
	"9complied_with_concentration_limit_investment_restrictions\x18\x15 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR4compliedWithConcentrationLimitInvestmentRestrictions\x12\x9a\x01\n" +
	"5complied_with_borrowing_limit_investment_restrictions\x18\x16 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR0compliedWithBorrowingLimitInvestmentRestrictions\x12\x98\x01\n" +
	"4complied_with_uncovered_sale_investment_restrictions\x18\x17 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR/compliedWithUncoveredSaleInvestmentRestrictions\x12\x9d\x01\n" +
	"7complied_with_ten_percent_trash_investment_restrictions\x18\x18 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR1compliedWithTenPercentTrashInvestmentRestrictions\x12\x85\x01\n" +
	"*complied_all_other_investment_restrictions\x18\x19 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR&compliedAllOtherInvestmentRestrictions\x1a\x85\x01\n" +
	"\x10TrashRatioByFund\x12\x1b\n" +
	"\tcssf_code\x18\x01 \x01(\tR\bcssfCode\x12\x1b\n" +
	"\tfund_name\x18\x02 \x01(\tR\bfundName\x12\x16\n" +
	"\x06active\x18\x04 \x01(\bR\x06active\x12\x1f\n" +
	"\vtrash_ratio\x18\x05 \x01(\x01R\n" +
	"trashRatio\x1a\xa4\x01\n" +
	"!LegalAndRegulatoryRestrictionsSIF\x12\x7f\n" +
	"(complied_with_scar_law_and_cssf_circular\x18\x01 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR\"compliedWithScarLawAndCssfCircular\x1a\xa8\x11\n" +
	"!LegalAndRegulatoryRestrictionsMMF\x12\x82\x01\n" +
	")complied_with_article9_on_eligible_assets\x18\x01 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR$compliedWithArticle9OnEligibleAssets\x12|\n" +
	"&complied_with_article9_on_eligible_mmi\x18\x02 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR!compliedWithArticle9OnEligibleMmi\x12\x9e\x01\n" +
	"8complied_with_article11_on_eligible_securities_and_abcps\x18\x03 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR1compliedWithArticle11OnEligibleSecuritiesAndAbcps\x12\xb7\x01\n" +
	"Ecomplied_with_article12_on_eligible_deposits_with_credit_institutions\x18\x04 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR=compliedWithArticle12OnEligibleDepositsWithCreditInstitutions\x12\xa5\x01\n" +
	";complied_with_article13_on_financial_derivative_instruments\x18\x05 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR5compliedWithArticle13OnFinancialDerivativeInstruments\x12\xa1\x01\n" +
	"9complied_with_article14_on_eligible_repurchase_agreements\x18\x06 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR3compliedWithArticle14OnEligibleRepurchaseAgreements\x12\x9f\x01\n" +
	"8complied_with_article15_on_reverse_repurchase_agreements\x18\a \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR2compliedWithArticle15OnReverseRepurchaseAgreements\x12\xa2\x01\n" +
	";complied_with_article16_on_eligible_shares_or_units_of_mmfs\x18\b \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR2compliedWithArticle16OnEligibleSharesOrUnitsOfMmfs\x12\x8d\x01\n" +
	"/credit_quality_assessment_of_each_mmi_favorable\x18\t \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR)creditQualityAssessmentOfEachMmiFavorable\x12\xb3\x01\n" +
	"Ccredit_quality_assessment_of_each_securitization_and_abcp_favorable\x18\n" +
	" \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR;creditQualityAssessmentOfEachSecuritizationAndAbcpFavorable\x12B\n" +
	"\x1dlegal_restrictions_applicable\x18\v \x03(\tR\x1blegalRestrictionsApplicable\x12\xa4\x01\n" +
	";complied_on_ongoing_basis_with_article17_on_diversification\x18\f \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR4compliedOnOngoingBasisWithArticle17OnDiversification\x12\xa0\x01\n" +
	"9complied_on_ongoing_basis_with_article18_on_concentration\x18\r \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR2compliedOnOngoingBasisWithArticle18OnConcentration\x12\xbd\x01\n" +
	"Icomplied_on_ongoing_basis_with_article24_and_article25_on_portfolio_rules\x18\x0e \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR?compliedOnOngoingBasisWithArticle24AndArticle25OnPortfolioRules\x1a\xe8T\n" +
	"\tValuation\x12\xa0\x01\n" +
	"8valuation_policies_appropriately_disclosed_in_prospectus\x18\x01 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR3valuationPoliciesAppropriatelyDisclosedInProspectus\x12\xaa\x01\n" +
	">written_valuation_procedures_covering_all_investments_in_place\x18\x02 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR7writtenValuationProceduresCoveringAllInvestmentsInPlace\x12\x8f\x01\n" +
	"/management_formally_approved_valuation_policies\x18\x03 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR+managementFormallyApprovedValuationPolicies\x12\x8f\x01\n" +
	"/management_ensured_valuation_policies_compliant\x18\x04 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR+managementEnsuredValuationPoliciesCompliant\x12\x95\x01\n" +
	"3management_approved_formally_use_of_valuation_model\x18\x05 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR-managementApprovedFormallyUseOfValuationModel\x12\xba\x01\n" +
	"Fmanagement_approved_formally_independence_of_external_valuer_appointed\x18\x06 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR?managementApprovedFormallyIndependenceOfExternalValuerAppointed\x12\xd5\x01\n" +
	"Umanagement_conducts_periodic_review_of_adequacy_of_valuation_policies_and_prodcedures\x18\a \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRKmanagementConductsPeriodicReviewOfAdequacyOfValuationPoliciesAndProdcedures\x12~\n" +
	"4date_of_latest_periodic_review_of_valuation_policies\x18\b \x01(\v2\x11.google.type.DateR-dateOfLatestPeriodicReviewOfValuationPolicies\x12\xe4\x01\n" +
	"^organisation_of_fund_provides_for_escalation_process_to_management_in_case_of_valuation_issues\x18\t \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRQorganisationOfFundProvidesForEscalationProcessToManagementInCaseOfValuationIssues\x12\xbc\x01\n" +
	"1legal_and_regulatory_valuation_requirements_ucits\x18\n" +
	" \x01(\v2S.standards.open.v1.RT000D034.Valuation.LegalAndRegulatoryValuationRequirementsUCITSR,legalAndRegulatoryValuationRequirementsUcits\x12\xd3\x01\n" +
	"9legal_and_regulatory_valuation_requirements_uci_sif_sicar\x18\v \x01(\v2\\.standards.open.v1.RT000D034.Valuation.LegalAndRegulatoryValuationRequirements_UCI_SIF_SICARR2legalAndRegulatoryValuationRequirementsUciSifSicar\x12\xb7\x01\n" +
	"/legal_and_regulatory_valuation_requirements_mmf\x18\f \x01(\v2R.standards.open.v1.RT000D034.Valuation.LegalAndRegulatoryValuationRequirements_MMFR*legalAndRegulatoryValuationRequirementsMmf\x12\xc9\x01\n" +
	"Oall_investments_held_valued_in_accordance_with_valuation_policies_in_prospectus\x18\r \x01(\v2).standards.open.v1.RT000D034.YesNoExplainREallInvestmentsHeldValuedInAccordanceWithValuationPoliciesInProspectus\x12\xb4\x01\n" +
	"]any_funds_invest_material_portion_of_nav_in_assets_or_fdis_valued_at_lower_frequency_than_nav\x18\x0e \x01(\bRManyFundsInvestMaterialPortionOfNavInAssetsOrFdisValuedAtLowerFrequencyThanNav\x12\xd2\x01\n" +
	";instrument_types_valued_at_lower_than_nav_frequency_by_fund\x18\x0f \x03(\v2Y.standards.open.v1.RT000D034.Valuation.InstrumentTypesValuedAtLowerThanNavFrequencyByFundR2instrumentTypesValuedAtLowerThanNavFrequencyByFund\x12\x85\x01\n" +
	"Cany_funds_invested_material_portion_of_nav_in_non_standard_otc_fdis\x18\x10 \x01(\bR8anyFundsInvestedMaterialPortionOfNavInNonStandardOtcFdis\x12\xbd\x01\n" +
	"@funds_investing_material_portion_of_nav_in_non_standard_otc_fdis\x18\x11 \x03(\v2;.standards.open.v1.RT000D034.Valuation.MaxMinExposureByFundR6fundsInvestingMaterialPortionOfNavInNonStandardOtcFdis\x12~\n" +
	">any_funds_invested_material_portion_of_nav_haircut_investments\x18\x12 \x01(\bR6anyFundsInvestedMaterialPortionOfNavHaircutInvestments\x12\xb6\x01\n" +
	";funds_investing_material_portion_of_nav_haircut_investments\x18\x13 \x03(\v2;.standards.open.v1.RT000D034.Valuation.MaxMinExposureByFundR4fundsInvestingMaterialPortionOfNavHaircutInvestments\x12\xb0\x01\n" +
	"Ahaircut_decided_by_mangement_subject_to_appropriate_documentation\x18\x14 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR:haircutDecidedByMangementSubjectToAppropriateDocumentation\x12\x95\x01\n" +
	"Jany_funds_invested_material_portion_of_nav_valuation_uncertain_investments\x18\x15 \x01(\bRAanyFundsInvestedMaterialPortionOfNavValuationUncertainInvestments\x12\xcd\x01\n" +
	"Gfunds_investing_material_portion_of_nav_valuation_uncertain_investments\x18\x16 \x03(\v2;.standards.open.v1.RT000D034.Valuation.MaxMinExposureByFundR?fundsInvestingMaterialPortionOfNavValuationUncertainInvestments\x12\xcf\x01\n" +
	"Rexperienced_operational_or_it_risk_impacting_nav_determination_across_all_subfunds\x18\x17 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRHexperiencedOperationalOrItRiskImpactingNavDeterminationAcrossAllSubfunds\x12\x9a\x01\n" +
	"*fund_specific_operational_valuation_issues\x18\x18 \x03(\v2>.standards.open.v1.RT000D034.Valuation.FundSpecificExplanationR&fundSpecificOperationalValuationIssues\x12\x9d\x01\n" +
	"7written_valuation_policies_provide_for_liquidity_checks\x18\x19 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR1writtenValuationPoliciesProvideForLiquidityChecks\x12v\n" +
	":any_funds_invested_material_portion_valued_on_stale_prices\x18\x1a \x01(\bR2anyFundsInvestedMaterialPortionValuedOnStalePrices\x12\xac\x01\n" +
	"6funds_invested_material_portion_valued_on_stale_prices\x18\x1b \x03(\v2;.standards.open.v1.RT000D034.Valuation.MaxMinExposureByFundR/fundsInvestedMaterialPortionValuedOnStalePrices\x12\x89\x01\n" +
	"Dany_funds_invested_material_portion_valued_by_non_independent_source\x18\x1c \x01(\bR;anyFundsInvestedMaterialPortionValuedByNonIndependentSource\x12\xbf\x01\n" +
	"@funds_invested_material_portion_valued_by_non_independent_source\x18\x1d \x03(\v2;.standards.open.v1.RT000D034.Valuation.MaxMinExposureByFundR8fundsInvestedMaterialPortionValuedByNonIndependentSource\x12\xc3\x01\n" +
	"Lif_valuation_not_independent_procedures_carried_out_to_ensure_fair_valuation\x18\x1e \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRBifValuationNotIndependentProceduresCarriedOutToEnsureFairValuation\x12t\n" +
	"8management_refused_valuation_provided_by_external_valuer\x18\x1f \x01(\bR2managementRefusedValuationProvidedByExternalValuer\x12\xa4\x01\n" +
	"/instances_management_refused_external_valuation\x18  \x03(\v2>.standards.open.v1.RT000D034.Valuation.InvestmentDetailsByFundR+instancesManagementRefusedExternalValuation\x12]\n" +
	",external_valuer_refused_to_provide_valuation\x18! \x01(\bR'externalValuerRefusedToProvideValuation\x12\x9f\x01\n" +
	"-instances_valuer_refused_to_provide_valuation\x18\" \x03(\v2>.standards.open.v1.RT000D034.Valuation.InvestmentDetailsByFundR(instancesValuerRefusedToProvideValuation\x12\x88\x01\n" +
	"Dany_fund_invested_material_portion_of_nav_in_target_investment_funds\x18# \x01(\bR:anyFundInvestedMaterialPortionOfNavInTargetInvestmentFunds\x12\xae\x01\n" +
	"@target_investment_funds_subject_to_documented_valuation_controls\x18$ \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR9targetInvestmentFundsSubjectToDocumentedValuationControls\x12\x9a\x01\n" +
	"Many_fund_invested_material_portion_in_unquoted_investments_in_audited_company\x18% \x01(\bRCanyFundInvestedMaterialPortionInUnquotedInvestmentsInAuditedCompany\x12\xcd\x01\n" +
	"Qrelied_on_audited_statements_for_material_unquoted_investments_in_audited_company\x18& \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRGreliedOnAuditedStatementsForMaterialUnquotedInvestmentsInAuditedCompany\x12^\n" +
	"-any_fund_sold_investment_at_material_discount\x18' \x01(\bR'anyFundSoldInvestmentAtMaterialDiscount\x12\x9e\x01\n" +
	"-instruments_sold_at_material_discount_by_fund\x18( \x03(\v2>.standards.open.v1.RT000D034.Valuation.InvestmentDetailsByFundR'instrumentsSoldAtMaterialDiscountByFund\x12\xc7\x01\n" +
	"Ndocumented_procedure_in_place_to_ensure_related_party_transactions_arms_length\x18) \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRDdocumentedProcedureInPlaceToEnsureRelatedPartyTransactionsArmsLength\x12o\n" +
	"7all_transactions_on_assets_and_fdis_in_year_arms_length\x18* \x01(\bR.allTransactionsOnAssetsAndFdisInYearArmsLength\x12}\n" +
	"\x1bnon_arms_length_investments\x18+ \x03(\v2>.standards.open.v1.RT000D034.Valuation.InvestmentDetailsByFundR\x18nonArmsLengthInvestments\x12\x97\x01\n" +
	")non_arms_length_investments_related_party\x18, \x03(\v2>.standards.open.v1.RT000D034.Valuation.InvestmentDetailsByFundR$nonArmsLengthInvestmentsRelatedParty\x12\xc1\x01\n" +
	"Knon_arms_length_related_party_transactions_described_in_annual_report_notes\x18- \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRAnonArmsLengthRelatedPartyTransactionsDescribedInAnnualReportNotes\x1a\xb5\n" +
	"\n" +
	",LegalAndRegulatoryValuationRequirementsUCITS\x12\xc5\x01\n" +
	"Mall_transferable_securities_valued_at_market_prices_or_independent_of_issuers\x18\x01 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRCallTransferableSecuritiesValuedAtMarketPricesOrIndependentOfIssuers\x12\xae\x01\n" +
	"Aall_money_market_securities_valued_accurately_on_an_ongoing_basis\x18\x02 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR8allMoneyMarketSecuritiesValuedAccuratelyOnAnOngoingBasis\x12\xbd\x01\n" +
	"Jall_otc_fdi_valued_on_an_ongoing_basis_with_reliable_and_verifiable_prices\x18\x03 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR>allOtcFdiValuedOnAnOngoingBasisWithReliableAndVerifiablePrices\x12\xf6\x01\n" +
	"hall_instruments_in_trash_ratio_valued_on_an_ongoing_basis_using_issuer_information_or_competent_research\x18\x04 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRYallInstrumentsInTrashRatioValuedOnAnOngoingBasisUsingIssuerInformationOrCompetentResearch\x12n\n" +
	"6material_portion_of_nav_in_investments_valued_by_model\x18\x05 \x01(\bR.materialPortionOfNavInInvestmentsValuedByModel\x12\xcd\x01\n" +
	")proportion_of_nav_valued_by_model_by_fund\x18\x06 \x03(\v2v.standards.open.v1.RT000D034.Valuation.LegalAndRegulatoryValuationRequirementsUCITS.ProportionOfNavValuedByModelByFundR\"proportionOfNavValuedByModelByFund\x1a\x92\x01\n" +
	"\"ProportionOfNavValuedByModelByFund\x12\x1b\n" +
	"\tcssf_code\x18\x01 \x01(\tR\bcssfCode\x12\x1b\n" +
	"\tfund_name\x18\x02 \x01(\tR\bfundName\x12\x18\n" +
	"\aminimum\x18\x03 \x01(\x01R\aminimum\x12\x18\n" +
	"\amaximum\x18\x04 \x01(\x01R\amaximum\x1a\xf4\b\n" +
	"5LegalAndRegulatoryValuationRequirements_UCI_SIF_SICAR\x12r\n" +
	"9all_assets_and_fdis_valued_on_ongoing_basis_at_fair_value\x18\x01 \x01(\bR/allAssetsAndFdisValuedOnOngoingBasisAtFairValue\x12\x97\x01\n" +
	"5all_assets_and_fdis_valued_on_according_to_prospectus\x18\x02 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR-allAssetsAndFdisValuedOnAccordingToProspectus\x12~\n" +
	"?invested_material_portion_of_nav_in_unquoted_assets_or_otc_fdis\x18\x03 \x01(\bR5investedMaterialPortionOfNavInUnquotedAssetsOrOtcFdis\x12\xde\x01\n" +
	"5proportion_of_nav_unquoted_assets_or_otc_fdis_by_fund\x18\x06 \x03(\v2q.standards.open.v1.RT000D034.Valuation.LegalAndRegulatoryValuationRequirements_UCI_SIF_SICAR.MaxMinExposureByFundR,proportionOfNavUnquotedAssetsOrOtcFdisByFund\x12z\n" +
	"<invested_material_portion_of_nav_investments_valued_by_model\x18\a \x01(\bR4investedMaterialPortionOfNavInvestmentsValuedByModel\x12\xc8\x01\n" +
	")proportion_of_nav_valued_by_model_by_fund\x18\b \x03(\v2q.standards.open.v1.RT000D034.Valuation.LegalAndRegulatoryValuationRequirements_UCI_SIF_SICAR.MaxMinExposureByFundR\"proportionOfNavValuedByModelByFund\x1a\x84\x01\n" +
	"\x14MaxMinExposureByFund\x12\x1b\n" +
	"\tcssf_code\x18\x01 \x01(\tR\bcssfCode\x12\x1b\n" +
	"\tfund_name\x18\x02 \x01(\tR\bfundName\x12\x18\n" +
	"\aminimum\x18\x03 \x01(\x01R\aminimum\x12\x18\n" +
	"\amaximum\x18\x04 \x01(\x01R\amaximum\x1a\x91\x01\n" +
	"+LegalAndRegulatoryValuationRequirements_MMF\x12b\n" +
	"\x18all_assets_in_compliance\x18\x01 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR\x15allAssetsInCompliance\x1a\xcd\x01\n" +
	"2InstrumentTypesValuedAtLowerThanNavFrequencyByFund\x12\x1b\n" +
	"\tcssf_code\x18\x01 \x01(\tR\bcssfCode\x12\x1b\n" +
	"\tfund_name\x18\x02 \x01(\tR\bfundName\x12\x18\n" +
	"\aminimum\x18\x03 \x01(\x01R\aminimum\x12\x18\n" +
	"\amaximum\x18\x04 \x01(\x01R\amaximum\x12)\n" +
	"\x10investment_types\x18\x05 \x03(\tR\x0finvestmentTypes\x1a\x84\x01\n" +
	"\x14MaxMinExposureByFund\x12\x1b\n" +
	"\tcssf_code\x18\x01 \x01(\tR\bcssfCode\x12\x1b\n" +
	"\tfund_name\x18\x02 \x01(\tR\bfundName\x12\x18\n" +
	"\aminimum\x18\x03 \x01(\x01R\aminimum\x12\x18\n" +
	"\amaximum\x18\x04 \x01(\x01R\amaximum\x1a\xb3\x01\n" +
	"\x17FundSpecificExplanation\x12\x1b\n" +
	"\tcssf_code\x18\x01 \x01(\tR\bcssfCode\x12\x1b\n" +
	"\tfund_name\x18\x02 \x01(\tR\bfundName\x12\x16\n" +
	"\x06active\x18\x03 \x01(\bR\x06active\x12F\n" +
	" explanation_of_issues_and_impact\x18\x04 \x03(\tR\x1cexplanationOfIssuesAndImpact\x1a\x95\x01\n" +
	"\x17InvestmentDetailsByFund\x12\x1b\n" +
	"\tcssf_code\x18\x01 \x01(\tR\bcssfCode\x12\x1b\n" +
	"\tfund_name\x18\x02 \x01(\tR\bfundName\x12\x1e\n" +
	"\n" +
	"investment\x18\x03 \x01(\tR\n" +
	"investment\x12 \n" +
	"\vexplanation\x18\x04 \x01(\tR\vexplanation\x1a\x84^\n" +
	"\x11NAVDeterminiation\x12@\n" +
	"\x1cadopted_accounting_standards\x18\x01 \x01(\tR\x1aadoptedAccountingStandards\x12\x89\x01\n" +
	"Cconsistent_application_of_accounting_standards_to_nav_determination\x18\x03 \x01(\bR<consistentApplicationOfAccountingStandardsToNavDetermination\x12\x95\x01\n" +
	"3material_changes_disclosed_in_audited_annual_report\x18\x04 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR-materialChangesDisclosedInAuditedAnnualReport\x12\xa7\x01\n" +
	"<documented_assessment_performed_regarding_market_timing_risk\x18\x05 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR6documentedAssessmentPerformedRegardingMarketTimingRisk\x12W\n" +
	"*any_funds_exposed_to_risk_of_market_timing\x18\x06 \x01(\bR#anyFundsExposedToRiskOfMarketTiming\x12\x82\x01\n" +
	"\x1efunds_exposed_to_market_timing\x18\a \x03(\v2>.standards.open.v1.RT000D034.NAVDeterminiation.FundInformationR\x1afundsExposedToMarketTiming\x12\x90\x01\n" +
	"1adequate_measures_in_place_to_avoid_market_timing\x18\b \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR*adequateMeasuresInPlaceToAvoidMarketTiming\x12\xa8\x01\n" +
	">adequate_measures_in_place_to_avoid_market_timing_by_employees\x18\t \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR5adequateMeasuresInPlaceToAvoidMarketTimingByEmployees\x12\x80\x01\n" +
	"(any_instance_of_market_timing_identified\x18\n" +
	" \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR#anyInstanceOfMarketTimingIdentified\x12|\n" +
	"&any_instance_of_market_timing_executed\x18\v \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR!anyInstanceOfMarketTimingExecuted\x12\xc7\x01\n" +
	"Nappropriate_measures_in_place_to_ensure_compliance_with_prospectus_cutoff_time\x18\f \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRDappropriateMeasuresInPlaceToEnsureComplianceWithProspectusCutoffTime\x12\x8d\x01\n" +
	"/instance_of_late_trading_identified_during_year\x18\r \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR)instanceOfLateTradingIdentifiedDuringYear\x12g\n" +
	"2has_any_intermediary_been_appointed_to_market_fund\x18\x0e \x01(\bR+hasAnyIntermediaryBeenAppointedToMarketFund\x12\xbe\x01\n" +
	"Hwritten_confirmation_prohibiting_market_timing_if_intermediary_appointed\x18\x0f \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRAwrittenConfirmationProhibitingMarketTimingIfIntermediaryAppointed\x12\xb1\x01\n" +
	"Bwritten_confirmation_from_intermediary_to_transmit_orders_same_day\x18\x10 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR:writtenConfirmationFromIntermediaryToTransmitOrdersSameDay\x12E\n" +
	" prospectus_allows_for_use_of_adl\x18\x11 \x01(\bR\x1bprospectusAllowsForUseOfAdl\x12\x9e\x01\n" +
	"8prospectus_indicates_circumstances_where_adl_may_be_used\x18\x12 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR1prospectusIndicatesCircumstancesWhereAdlMayBeUsed\x12\x87\x01\n" +
	"+prospectus_discloses_maximum_adl_authorised\x18\x13 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR'prospectusDisclosesMaximumAdlAuthorised\x12\x1f\n" +
	"\vmaximum_adl\x18\x14 \x01(\x01R\n" +
	"maximumAdl\x12\x98\x01\n" +
	"Kprospectus_allows_temporary_increase_in_adl_under_exceptional_circumstances\x18\x15 \x01(\bRCprospectusAllowsTemporaryIncreaseInAdlUnderExceptionalCircumstances\x12\xc4\x01\n" +
	"Kprospectus_discloses_maximum_adl_authorised_under_exceptional_circumstances\x18\x16 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRDprospectusDisclosesMaximumAdlAuthorisedUnderExceptionalCircumstances\x12\\\n" +
	"+maximum_adl_under_exceptional_circumstances\x18\x17 \x01(\x01R'maximumAdlUnderExceptionalCircumstances\x12c\n" +
	"1have_adl_been_applied_to_any_sub_fund_during_year\x18\x18 \x01(\bR(haveAdlBeenAppliedToAnySubFundDuringYear\x12\x89\x01\n" +
	"-are_adl_covered_by_robust_internal_governance\x18\x19 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR'areAdlCoveredByRobustInternalGovernance\x12m\n" +
	"5has_maximum_adl_authorised_been_increased_during_year\x18\x1a \x01(\bR.hasMaximumAdlAuthorisedBeenIncreasedDuringYear\x12\xac\x01\n" +
	"?increase_in_maximum_adl_appropriately_communicated_to_investors\x18\x1b \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR8increaseInMaximumAdlAppropriatelyCommunicatedToInvestors\x12\xa4\x01\n" +
	"<all_funds_in_compliance_with_prospectus_regarding_use_of_adl\x18\x1c \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR3allFundsInComplianceWithProspectusRegardingUseOfAdl\x12\x87\x01\n" +
	",adl_subject_to_periodic_review_by_management\x18\x1d \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR&adlSubjectToPeriodicReviewByManagement\x12G\n" +
	"!prospectus_allows_for_use_of_swpr\x18\x1e \x01(\bR\x1cprospectusAllowsForUseOfSwpr\x12\xa0\x01\n" +
	"9prospectus_indicates_circumstances_where_swpr_may_be_used\x18\x1f \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR2prospectusIndicatesCircumstancesWhereSwprMayBeUsed\x12\x89\x01\n" +
	",prospectus_discloses_maximum_swpr_authorised\x18  \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR(prospectusDisclosesMaximumSwprAuthorised\x12!\n" +
	"\fmaximum_swpr\x18! \x01(\x01R\vmaximumSwpr\x12\x9a\x01\n" +
	"Lprospectus_allows_temporary_increase_in_swpr_under_exceptional_circumstances\x18\" \x01(\bRDprospectusAllowsTemporaryIncreaseInSwprUnderExceptionalCircumstances\x12\xa7\x01\n" +
	"Sprospectus_discloses_max_temporary_increase_in_swpr_under_exceptional_circumstances\x18# \x01(\bRJprospectusDisclosesMaxTemporaryIncreaseInSwprUnderExceptionalCircumstances\x12^\n" +
	",maximum_swpr_under_exceptional_circumstances\x18$ \x01(\x01R(maximumSwprUnderExceptionalCircumstances\x12c\n" +
	"1has_swpr_been_applied_to_any_sub_fund_during_year\x18% \x01(\bR(hasSwprBeenAppliedToAnySubFundDuringYear\x12\x97\x01\n" +
	"4swpr_covered_by_robust_internal_governance_processes\x18& \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR.swprCoveredByRobustInternalGovernanceProcesses\x12J\n" +
	"\"swpr_maximum_increased_during_year\x18' \x01(\bR\x1eswprMaximumIncreasedDuringYear\x12\x9a\x01\n" +
	"6has_maximum_swpr_authorised_been_increased_during_year\x18( \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR/hasMaximumSwprAuthorisedBeenIncreasedDuringYear\x12\x86\x01\n" +
	",if_swpr_applied_were_all_funds_in_compliance\x18) \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR%ifSwprAppliedWereAllFundsInCompliance\x12\x99\x01\n" +
	"6if_swpr_applied_were_policy_subject_to_periodic_review\x18* \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR.ifSwprAppliedWerePolicySubjectToPeriodicReview\x12\x9d\x01\n" +
	"8did_all_funds_comply_with_prospectus_concerning_lock_ups\x18+ \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR0didAllFundsComplyWithProspectusConcerningLockUps\x12T\n" +
	"'prospectus_allows_for_redemption_gating\x18, \x01(\bR#prospectusAllowsForRedemptionGating\x12\x85\x01\n" +
	"*prospectus_states_circumstances_for_gating\x18- \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR&prospectusStatesCircumstancesForGating\x12m\n" +
	"4prospectus_discloses_redemption_threshold_for_gating\x18. \x01(\bR/prospectusDisclosesRedemptionThresholdForGating\x12Y\n" +
	")prospectus_disclosed_redemption_threshold\x18/ \x01(\x01R&prospectusDisclosedRedemptionThreshold\x12\xb5\x01\n" +
	"Zprospectus_allows_management_to_decrease_redemption_threshold_in_exceptional_circumstances\x180 \x01(\bRQprospectusAllowsManagementToDecreaseRedemptionThresholdInExceptionalCircumstances\x12\x99\x01\n" +
	"5prospectus_specifies_time_limit_for_redemption_gating\x181 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR/prospectusSpecifiesTimeLimitForRedemptionGating\x12Z\n" +
	"+has_redemption_gating_been_used_during_year\x182 \x01(\bR%hasRedemptionGatingBeenUsedDuringYear\x12\x9a\x01\n" +
	"5investors_informed_appropriately_of_redemption_gating\x183 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR0investorsInformedAppropriatelyOfRedemptionGating\x12\xd2\x01\n" +
	"Twere_all_funds_in_compliance_with_prospectus_regarding_redemption_gating_during_year\x184 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRIwereAllFundsInComplianceWithProspectusRegardingRedemptionGatingDuringYear\x12^\n" +
	"-number_of_redemption_gatings_used_during_year\x185 \x01(\x05R'numberOfRedemptionGatingsUsedDuringYear\x12b\n" +
	"/number_of_funds_concerned_by_redemption_gatings\x186 \x01(\x05R)numberOfFundsConcernedByRedemptionGatings\x12X\n" +
	")prospectus_allows_for_redemption_deferral\x187 \x01(\bR%prospectusAllowsForRedemptionDeferral\x12\x9d\x01\n" +
	"6prospectus_discloses_redemption_deferral_circumstances\x188 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR2prospectusDisclosesRedemptionDeferralCircumstances\x12\x98\x01\n" +
	"4prospectus_specifies_time_limit_redemption_deferrals\x189 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR/prospectusSpecifiesTimeLimitRedemptionDeferrals\x12L\n" +
	"#have_redemption_deferrals_been_used\x18: \x01(\bR\x1fhaveRedemptionDeferralsBeenUsed\x12\xbb\x01\n" +
	"Gall_funds_in_compliances_with_prospectus_regarding_redemption_deferrals\x18; \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR?allFundsInCompliancesWithProspectusRegardingRedemptionDeferrals\x12f\n" +
	"1number_of_funds_concerned_by_redemption_deferrals\x18< \x01(\x05R+numberOfFundsConcernedByRedemptionDeferrals\x12N\n" +
	"$prospectus_allows_redemption_in_kind\x18= \x01(\bR prospectusAllowsRedemptionInKind\x12E\n" +
	" redemption_in_kind_has_been_used\x18> \x01(\bR\x1bredemptionInKindHasBeenUsed\x12\xb0\x01\n" +
	"1number_of_redemption_in_kind_transactions_by_fund\x18? \x03(\v2I.standards.open.v1.RT000D034.NAVDeterminiation.NumberOfTransactionsByFundR*numberOfRedemptionInKindTransactionsByFund\x12\x88\x01\n" +
	",redemptions_in_kind_complied_with_prospectus\x18@ \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR'redemptionsInKindCompliedWithProspectus\x12\xa3\x01\n" +
	";redemptions_in_kind_subject_to_auditor_report_when_required\x18A \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR3redemptionsInKindSubjectToAuditorReportWhenRequired\x12[\n" +
	",side_pockets_created_by_any_fund_during_year\x18B \x01(\bR%sidePocketsCreatedByAnyFundDuringYear\x12\x8c\x01\n" +
	".created_side_pockets_communicated_to_investors\x18C \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR)createdSidePocketsCommunicatedToInvestors\x12\x82\x01\n" +
	")created_side_pockets_communicated_to_cssf\x18D \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR$createdSidePocketsCommunicatedToCssf\x12J\n" +
	"\"prospectus_allows_for_dual_pricing\x18E \x01(\bR\x1eprospectusAllowsForDualPricing\x12\xba\x01\n" +
	"Gprospectus_indicates_circumstances_under_which_dual_pricing_may_be_used\x18F \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR>prospectusIndicatesCircumstancesUnderWhichDualPricingMayBeUsed\x12P\n" +
	"&dual_pricing_has_been_used_during_year\x18G \x01(\bR dualPricingHasBeenUsedDuringYear\x12\xa9\x01\n" +
	">all_funds_in_compliance_with_prospectus_regarding_dual_pricing\x18H \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR6allFundsInComplianceWithProspectusRegardingDualPricing\x12t\n" +
	"8prospectus_allows_for_temporary_suspension_of_redemption\x18I \x01(\bR2prospectusAllowsForTemporarySuspensionOfRedemption\x12\xd1\x01\n" +
	"Rprospectus_clearly_indicates_circumstances_for_temporary_suspension_of_redemptions\x18J \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRJprospectusClearlyIndicatesCircumstancesForTemporarySuspensionOfRedemptions\x12j\n" +
	"3have_temporary_suspensions_of_redemptions_been_used\x18K \x01(\bR-haveTemporarySuspensionsOfRedemptionsBeenUsed\x12\xd5\x01\n" +
	"Uall_funds_in_compliance_with_prospectus_regarding_temporary_suspension_of_redemptions\x18L \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRKallFundsInComplianceWithProspectusRegardingTemporarySuspensionOfRedemptions\x12\xa6\x01\n" +
	"<all_temporary_suspension_of_redemptions_communicated_to_cssf\x18M \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR5allTemporarySuspensionOfRedemptionsCommunicatedToCssf\x12\xdf\x01\n" +
	"Zall_temporary_suspension_of_redemptions_communicated_to_all_national_competent_authorities\x18N \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRPallTemporarySuspensionOfRedemptionsCommunicatedToAllNationalCompetentAuthorities\x12_\n" +
	"-number_of_temporary_suspension_of_redemptions\x18O \x01(\x05R(numberOfTemporarySuspensionOfRedemptions\x12\x80\x01\n" +
	"?number_of_funds_concerned_by_temporary_suspension_of_redemption\x18P \x01(\x05R7numberOfFundsConcernedByTemporarySuspensionOfRedemption\x12\xbb\x01\n" +
	"Gformalized_policy_covering_treatment_of_material_nav_calculation_errors\x18Q \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR?formalizedPolicyCoveringTreatmentOfMaterialNavCalculationErrors\x12~\n" +
	">number_of_material_nav_calcualtion_errors_detected_during_year\x18R \x01(\x05R6numberOfMaterialNavCalcualtionErrorsDetectedDuringYear\x12\xb0\x01\n" +
	"Bfund_reported_to_cssf_all_detected_material_nav_calculation_errors\x18S \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR9fundReportedToCssfAllDetectedMaterialNavCalculationErrors\x12[\n" +
	"+prospectus_allows_for_contributions_in_kind\x18T \x01(\bR&prospectusAllowsForContributionsInKind\x12b\n" +
	"/fund_received_contributions_in_kind_during_year\x18U \x01(\bR)fundReceivedContributionsInKindDuringYear\x12\x9d\x01\n" +
	"'number_of_contributions_in_kind_by_fund\x18V \x03(\v2I.standards.open.v1.RT000D034.NAVDeterminiation.NumberOfTransactionsByFundR!numberOfContributionsInKindByFund\x12\x93\x01\n" +
	"2all_contributions_in_kind_complied_with_prospectus\x18W \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR,allContributionsInKindCompliedWithProspectus\x12\xbc\x01\n" +
	"Iall_contributions_in_kind_subject_to_report_issued_by_auditor_if_required\x18X \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR>allContributionsInKindSubjectToReportIssuedByAuditorIfRequired\x1aK\n" +
	"\x0fFundInformation\x12\x1b\n" +
	"\tcssf_code\x18\x01 \x01(\tR\bcssfCode\x12\x1b\n" +
	"\tfund_name\x18\x02 \x01(\tR\bfundName\x1a\x8c\x01\n" +
	"\x1aNumberOfTransactionsByFund\x12\x1b\n" +
	"\tcssf_code\x18\x01 \x01(\tR\bcssfCode\x12\x1b\n" +
	"\tfund_name\x18\x02 \x01(\tR\bfundName\x124\n" +
	"\x16number_of_transactions\x18\x03 \x01(\x05R\x14numberOfTransactions\x1a\x9c=\n" +
	"\x11ExpensesAndIncome\x12\xb4\x01\n" +
	"[all_costs_and_fees_charged_corresponded_to_chargeable_service_in_accordance_with_prospectus\x18\x01 \x01(\bROallCostsAndFeesChargedCorrespondedToChargeableServiceInAccordanceWithProspectus\x12\xd3\x01\n" +
	"Mcosts_or_fees_not_corresponding_to_chargeable_service_charged_to_all_subfunds\x18\x02 \x03(\v28.standards.open.v1.RT000D034.ExpensesAndIncome.CostOrFeeRBcostsOrFeesNotCorrespondingToChargeableServiceChargedToAllSubfunds\x12\xe9\x01\n" +
	"Rcosts_or_fees_not_corresponding_to_chargeable_service_charged_to_specific_subfunds\x18\x03 \x03(\v2D.standards.open.v1.RT000D034.ExpensesAndIncome.FundSpecificCostOrFeeRGcostsOrFeesNotCorrespondingToChargeableServiceChargedToSpecificSubfunds\x12\x7f\n" +
	"?all_costs_and_fees_calculated_and_booked_comply_with_prospectus\x18\x04 \x01(\bR6allCostsAndFeesCalculatedAndBookedComplyWithProspectus\x12\xde\x01\n" +
	"Scosts_and_fees_calculated_and_booked_comply_with_prospectus_charged_to_all_subfunds\x18\x05 \x03(\v28.standards.open.v1.RT000D034.ExpensesAndIncome.CostOrFeeRGcostsAndFeesCalculatedAndBookedComplyWithProspectusChargedToAllSubfunds\x12\xf4\x01\n" +
	"Xcosts_and_fees_calculated_and_booked_comply_with_prospectus_charged_to_specific_subfunds\x18\x06 \x03(\v2D.standards.open.v1.RT000D034.ExpensesAndIncome.FundSpecificCostOrFeeRLcostsAndFeesCalculatedAndBookedComplyWithProspectusChargedToSpecificSubfunds\x12[\n" +
	",all_costs_and_fees_disclosed_in_adequate_way\x18\a \x01(\bR%allCostsAndFeesDisclosedInAdequateWay\x12\xb9\x01\n" +
	"?costs_and_fees_not_adequately_disclosed_charged_to_all_subfunds\x18\b \x03(\v28.standards.open.v1.RT000D034.ExpensesAndIncome.CostOrFeeR6costsAndFeesNotAdequatelyDisclosedChargedToAllSubfunds\x12\xc3\x01\n" +
	"Dcosts_and_fees_not_adequately_disclosed_charged_to_specific_subfunds\x18\t \x03(\v28.standards.open.v1.RT000D034.ExpensesAndIncome.CostOrFeeR;costsAndFeesNotAdequatelyDisclosedChargedToSpecificSubfunds\x12\xd7\x01\n" +
	"Vformal_assessment_performed_to_verify_costs_proportionate_compared_to_market_standards\x18\n" +
	" \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRLformalAssessmentPerformedToVerifyCostsProportionateComparedToMarketStandards\x12\x9e\x01\n" +
	"8formal_assessment_performed_to_verify_no_duplicate_costs\x18\v \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR1formalAssessmentPerformedToVerifyNoDuplicateCosts\x12\xcf\x01\n" +
	"Rformal_assessment_performed_to_verify_effective_service_in_investors_best_interest\x18\f \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRHformalAssessmentPerformedToVerifyEffectiveServiceInInvestorsBestInterest\x12m\n" +
	"\x14fund_expense_rations\x18\r \x03(\v2;.standards.open.v1.RT000D034.ExpensesAndIncome.ExpenseRatioR\x12fundExpenseRations\x12v\n" +
	":expense_ration_of_any_subfund_subject_to_material_increase\x18\x0e \x01(\bR2expenseRationOfAnySubfundSubjectToMaterialIncrease\x12\xa8\x01\n" +
	"*funds_subject_to_material_expense_increase\x18\x0f \x03(\v2M.standards.open.v1.RT000D034.ExpensesAndIncome.MaterialIncreaseInFundExpensesR%fundsSubjectToMaterialExpenseIncrease\x12}\n" +
	"=advisory_fees_supported_superior_to_portfolio_management_fees\x18\x10 \x01(\bR6advisoryFeesSupportedSuperiorToPortfolioManagementFees\x12\xa2\x01\n" +
	"4fund_specific_explanation_for_superior_advisory_fees\x18\x11 \x03(\v24.standards.open.v1.RT000D034.FundSpecificExplanationR.fundSpecificExplanationForSuperiorAdvisoryFees\x12~\n" +
	">carried_interest_to_advisers_greater_than_to_portfolio_manager\x18\x12 \x01(\bR6carriedInterestToAdvisersGreaterThanToPortfolioManager\x12\xb9\x01\n" +
	"@fund_specific_explanation_for_superior_advisory_carried_interest\x18\x13 \x03(\v24.standards.open.v1.RT000D034.FundSpecificExplanationR9fundSpecificExplanationForSuperiorAdvisoryCarriedInterest\x12\x82\x01\n" +
	"@total_transaction_costs_above_materiality_threshold_for_any_fund\x18\x14 \x01(\bR8totalTransactionCostsAboveMaterialityThresholdForAnyFund\x12\x91\x01\n" +
	"\x1ffund_specific_transaction_costs\x18\x15 \x03(\v2J.standards.open.v1.RT000D034.ExpensesAndIncome.FundSpecificTransactionCostR\x1cfundSpecificTransactionCosts\x12y\n" +
	";prospectus_provides_for_performance_fee_or_carried_interest\x18\x16 \x01(\bR4prospectusProvidesForPerformanceFeeOrCarriedInterest\x12\x98\x01\n" +
	"Kperformance_fee_or_carried_interest_prospectus_provisions_correctly_applied\x18\x17 \x01(\bRCperformanceFeeOrCarriedInterestProspectusProvisionsCorrectlyApplied\x12\xb3\x01\n" +
	"=incorrect_applications_of_performance_fee_or_carried_interest\x18\x18 \x03(\v24.standards.open.v1.RT000D034.FundSpecificExplanationR6incorrectApplicationsOfPerformanceFeeOrCarriedInterest\x12\x93\x01\n" +
	"Iperformance_fee_calculation_parameters_in_line_with_prospectus_and_market\x18\x19 \x01(\bR@performanceFeeCalculationParametersInLineWithProspectusAndMarket\x12\xde\x01\n" +
	"Uperformance_fee_calculation_parameters_not_in_line_with_prospectus_and_market_by_fund\x18\x1a \x03(\v24.standards.open.v1.RT000D034.FundSpecificExplanationRIperformanceFeeCalculationParametersNotInLineWithProspectusAndMarketByFund\x12\x98\x01\n" +
	"!fund_specific_performance_charges\x18\x1b \x03(\v2M.standards.open.v1.RT000D034.ExpensesAndIncome.FundSpecificPerformanceChargesR\x1efundSpecificPerformanceCharges\x12\xcf\x01\n" +
	"Qperformance_charge_calculation_method_ensures_alignment_to_investment_performance\x18\x1c \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRIperformanceChargeCalculationMethodEnsuresAlignmentToInvestmentPerformance\x12\x9f\x01\n" +
	"Qdid_any_subfund_invest_more_than_fifty_percent_of_nav_in_reduced_liquidity_assets\x18\x1d \x01(\bRDdidAnySubfundInvestMoreThanFiftyPercentOfNavInReducedLiquidityAssets\x12\x88\x01\n" +
	"Cfor_reduced_liquidity_funds_when_do_performance_charges_crystallize\x18\x1e \x01(\tR;forReducedLiquidityFundsWhenDoPerformanceChargesCrystallize\x12s\n" +
	"!material_income_past_due_interest\x18\x1f \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR\x1dmaterialIncomePastDueInterest\x12u\n" +
	"\"material_income_past_due_principal\x18  \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR\x1ematerialIncomePastDuePrincipal\x12m\n" +
	"\x1ematerial_income_past_due_other\x18! \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR\x1amaterialIncomePastDueOther\x12\x85\x01\n" +
	"*booked_receivable_against_service_provider\x18\" \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR&bookedReceivableAgainstServiceProvider\x12M\n" +
	"$any_epm_sft_transactions_during_year\x18# \x01(\bR\x1fanyEpmSftTransactionsDuringYear\x12\x9b\x01\n" +
	"6epm_sft_comprehensive_assessment_of_adequacy_performed\x18$ \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR0epmSftComprehensiveAssessmentOfAdequacyPerformed\x12v\n" +
	"#epm_sft_concluded_by_best_execution\x18% \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR\x1eepmSftConcludedByBestExecution\x1a\xa8\x01\n" +
	"\x15FundSpecificCostOrFee\x12\x1b\n" +
	"\tcssf_code\x18\x01 \x01(\tR\bcssfCode\x12\x1b\n" +
	"\tfund_name\x18\x02 \x01(\tR\bfundName\x12)\n" +
	"\x10cost_description\x18\x03 \x01(\tR\x0fcostDescription\x12*\n" +
	"\x06amount\x18\x04 \x01(\v2\x12.google.type.MoneyR\x06amount\x1ab\n" +
	"\tCostOrFee\x12)\n" +
	"\x10cost_description\x18\x01 \x01(\tR\x0fcostDescription\x12*\n" +
	"\x06amount\x18\x02 \x01(\v2\x12.google.type.MoneyR\x06amount\x1a\x8f\x05\n" +
	"\fExpenseRatio\x12\x1b\n" +
	"\tcssf_code\x18\x01 \x01(\tR\bcssfCode\x12\x1b\n" +
	"\tfund_name\x18\x02 \x01(\tR\bfundName\x12$\n" +
	"\x0eshare_class_id\x18\x03 \x01(\tR\fshareClassId\x12\x84\x01\n" +
	"\x13share_class_id_type\x18\x04 \x01(\x0e2U.standards.open.v1.RT000D034.ExpensesAndIncome.ExpenseRatio.ShareClassIdentifierTypesR\x10shareClassIdType\x122\n" +
	"\x15share_class_extension\x18\x05 \x01(\tR\x13shareClassExtension\x12)\n" +
	"\x11annual_ter_or_ocr\x18\x06 \x01(\x01R\x0eannualTerOrOcr\x12v\n" +
	"/average_total_nav_of_representative_share_class\x18\a \x01(\v2\x12.google.type.MoneyR)averageTotalNavOfRepresentativeShareClass\x12\x1a\n" +
	"\bcomments\x18\b \x03(\tR\bcomments\"\xa4\x01\n" +
	...
	"\aPERM_ID\x10\n" +
	"\x1a\xa0\x03\n" +
	"\x1eMaterialIncreaseInFundExpenses\x12\x1b\n" +
	"\tcssf_code\x18\x01 \x01(\tR\bcssfCode\x12\x1b\n" +
	"\tfund_name\x18\x02 \x01(\tR\bfundName\x12\x94\x01\n" +
	"\x15cost_increase_reasons\x18\x03 \x03(\x0e2`.standards.open.v1.RT000D034.ExpensesAndIncome.MaterialIncreaseInFundExpenses.CostIncreaseReasonR\x13costIncreaseReasons\x12\x1a\n" +
	"\bcomments\x18\x04 \x01(\tR\bcomments\"\x90\x01\n" +
	"\x12CostIncreaseReason\x12\x16\n" +
	"\x12REASON_UNSPECIFIED\x10\x00\x12*\n" +
	"&CHANGE_IN_COST_STRUCTURE_IN_PROSPECTUS\x10\x01\x12\x13\n" +
	"\x0fDECREASE_IN_NAV\x10\x02\x12\x16\n" +
	"\x12NON_RECURRING_FEES\x10\x03\x12\t\n" +
	"\x05OTHER\x10\x04\x1a\x82\x01\n" +
	"\x1bFundSpecificTransactionCost\x12\x1b\n" +
	"\tcssf_code\x18\x01 \x01(\tR\bcssfCode\x12\x1b\n" +
	"\tfund_name\x18\x02 \x01(\tR\bfundName\x12)\n" +
	"\x10transaction_cost\x18\x03 \x01(\x01R\x0ftransactionCost\x1a\x8f\x03\n" +
	"\x1eFundSpecificPerformanceCharges\x12\x1b\n" +
	"\tcssf_code\x18\x01 \x01(\tR\bcssfCode\x12\x1b\n" +
	"\tfund_name\x18\x02 \x01(\tR\bfundName\x12#\n" +
	"\rbase_currency\x18\x03 \x01(\tR\fbaseCurrency\x12\x16\n" +
	"\x06active\x18\x04 \x01(\bR\x06active\x12]\n" +
	",performance_fee_or_carried_interest_possible\x18\x05 \x01(\bR'performanceFeeOrCarriedInterestPossible\x12[\n" +
	"+performance_fee_or_carried_interest_charged\x18\x06 \x01(\x01R&performanceFeeOrCarriedInterestCharged\x12:\n" +
	"\x1aaverage_total_nav_for_year\x18\a \x01(\x01R\x16averageTotalNavForYear\x1a\xf6p\n" +
	"\x16DepositaryRelationship\x12\xc7\x01\n" +
	"-ucits_and_regulated_aifs_with_authorised_aifm\x18\x01 \x01(\v2g.standards.open.v1.RT000D034.DepositaryRelationship.DepositaryRelationshipUCITSandRegulatedAIFsWithAIFMR'ucitsAndRegulatedAifsWithAuthorisedAifm\x12\xc4\x01\n" +
	"\"registered_aifm_and_regulated_aifs\x18\x02 \x01(\v2x.standards.open.v1.RT000D034.DepositaryRelationship.DepositaryRelationshipRegulatedAIFsRegisteredAIFMAndRegulatedNonAIFsR\x1eregisteredAifmAndRegulatedAifs\x1a\x97B\n" +
	"3DepositaryRelationshipUCITSandRegulatedAIFsWithAIFM\x12\xa3\x01\n" +
	":reconciliation_process_against_depositary_records_in_place\x18\x01 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR4reconciliationProcessAgainstDepositaryRecordsInPlace\x12h\n" +
	"\x1cfrequency_of_reconciliations\x18\x02 \x01(\x0e2&.standards.open.v1.RT000D034.FrequencyR\x1afrequencyOfReconciliations\x12\xa3\x01\n" +
	":frequency_of_reconciliations_consistent_with_nav_frequency\x18\x03 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR4frequencyOfReconciliationsConsistentWithNavFrequency\x12\x9e\x01\n" +
	"7reconciliations_performed_consistent_with_nav_frequency\x18\x04 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR2reconciliationsPerformedConsistentWithNavFrequency\x12\x80\x01\n" +
	"'all_reconciliation_differences_resolved\x18\x05 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR$allReconciliationDifferencesResolved\x12\x85\x01\n" +
	"Cdepositary_confirmed_all_assets_of_fund_that_can_be_held_in_custody\x18\x06 \x01(\bR8depositaryConfirmedAllAssetsOfFundThatCanBeHeldInCustody\x12n\n" +
	"\x19assets_no_held_in_custody\x18\a \x01(\v24.standards.open.v1.RT000D034.FundSpecificExplanationR\x15assetsNoHeldInCustody\x12V\n" +
	")fund_invested_in_other_assets_during_year\x18\b \x01(\bR#fundInvestedInOtherAssetsDuringYear\x12\x8e\x01\n" +
	"/appropriate_asset_registration_process_in_place\x18\t \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR*appropriateAssetRegistrationProcessInPlace\x12w\n" +
	"\"periodical_ownership_verifications\x18\n" +
	" \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR periodicalOwnershipVerifications\x12\x8c\x01\n" +
	"/frequency_of_periodical_ownership_verifications\x18\v \x01(\x0e2&.standards.open.v1.RT000D034.FrequencyR+frequencyOfPeriodicalOwnershipVerifications\x12\xc7\x01\n" +
	"Mfrequency_of_periodical_ownership_verifications_consistent_with_nav_frequency\x18\f \x01(\v2).standards.open.v1.RT000D034.YesNoExplainREfrequencyOfPeriodicalOwnershipVerificationsConsistentWithNavFrequency\x12\xa5\x01\n" +
	";periodical_ownership_verifications_for_non_financial_assets\x18\r \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR5periodicalOwnershipVerificationsForNonFinancialAssets\x12\xba\x01\n" +
	"Hfrequency_of_periodical_ownership_verifications_for_non_financial_assets\x18\x0e \x01(\x0e2&.standards.open.v1.RT000D034.FrequencyR@frequencyOfPeriodicalOwnershipVerificationsForNonFinancialAssets\x12\xe1\x01\n" +
	"[frequency_of_periodical_ownership_verifications_non_financial_consistent_with_nav_frequency\x18\x0f \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRQfrequencyOfPeriodicalOwnershipVerificationsNonFinancialConsistentWithNavFrequency\x12\xad\x01\n" +
	"?all_differences_identified_by_ownership_verifications_explained\x18\x10 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR9allDifferencesIdentifiedByOwnershipVerificationsExplained\x12\xc0\x01\n" +
	"Kprocess_in_place_to_ensure_fund_and_depositary_consistency_for_other_assets\x18\x11 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR@processInPlaceToEnsureFundAndDepositaryConsistencyForOtherAssets\x12\x89\x01\n" +
	".frequency_of_consistency_controls_other_assets\x18\x12 \x01(\x0e2&.standards.open.v1.RT000D034.FrequencyR)frequencyOfConsistencyControlsOtherAssets\x12\xc4\x01\n" +
	"Lfrequency_of_consistency_controls_other_assets_consistent_with_nav_frequency\x18\x13 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRCfrequencyOfConsistencyControlsOtherAssetsConsistentWithNavFrequency\x12\xa3\x01\n" +
	"<frequency_of_consistency_controls_other_non_financial_assets\x18\x14 \x01(\x0e2&.standards.open.v1.RT000D034.FrequencyR5frequencyOfConsistencyControlsOtherNonFinancialAssets\x12\xde\x01\n" +
	"Zfrequency_of_consistency_controls_other_non_financial_assets_consistent_with_nav_frequency\x18\x15 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainROfrequencyOfConsistencyControlsOtherNonFinancialAssetsConsistentWithNavFrequency\x12\xa7\x01\n" +
	"<all_differences_identified_by_consistency_controls_explained\x18\x16 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR6allDifferencesIdentifiedByConsistencyControlsExplained\x12\x96\x01\n" +
	"4depositary_provided_inventory_of_assets_held_by_fund\x18\x17 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR-depositaryProvidedInventoryOfAssetsHeldByFund\x12\x97\x01\n" +
	"4management_notified_of_any_other_asset_discrepancies\x18\x18 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR.managementNotifiedOfAnyOtherAssetDiscrepancies\x12\xc5\x01\n" +
	"emanagement_notified_of_any_escalation_from_depositary_to_ifm_of_discrepancy_not_corrected_in_due_time\x18\x19 \x01(\bRVmanagementNotifiedOfAnyEscalationFromDepositaryToIfmOfDiscrepancyNotCorrectedInDueTime\x12\xe5\x01\n" +
	"_escalation_of_discrepancy_not_corrected_in_due_time_related_to_eligibility_of_third_party_banks\x18\x1a \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRQescalationOfDiscrepancyNotCorrectedInDueTimeRelatedToEligibilityOfThirdPartyBanks\x12\xdd\x01\n" +
	"Zescalation_of_discrepancy_not_corrected_in_due_time_related_to_cash_reconciliation_process\x18\x1b \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRNescalationOfDiscrepancyNotCorrectedInDueTimeRelatedToCashReconciliationProcess\x12\xd5\x01\n" +
	"Vescalation_of_discrepancy_not_corrected_in_due_time_related_to_cash_monitoring_process\x18\x1c \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRJescalationOfDiscrepancyNotCorrectedInDueTimeRelatedToCashMonitoringProcess\x12\xac\x01\n" +
	"Vmanagement_notified_of_any_escalation_from_depositary_regarding_other_oversight_duties\x18\x1d \x01(\bRLmanagementNotifiedOfAnyEscalationFromDepositaryRegardingOtherOversightDuties\x12\xc1\x01\n" +
	"bmanagement_notified_of_any_escalation_from_depositary_to_ifm_related_to_valuation_oversight_duties\x18\x1e \x01(\bRUmanagementNotifiedOfAnyEscalationFromDepositaryToIfmRelatedToValuationOversightDuties\x12\x9e\x01\n" +
	"8escalation_on_oversight_of_valuation_evidence_for_assets\x18\x1f \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR1escalationOnOversightOfValuationEvidenceForAssets\x12\xa6\x01\n" +
	"<escalation_on_oversight_of_valuation_nav_calculation_process\x18  \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR5escalationOnOversightOfValuationNavCalculationProcess\x12\xa2\x01\n" +
	":escalation_on_oversight_of_valuation_nav_calculation_error\x18! \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR3escalationOnOversightOfValuationNavCalculationError\x12\x91\x01\n" +
	"1escalation_on_oversight_of_valuation_other_reason\x18\" \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR+escalationOnOversightOfValuationOtherReason\x12\xe3\x01\n" +
	"tmanagement_notified_of_any_escalation_from_depositary_to_ifm_related_to_subscription_and_redemption_oversight_duties\x18# \x01(\bRemanagementNotifiedOfAnyEscalationFromDepositaryToIfmRelatedToSubscriptionAndRedemptionOversightDuties\x12\xc3\x01\n" +
	"Kescalation_on_oversight_of_subscriptions_and_redemptions_unprocessed_trades\x18$ \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRCescalationOnOversightOfSubscriptionsAndRedemptionsUnprocessedTrades\x12\xd2\x01\n" +
	"Sescalation_on_oversight_of_subscriptions_and_redemptions_cash_reconciliation_issues\x18% \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRJescalationOnOversightOfSubscriptionsAndRedemptionsCashReconciliationIssues\x12\xce\x01\n" +
	"Rescalation_on_oversight_of_subscriptions_and_redemptions_breaks_on_shares_or_units\x18& \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRGescalationOnOversightOfSubscriptionsAndRedemptionsBreaksOnSharesOrUnits\x12\xaa\x01\n" +
	">escalation_on_oversight_of_subscriptions_and_redemptions_other\x18' \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR7escalationOnOversightOfSubscriptionsAndRedemptionsOther\x12\xcf\x01\n" +
	"imanagement_notified_of_any_escalation_from_depositary_to_ifm_related_to_investment_restriction_monitoring\x18( \x01(\bR\\managementNotifiedOfAnyEscalationFromDepositaryToIfmRelatedToInvestmentRestrictionMonitoring\x12\xdc\x01\n" +
	"Yescalation_on_oversight_of_investment_restrictions_breaches_of_legal_and_prospectus_rules\x18) \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRNescalationOnOversightOfInvestmentRestrictionsBreachesOfLegalAndProspectusRules\x12\x9f\x01\n" +
	"8escalation_on_oversight_of_investment_restrictions_other\x18* \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR2escalationOnOversightOfInvestmentRestrictionsOther\x12\xd2\x01\n" +
	"kmanagement_notified_of_any_escalation_from_depositary_to_ifm_related_to_income_calculation_and_distribution\x18+ \x01(\bR]managementNotifiedOfAnyEscalationFromDepositaryToIfmRelatedToIncomeCalculationAndDistribution\x12\xf1\x01\n" +
	"descalation_on_oversight_of_income_calculation_and_distribution_not_processed_according_to_prospectus\x18, \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRXescalationOnOversightOfIncomeCalculationAndDistributionNotProcessedAccordingToProspectus\x12\xd7\x01\n" +
	"Vescalation_on_oversight_of_income_calculation_and_distribution_qualified_audit_opinion\x18- \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRLescalationOnOversightOfIncomeCalculationAndDistributionQualifiedAuditOpinion\x12\xb5\x01\n" +
	"Descalation_on_oversight_of_income_calculation_and_distribution_other\x18. \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR<escalationOnOversightOfIncomeCalculationAndDistributionOther\x12\xd4\x01\n" +
	"Umanagement_notified_of_any_escalation_from_depositary_to_ifm_any_other_irregularities\x18/ \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRJmanagementNotifiedOfAnyEscalationFromDepositaryToIfmAnyOtherIrregularities\x1a\xb0+\n" +
	"DDepositaryRelationshipRegulatedAIFsRegisteredAIFMAndRegulatedNonAIFs\x12\xa3\x01\n" +
	":reconciliation_process_against_depositary_records_in_place\x18\x01 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR4reconciliationProcessAgainstDepositaryRecordsInPlace\x12h\n" +
	"\x1cfrequency_of_reconciliations\x18\x02 \x01(\x0e2&.standards.open.v1.RT000D034.FrequencyR\x1afrequencyOfReconciliations\x12\xa3\x01\n" +
	":frequency_of_reconciliations_consistent_with_nav_frequency\x18\x03 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR4frequencyOfReconciliationsConsistentWithNavFrequency\x12\xbd\x01\n" +
	"Hreconciliations_performed_on_ongoing_basis_consistent_with_nav_frequency\x18\x04 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR@reconciliationsPerformedOnOngoingBasisConsistentWithNavFrequency\x12\x80\x01\n" +
	"'all_reconciliation_differences_resolved\x18\x05 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR$allReconciliationDifferencesResolved\x12\x85\x01\n" +
	"Cdepositary_confirmed_all_assets_of_fund_that_can_be_held_in_custody\x18\x06 \x01(\bR8depositaryConfirmedAllAssetsOfFundThatCanBeHeldInCustody\x12n\n" +
	"\x19assets_no_held_in_custody\x18\a \x01(\v24.standards.open.v1.RT000D034.FundSpecificExplanationR\x15assetsNoHeldInCustody\x12\xf2\x01\n" +
	"ereconciliation_process_against_depositary_records_in_place_for_assets_held_with_third_party_custodian\x18\b \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRXreconciliationProcessAgainstDepositaryRecordsInPlaceForAssetsHeldWithThirdPartyCustodian\x12\x91\x01\n" +
	"2frequency_of_third_party_custodian_reconciliations\x18\t \x01(\x0e2&.standards.open.v1.RT000D034.FrequencyR-frequencyOfThirdPartyCustodianReconciliations\x12\xcc\x01\n" +
	"Pfrequency_of_third_party_custodian_reconciliations_consistent_with_nav_frequency\x18\n" +
	" \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRGfrequencyOfThirdPartyCustodianReconciliationsConsistentWithNavFrequency\x12\xe6\x01\n" +
	"^third_party_custodian_reconciliations_performed_on_ongoing_basis_consistent_with_nav_frequency\x18\v \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRSthirdPartyCustodianReconciliationsPerformedOnOngoingBasisConsistentWithNavFrequency\x12\xc5\x01\n" +
	"Lall_identified_differences_in_third_party_custodian_reconciliations_resolved\x18\f \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRDallIdentifiedDifferencesInThirdPartyCustodianReconciliationsResolved\x12|\n" +
	"=depositary_confirmed_all_assets_held_at_third_party_custodian\x18\r \x01(\bR5depositaryConfirmedAllAssetsHeldAtThirdPartyCustodian\x12\xf0\x01\n" +
	"/asset_types_not_held_with_third_party_custodian\x18\x0e \x03(\v2\x8c\x01.standards.open.v1.RT000D034.DepositaryRelationship.DepositaryRelationshipRegulatedAIFsRegisteredAIFMAndRegulatedNonAIFs.AssetTypeAndDetailsR(assetTypesNotHeldWithThirdPartyCustodian\x12g\n" +
	"2fund_invested_in_assets_qualifying_as_other_assets\x18\x0f \x01(\bR+fundInvestedInAssetsQualifyingAsOtherAssets\x12\x99\x01\n" +
	"5appropriate_other_asset_registration_process_in_place\x18\x10 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR/appropriateOtherAssetRegistrationProcessInPlace\x12\xfe\x01\n" +
	"kperiodical_ownership_verification_based_on_reliable_independent_sources_has_been_performed_for_other_assets\x18\x11 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR^periodicalOwnershipVerificationBasedOnReliableIndependentSourcesHasBeenPerformedForOtherAssets\x12\x8c\x01\n" +
	"/frequency_of_periodical_ownership_verifications\x18\x12 \x01(\x0e2&.standards.open.v1.RT000D034.FrequencyR+frequencyOfPeriodicalOwnershipVerifications\x12\xc7\x01\n" +
	"Mfrequency_of_periodical_ownership_verifications_consistent_with_nav_frequency\x18\x13 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainREfrequencyOfPeriodicalOwnershipVerificationsConsistentWithNavFrequency\x12\x98\x02\n" +
	"yperiodical_ownership_verification_based_on_reliable_independent_sources_has_been_performed_for_non_financial_other_assets\x18\x14 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRjperiodicalOwnershipVerificationBasedOnReliableIndependentSourcesHasBeenPerformedForNonFinancialOtherAssets\x12\xc5\x01\n" +
	"Nfrequency_of_periodical_ownership_verifications_for_non_financial_other_assets\x18\x15 \x01(\x0e2&.standards.open.v1.RT000D034.FrequencyREfrequencyOfPeriodicalOwnershipVerificationsForNonFinancialOtherAssets\x12\x80\x02\n" +
	"lfrequency_of_periodical_ownership_verifications_for_non_financial_other_assets_consistent_with_nav_frequency\x18\x16 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR_frequencyOfPeriodicalOwnershipVerificationsForNonFinancialOtherAssetsConsistentWithNavFrequency\x12\xc2\x01\n" +
	"Jall_differences_identified_by_periodical_ownership_verifications_explained\x18\x17 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainRCallDifferencesIdentifiedByPeriodicalOwnershipVerificationsExplained\x12\xb5\x01\n" +
	"Eprocess_in_place_to_ensure_consistency_of_fund_and_depository_records\x18\x18 \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR;processInPlaceToEnsureConsistencyOfFundAndDepositoryRecords\x12\xa3\x01\n" +
	"<frequency_of_consistency_controls_for_other_financial_assets\x18\x19 \x01(\x0e2&.standards.open.v1.RT000D034.FrequencyR5frequencyOfConsistencyControlsForOtherFinancialAssets\x12\xac\x01\n" +
	"?frequency_of_consistency_controls_consistent_with_nav_frequency\x18\x1a \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR8frequencyOfConsistencyControlsConsistentWithNavFrequency\x12\xaa\x01\n" +
	"@frequency_of_consistency_controls_for_other_non_financial_assets\x18\x1b \x01(\x0e2&.standards.open.v1.RT000D034.FrequencyR8frequencyOfConsistencyControlsForOtherNonFinancialAssets\x12\xa2\x01\n" +
	"9all_differences_identified_consistency_controls_explained\x18\x1c \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR4allDifferencesIdentifiedConsistencyControlsExplained\x12{\n" +
	"%depository_confirmed_all_other_assets\x18\x1d \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR!depositoryConfirmedAllOtherAssets\x12\xb9\x01\n" +
	"Gmanagement_notified_about_any_escalation_from_depository_to_ifm_or_fund\x18\x1e \x01(\v2).standards.open.v1.RT000D034.YesNoExplainR=managementNotifiedAboutAnyEscalationFromDepositoryToIfmOrFund\x1a[\n" +
	"\x13AssetTypeAndDetails\x12\"\n" +
	"\rtype_of_asset\x18\x01 \x01(\tR\vtypeOfAsset\x12 \n" +
	"\vexplanation\x18\x02 \x01(\tR\vexplanation\"\x84\x01\n" +
	"\tFrequency\x12\x19\n" +
	...
	"\fMONEY_MARKET\x10\x03\"\xd2\a\n" +
	"\x0eInstrumentType\x12\x1f\n" +
	"\x1bINSTRUMENT_TYPE_UNSPECIFIED\x10\x00\x12\x1c\n" +
	"\x18MONEY_MARKET_INSTRUMENTS\x10\x01\x12\x19\n" +
	"\x15DEPOSITS_TERM_OR_CASH\x10\x02\x120\n" +
	",REPURCHASE_TRANSACTIONS_REPO_OR_REVERSE_REPO\x10\x03\x12\x16\n" +
	"\x12SECURITIES_LENDING\x10\x04\x12\x13\n" +
	"\x0fLISTED_EQUITIES\x10\x05\x12\x13\n" +
	"\x0fCORPORATE_BONDS\x10\x06\x12!\n" +
	"\x1dGOVERNMENT_OR_MUNICIPAL_BONDS\x10\a\x12'\n" +
	"#REAL_ESTATE_INVESTMENT_TRUSTS_REITS\x10\b\x12\x15\n" +
	"\x11CONVERTIBLE_BONDS\x10\t\x12\x1c\n" +
	"\x18LOANS_OR_PRIVATE_CREDITS\x10\n" +
	"\x12&\n" +
	"\"STRUCTURED_OR_SECURITIZED_PRODUCTS\x10\v\x12\x16\n" +
	"\x12EQUITY_DERIVATIVES\x10\f\x12\x1c\n" +
	"\x18FIXED_INCOME_DERIVATIVES\x10\r\x12\x16\n" +
	"\x12CREDIT_DERIVATIVES\x10\x0e\x12\x12\n" +
	"\x0eFX_DERIVATIVES\x10\x0f\x12\x19\n" +
	"\x15COMMODITY_DERIVATIVES\x10\x10\x12\x15\n" +
	"\x11OTHER_DERIVATIVES\x10\x11\x12\x12\n" +
	"\x0eHEDGE_FUNDS_HF\x10\x12\x12B\n" +
	">REAL_ESTATE_OR_INFRASTRUCTURE_OR_RENEWABLES_DIRECT_OR_INDIRECT\x10\x13\x12%\n" +
	"!PRIVATE_EQUITY_DIRECT_OR_INDIRECT\x10\x14\x12(\n" +
	"$OPEN_ENDED_FUNDS_EXCL_HF_OR_RE_OR_PE\x10\x15\x12)\n" +
	"%CLOSED_ENDED_FUNDS_EXC_HF_OR_RE_OR_PE\x10\x16\x12i\n" +
	"ePHYSICAL_ASSETS_DIRECT_INVESTMENTS_IN_REAL_OR_TANGIBLE_ASSETS_EXCL_RE_OR_INFRASTRUCTURE_OR_RENEWABLES\x10\x17\x12k\n" +
	"gPHYSICAL_ASSETS_INDIRECT_INVESTMENTS_IN_REAL_OR_TANGIBLE_ASSETS_EXCL_RE_OR_INFRASTRUCTURE_OR_RENEWABLES\x10\x18\x12\t\n" +
	"\x05OTHER\x10\x19\"K\n" +
	"\x0fRT000D034_batch\x128\n" +
	"\bresponse\x18\x01 \x03(\v2\x1c.standards.open.v1.RT000D034R\bresponseB(Z&go.alis.build/common/standards/open/v1b\x06proto3"

var (
	file_standards_open_v1_RT000D034_proto_rawDescOnce sync.Once
	file_standards_open_v1_RT000D034_proto_rawDescData []byte
)

func file_standards_open_v1_RT000D034_proto_rawDescGZIP() []byte {
	file_standards_open_v1_RT000D034_proto_rawDescOnce.Do(func() {
		file_standards_open_v1_RT000D034_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_standards_open_v1_RT000D034_proto_rawDesc), len(file_standards_open_v1_RT000D034_proto_rawDesc)))
	})
...
var file_standards_open_v1_RT000D034_proto_goTypes = []any{
...
func file_standards_open_v1_RT000D034_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_standards_open_v1_RT000D034_proto_rawDesc), len(file_standards_open_v1_RT000D034_proto_rawDesc)),
			NumEnums:      8,
			NumMessages:   37,
			NumExtensions: 0,
			NumServices:   0,
