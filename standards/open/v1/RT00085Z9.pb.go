...
const file_standards_open_v1_RT00085Z9_proto_rawDesc = "" +
	"\n" +
	"!standards/open/v1/RT00085Z9.proto\x12\x11standards.open.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x19google/api/resource.proto\x1a\x17google/type/money.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x16google/type/date.proto\"\xfd\xa9\x01\n" +
	"\tRT00085Z9\x12<\n" +
	"\x1afinancial_institution_name\x18\x01 \x01(\tR\x18financialInstitutionName\x12\x18\n" +
	"\acountry\x18\x02 \x01(\tR\acountry\x12a\n" +
	"\x14entity_and_ownership\x18\x03 \x01(\v2/.standards.open.v1.RT00085Z9.EntityAndOwnershipR\x12entityAndOwnership\x12\x82\x01\n" +
	"!aml_and_ctf_and_sanctions_program\x18\x04 \x01(\v29.standards.open.v1.RT00085Z9.AMLAndCTFAndSanctionsProgramR\x1camlAndCtfAndSanctionsProgram\x12t\n" +
	"\x1banti_bribery_and_corruption\x18\x05 \x01(\v25.standards.open.v1.RT00085Z9.AntiBriberyAndCorruptionR\x18antiBriberyAndCorruption\x12\xa7\x01\n" +
	"-aml_ctf_and_sanctions_policies_and_procedures\x18\a \x01(\v2G.standards.open.v1.RT00085Z9.AMLAndCTFAndSanctionsPoliciesAndProceduresR'amlCtfAndSanctionsPoliciesAndProcedures\x12Z\n" +
	"\x13kyc_and_cdd_and_edd\x18\b \x01(\v2,.standards.open.v1.RT00085Z9.KYCAndCDDAndEDDR\x0fkycAndCddAndEdd\x12m\n" +
	"\x18monitoring_and_reporting\x18\t \x01(\v23.standards.open.v1.RT00085Z9.MonitoringAndReportingR\x16monitoringAndReporting\x12c\n" +
	"\x14payment_transparency\x18\n" +
	" \x01(\v20.standards.open.v1.RT00085Z9.PaymentTransparencyR\x13paymentTransparency\x12D\n" +
	"\tsanctions\x18\v \x01(\v2&.standards.open.v1.RT00085Z9.SanctionsR\tsanctions\x12g\n" +
	"\x16training_and_education\x18\f \x01(\v21.standards.open.v1.RT00085Z9.TrainingAndEducationR\x14trainingAndEducation\x128\n" +
	"\x05audit\x18\r \x01(\v2\".standards.open.v1.RT00085Z9.AuditR\x05audit\x1a\xb7\x01\n" +
	"\fYesNoExplain\x12N\n" +
	"\bresponse\x18\x01 \x01(\x0e22.standards.open.v1.RT00085Z9.YesNoExplain.ResponseR\bresponse\x12 \n" +
	...
	"\fYesExplainNo\x12N\n" +
	"\bresponse\x18\x01 \x01(\x0e22.standards.open.v1.RT00085Z9.YesExplainNo.ResponseR\bresponse\x12 \n" +
	"\vexplanation\x18\x02 \x01(\tR\vexplanation\"5\n" +
	"\bResponse\x12\x18\n" +
	"\x14RESPONSE_UNSPECIFIED\x10\x00\x12\a\n" +
	"\x03YES\x10\x01\x12\x06\n" +
	...
	"\bresponse\x18\x01 \x01(\x0e25.standards.open.v1.RT00085Z9.YesNoAndExplain.ResponseR\bresponse\x12 \n" +
	"\vexplanation\x18\x02 \x01(\tR\vexplanation\"5\n" +
	"\bResponse\x12\x18\n" +
	"\x14RESPONSE_UNSPECIFIED\x10\x00\x12\a\n" +
	"\x03YES\x10\x01\x12\x06\n" +
	...
	"\tsignature\x18\x03 \x01(\tR\tsignature\x1a\xd3\x15\n" +
	"\x12EntityAndOwnership\x12\x1d\n" +
	"\n" +
	"legal_name\x18\x01 \x01(\tR\tlegalName\x12a\n" +
	"\x10covered_branches\x18\x02 \x03(\v26.standards.open.v1.RT00085Z9.EntityAndOwnership.BranchR\x0fcoveredBranches\x12#\n" +
	...
	"\x0fownership_types\x18\x06 \x01(\x0e2=.standards.open.v1.RT00085Z9.EntityAndOwnership.OwnershipTypeR\x0eownershipTypes\x12y\n" +
	"\x13security_identifier\x18\a \x01(\v2H.standards.open.v1.RT00085Z9.EntityAndOwnership.TradedSecurityIdentifierR\x12securityIdentifier\x12\x81\x01\n" +
	"\x18significant_shareholders\x18\b \x03(\v2F.standards.open.v1.RT00085Z9.EntityAndOwnership.SignificantShareholderR\x17significantShareholders\x12R\n" +
	"\x0fstructure_chart\x18\t \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR\x0estructureChart\x122\n" +
	...
	"'branches_under_offshore_banking_license\x18\f \x03(\v26.standards.open.v1.RT00085Z9.EntityAndOwnership.BranchR#branchesUnderOffshoreBankingLicense\x1aE\n" +
	"\x06Branch\x12\x1f\n" +
	"\vbranch_name\x18\x01 \x01(\tR\n" +
	"branchName\x12\x1a\n" +
	"\blocation\x18\x02 \x01(\tR\blocation\x1a\xaa\x02\n" +
	"\x18TradedSecurityIdentifier\x12\x99\x01\n" +
	"\x14financial_identifier\x18\x04 \x01(\x0e2f.standards.open.v1.RT00085Z9.EntityAndOwnership.TradedSecurityIdentifier.FinancialInstrumentIdentifierR\x13financialIdentifier\x12\x1e\n" +
	"\n" +
	...
	"\x15beneficial_owner_type\x18\x02 \x01(\x0e2Z.standards.open.v1.RT00085Z9.EntityAndOwnership.SignificantShareholder.BeneficialOwnerTypeR\x13beneficialOwnerType\x121\n" +
	"\x14beneficial_ownership\x18\x03 \x01(\x01R\x13beneficialOwnership\x12\x9d\x01\n" +
	" natural_person_ownership_details\x18\x04 \x01(\v2T.standards.open.v1.RT00085Z9.EntityAndOwnership.SignificantShareholder.NaturalPersonR\x1dnaturalPersonOwnershipDetails\x12\x97\x01\n" +
	"\x1elegal_entity_ownership_details\x18\x05 \x01(\v2R.standards.open.v1.RT00085Z9.EntityAndOwnership.SignificantShareholder.LegalEntityR\x1blegalEntityOwnershipDetails\x1a\xe3\x01\n" +
	...
	"\x15directors_or_managers\x18\x04 \x03(\v2T.standards.open.v1.RT00085Z9.EntityAndOwnership.SignificantShareholder.NaturalPersonR\x13directorsOrManagers\x12d\n" +
	"\x0eownership_type\x18\x06 \x01(\x0e2=.standards.open.v1.RT00085Z9.EntityAndOwnership.OwnershipTypeR\rownershipType\"Q\n" +
	...
	"\aPRIVATE\x10\x04\x1a\xe7\f\n" +
	"\x1cAMLAndCTFAndSanctionsProgram\x12\x89\x01\n" +
	",appointed_officer_with_sufficient_experience\x18\x02 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR(appointedOfficerWithSufficientExperience\x12P\n" +
	"\x0ecash_reporting\x18\x03 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR\rcashReporting\x12;\n" +
	"\x03CDD\x18\x04 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR\x03CDD\x12;\n" +
	"\x03EDD\x18\x05 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR\x03EDD\x12\\\n" +
	"\x14beneficial_ownership\x18\x06 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR\x13beneficialOwnership\x12Z\n" +
	"\x13independent_testing\x18\a \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR\x12independentTesting\x12R\n" +
	"\x0fperiodic_review\x18\b \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR\x0eperiodicReview\x12a\n" +
	"\x17policies_and_procedures\x18\t \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR\x15policiesAndProcedures\x12R\n" +
	"\x0frisk_assessment\x18\n" +
	" \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR\x0eriskAssessment\x12G\n" +
	"\tsanctions\x18\v \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR\tsanctions\x12N\n" +
	"\rpep_screening\x18\f \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR\fpepScreening\x12m\n" +
	"\x1dadverse_information_screening\x18\r \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR\x1badverseInformationScreening\x12m\n" +
	"\x1dsuspicious_activity_reporting\x18\x0e \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR\x1bsuspiciousActivityReporting\x12_\n" +
	"\x16training_and_education\x18\x0f \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR\x14trainingAndEducation\x12`\n" +
	"\x16transaction_monitoring\x18\x10 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR\x15transactionMonitoring\x12\x98\x01\n" +
	"5policy_approved_at_least_annually_by_senior_committee\x18\x11 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR.policyApprovedAtLeastAnnuallyBySeniorCommittee\x12U\n" +
	"\x11use_third_parties\x18\x12 \x01(\v2).standards.open.v1.RT00085Z9.YesExplainNoR\x0fuseThirdParties\x1a\xd9\v\n" +
	"\x18AntiBriberyAndCorruption\x12\xaa\x01\n" +
	">documented_anti_bribery_and_corruption_policies_and_procedures\x18\x01 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR7documentedAntiBriberyAndCorruptionPoliciesAndProcedures\x12\xaf\x01\n" +
	"Aentity_internal_audit_function_covers_abc_policies_and_procedures\x18\x11 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR9entityInternalAuditFunctionCoversAbcPoliciesAndProcedures\x12\xc9\x01\n" +
	"Oentity_provides_mandatory_abc_training_to_board_and_senior_management_committee\x18\x12 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainREentityProvidesMandatoryAbcTrainingToBoardAndSeniorManagementCommittee\x12\xaa\x01\n" +
	"?entity_provides_mandatory_abc_training_to_first_line_of_defence\x18\x13 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR6entityProvidesMandatoryAbcTrainingToFirstLineOfDefence\x12\xac\x01\n" +
	"@entity_provides_mandatory_abc_training_to_second_line_of_defence\x18\x14 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR7entityProvidesMandatoryAbcTrainingToSecondLineOfDefence\x12\xaa\x01\n" +
	"?entity_provides_mandatory_abc_training_to_third_line_of_defence\x18\x15 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR6entityProvidesMandatoryAbcTrainingToThirdLineOfDefence\x12\xc0\x01\n" +
	"Kentity_provides_mandatory_abc_training_to_third_parties_subject_to_abc_risk\x18\x16 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR@entityProvidesMandatoryAbcTrainingToThirdPartiesSubjectToAbcRisk\x12\xc5\x01\n" +
	"Mentity_provides_mandatory_abc_training_to_non_employed_workers_as_appropriate\x18\x17 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainRCentityProvidesMandatoryAbcTrainingToNonEmployedWorkersAsAppropriate\x1a\xcb\x17\n" +
	"*AMLAndCTFAndSanctionsPoliciesAndProcedures\x12\xb1\x01\n" +
	"Bentity_has_documented_policies_and_procedures_for_money_laundering\x18\x01 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR:entityHasDocumentedPoliciesAndProceduresForMoneyLaundering\x12\xb7\x01\n" +
	"Eentity_has_documented_policies_and_procedures_for_terrorist_financing\x18\x02 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR=entityHasDocumentedPoliciesAndProceduresForTerroristFinancing\x12\xb9\x01\n" +
	"Fentity_has_documented_policies_and_procedures_for_sanctions_violations\x18\x03 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR>entityHasDocumentedPoliciesAndProceduresForSanctionsViolations\x12\xcf\x01\n" +
	"Rpolicies_that_prohibit_opening_and_keeping_anonymous_and_fictitious_named_accounts\x18\a \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainRHpoliciesThatProhibitOpeningAndKeepingAnonymousAndFictitiousNamedAccounts\x12\xbd\x01\n" +
	"Ipolicies_that_prohibit_opening_accounts_for_unlicensed_banks_and_or_nbfis\x18\b \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR?policiesThatProhibitOpeningAccountsForUnlicensedBanksAndOrNbfis\x12\xcf\x01\n" +
	"Rpolicies_that_prohibit_dealing_with_entities_providing_banking_to_unlicensed_banks\x18\t \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainRHpoliciesThatProhibitDealingWithEntitiesProvidingBankingToUnlicensedBanks\x12\xaf\x01\n" +
	"Apolicies_that_prohibit_accounts_or_relationships_with_shell_banks\x18\n" +
	" \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR9policiesThatProhibitAccountsOrRelationshipsWithShellBanks\x12\xd9\x01\n" +
	"Xpolicies_that_prohibit_dealing_with_another_entity_that_provides_services_to_shell_banks\x18\v \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainRLpoliciesThatProhibitDealingWithAnotherEntityThatProvidesServicesToShellBanks\x12\x9e\x01\n" +
	"8policies_that_prohibit_accounts_for_section_311_entities\x18\f \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR1policiesThatProhibitAccountsForSection311Entities\x12\x97\x02\n" +
	"ypolicies_that_prohibit_accounts_for_unlicensed_or_regulated_remittance_agents_or_exchange_houses_or_money_transfer_agents\x18\r \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainRipoliciesThatProhibitAccountsForUnlicensedOrRegulatedRemittanceAgentsOrExchangeHousesOrMoneyTransferAgents\x12\x98\x01\n" +
	"5policies_that_assess_risks_of_relationships_with_peps\x18\x0e \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR.policiesThatAssessRisksOfRelationshipsWithPeps\x12\xa4\x01\n" +
	";policies_that_define_escalation_process_for_financial_crime\x18\x0f \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR4policiesThatDefineEscalationProcessForFinancialCrime\x12\xa8\x01\n" +
	"=policies_that_specify_how_suspicious_activities_are_escalated\x18\x11 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR6policiesThatSpecifyHowSuspiciousActivitiesAreEscalated\x12\xcc\x01\n" +
	"Qpolicies_that_outline_process_for_screening_for_sanctions_peps_and_negative_media\x18\x12 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainRFpoliciesThatOutlineProcessForScreeningForSanctionsPepsAndNegativeMedia\x12\x89\x01\n" +
	"-entity_had_defined_a_risk_tolerance_statement\x18\x14 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR'entityHadDefinedARiskToleranceStatement\x12~\n" +
	"%entity_has_record_retention_procedure\x18\x15 \x01(\v2,.standards.open.v1.RT00085Z9.YesNoAndExplainR!entityHasRecordRetentionProcedure\x1a\xfe0\n" +
	"\x0fKYCAndCDDAndEDD\x12y\n" +
	"$entity_verifies_identity_of_customer\x18\x01 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR entityVerifiesIdentityOfCustomer\x12\xa0\x01\n" +
	":policies_and_procedures_set_out_when_cdd_must_be_completed\x18\x02 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR1policiesAndProceduresSetOutWhenCddMustBeCompleted\x12\x8d\x01\n" +
	".entity_gathers_ownership_structure_information\x18\x03 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR*entityGathersOwnershipStructureInformation\x12\x95\x01\n" +
	"2entity_gathers_customer_identification_information\x18\x04 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR.entityGathersCustomerIdentificationInformation\x12\x89\x01\n" +
	",entity_gathers_expected_activity_information\x18\x05 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR(entityGathersExpectedActivityInformation\x12\x8a\x01\n" +
	"-entity_gathers_nature_of_business_information\x18\x06 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR(entityGathersNatureOfBusinessInformation\x12\x81\x01\n" +
	"(entity_gathers_product_usage_information\x18\a \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR$entityGathersProductUsageInformation\x12\xa8\x01\n" +
	"=entity_gathers_purpose_and_nature_of_relationship_information\x18\b \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR6entityGathersPurposeAndNatureOfRelationshipInformation\x12\x84\x01\n" +
	"*entity_gathers_source_of_funds_information\x18\t \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR%entityGathersSourceOfFundsInformation\x12\x82\x01\n" +
	"(ultimate_beneficial_ownership_identified\x18\n" +
	" \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR%ultimateBeneficialOwnershipIdentified\x12~\n" +
	"&ultimate_beneficial_ownership_verified\x18\v \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR#ultimateBeneficialOwnershipVerified\x12u\n" +
	"!authorised_signatories_identified\x18\f \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR\x1fauthorisedSignatoriesIdentified\x12g\n" +
	"\x1akey_controllers_identified\x18\r \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR\x18keyControllersIdentified\x12t\n" +
	"!other_relevant_parties_identified\x18\x0e \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR\x1eotherRelevantPartiesIdentified\x12\x97\x01\n" +
	"4due_diligence_process_results_in_risk_classification\x18\x10 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR.dueDiligenceProcessResultsInRiskClassification\x12\xad\x01\n" +
	"?entity_has_risk_based_approach_to_screening_for_pep_connections\x18\x1c \x01(\v2,.standards.open.v1.RT00085Z9.YesNoAndExplainR6entityHasRiskBasedApproachToScreeningForPepConnections\x12\xc6\x01\n" +
	"Lentity_has_escalation_process_for_matches_when_screening_for_pep_connections\x18\x1d \x01(\v2,.standards.open.v1.RT00085Z9.YesNoAndExplainRBentityHasEscalationProcessForMatchesWhenScreeningForPepConnections\x12\xac\x01\n" +
	"@process_to_review_and_update_customer_information_on_kyc_renewal\x18\" \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR7processToReviewAndUpdateCustomerInformationOnKycRenewal\x12\x91\x01\n" +
	"1non_account_customers_restricted_by_fcc_programme\x18% \x01(\v2).standards.open.v1.RT00085Z9.YesExplainNoR+nonAccountCustomersRestrictedByFccProgramme\x12\x93\x01\n" +
	"2non_resident_customers_restricted_by_fcc_programme\x18& \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR,nonResidentCustomersRestrictedByFccProgramme\x12\x91\x01\n" +
	"1shell_banks_customers_restricted_by_fcc_programme\x18' \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR+shellBanksCustomersRestrictedByFccProgramme\x12\x8b\x01\n" +
	".mvts_msb_customers_restricted_by_fcc_programme\x18( \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR(mvtsMsbCustomersRestrictedByFccProgramme\x12\x82\x01\n" +
	")pep_customers_restricted_by_fcc_programme\x18) \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR$pepCustomersRestrictedByFccProgramme\x12\x91\x01\n" +
	"1pep_related_customers_restricted_by_fcc_programme\x18* \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR+pepRelatedCustomersRestrictedByFccProgramme\x12\xa0\x01\n" +
	"9pep_close_associate_customers_restricted_by_fcc_programme\x18+ \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR2pepCloseAssociateCustomersRestrictedByFccProgramme\x12\x9f\x01\n" +
	"8correspondent_bank_customers_restricted_by_fcc_programme\x18, \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR2correspondentBankCustomersRestrictedByFccProgramme\x12\xca\x01\n" +
	"Ncorrespondent_bank_customers_assessment_contains_worlsberg_principles_elements\x18- \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainRGcorrespondentBankCustomersAssessmentContainsWorlsbergPrinciplesElements\x12\xab\x01\n" +
	"?arms_defense_and_military_customers_restricted_by_fcc_programme\x18. \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR7armsDefenseAndMilitaryCustomersRestrictedByFccProgramme\x12\x93\x01\n" +
	"2atomic_power_customers_restricted_by_fcc_programme\x18/ \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR,atomicPowerCustomersRestrictedByFccProgramme\x12\xa1\x01\n" +
	"9extractive_industry_customers_restricted_by_fcc_programme\x180 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR3extractiveIndustryCustomersRestrictedByFccProgramme\x12\xad\x01\n" +
	"@precious_metals_and_stones_customers_restricted_by_fcc_programme\x181 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR8preciousMetalsAndStonesCustomersRestrictedByFccProgramme\x12\xa1\x01\n" +
	"9unregulated_charity_customers_restricted_by_fcc_programme\x182 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR3unregulatedCharityCustomersRestrictedByFccProgramme\x12\x9d\x01\n" +
	"7regulated_charity_customers_restricted_by_fcc_programme\x183 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR1regulatedCharityCustomersRestrictedByFccProgramme\x12\xb8\x01\n" +
	"Fred_light_or_adult_entertainment_customers_restricted_by_fcc_programme\x184 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR=redLightOrAdultEntertainmentCustomersRestrictedByFccProgramme\x12\x82\x01\n" +
	")ngo_customers_restricted_by_fcc_programme\x185 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR$ngoCustomersRestrictedByFccProgramme\x12\x9b\x01\n" +
	"6virtual_currency_cutsomers_restricted_by_fcc_programme\x186 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR0virtualCurrencyCutsomersRestrictedByFccProgramme\x12\x9d\x01\n" +
	"7marijuana_related_customers_restricted_by_fcc_programme\x187 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR1marijuanaRelatedCustomersRestrictedByFccProgramme\x12\xa2\x01\n" +
	":embassy_or_consulate_customers_restricted_by_fcc_programme\x188 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR3embassyOrConsulateCustomersRestrictedByFccProgramme\x12\x8c\x01\n" +
	".gambling_customers_restricted_by_fcc_programme\x189 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR)gamblingCustomersRestrictedByFccProgramme\x12\xaa\x01\n" +
	">payment_service_provider_customers_restricted_by_fcc_programme\x18: \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR7paymentServiceProviderCustomersRestrictedByFccProgramme\x12\x86\x01\n" +
	"+other_customers_restricted_by_fcc_programme\x18; \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR&otherCustomersRestrictedByFccProgramme\x1a\xd3\x06\n" +
	"\x16MonitoringAndReporting\x12m\n" +
	"\x1eentity_has_risk_based_policies\x18\x01 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR\x1aentityHasRiskBasedPolicies\x12\x8d\x01\n" +
	...
	"fentity_has_policies_procedures_processes_to_comply_with_suspicious_transaction_monitoring_requirements\x18\x05 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR[entityHasPoliciesProceduresProcessesToComplyWithSuspiciousTransactionMonitoringRequirements\x12\xb2\x01\n" +
	"Centity_has_policies_procedures_and_processes_to_review_and_escalate\x18\x06 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR:entityHasPoliciesProceduresAndProcessesToReviewAndEscalate\x1a\x80\x05\n" +
	"\x13PaymentTransparency\x12\xa3\x01\n" +
	":entity_adheres_to_wolfsberg_payment_transparency_standards\x18\x01 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR4entityAdheresToWolfsbergPaymentTransparencyStandards\x12\xa7\x01\n" +
	"=policies_and_procedures_to_comply_with_fatf_recommendation_16\x18\x02 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR5policiesAndProceduresToComplyWithFatfRecommendation16\x12\x9e\x01\n" +
	"8policies_and_procedures_to_comply_with_local_regulations\x18\x03 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR1policiesAndProceduresToComplyWithLocalRegulations\x12x\n" +
	":specify_relevant_local_payment_and_transparency_regulation\x18\x04 \x01(\tR4specifyRelevantLocalPaymentAndTransparencyRegulation\x1a\xbb\t\n" +
	"\tSanctions\x12\x8e\x01\n" +
	"/entity_has_management_approved_sanctions_policy\x18\x01 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR*entityHasManagementApprovedSanctionsPolicy\x12\x90\x01\n" +
	"0entity_screens_customers_against_sanctions_lists\x18\x04 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR+entityScreensCustomersAgainstSanctionsLists\x12{\n" +
	...
	"8other_G7_member_country_sanctions_list_used_in_screening\x18\r \x01(\tR0otherG7MemberCountrySanctionsListUsedInScreening\x12\x97\x01\n" +
	"4entity_has_physical_presence_in_sanctioned_countries\x18\x10 \x01(\v2).standards.open.v1.RT00085Z9.YesExplainNoR.entityHasPhysicalPresenceInSanctionedCountries\x1a\x9e\x0e\n" +
	"\x14TrainingAndEducation\x12\xf2\x01\n" +
	"dprovides_mandatory_training_on_identification_and_reporting_of_transaction_to_government_authorities\x18\x01 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainRYprovidesMandatoryTrainingOnIdentificationAndReportingOfTransactionToGovernmentAuthorities\x12\xc7\x01\n" +
	"Nprovides_mandatory_training_on_examples_of_different_types_of_money_laundering\x18\x02 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainRDprovidesMandatoryTrainingOnExamplesOfDifferentTypesOfMoneyLaundering\x12\xce\x01\n" +
	"Qprovides_mandatory_training_on_internal_policies_for_controlling_money_laundering\x18\x03 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainRHprovidesMandatoryTrainingOnInternalPoliciesForControllingMoneyLaundering\x12\x93\x01\n" +
	"2provides_mandatory_training_on_conduct_and_culture\x18\x05 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR,providesMandatoryTrainingOnConductAndCulture\x12\xb3\x01\n" +
	"Cmandatory_training_provided_to_board_and_senior_commitee_management\x18\x06 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR;mandatoryTrainingProvidedToBoardAndSeniorCommiteeManagement\x12\x96\x01\n" +
	"4mandatory_training_provided_to_first_line_of_defence\x18\a \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR-mandatoryTrainingProvidedToFirstLineOfDefence\x12\x98\x01\n" +
	"5mandatory_training_provided_to_second_line_of_defence\x18\b \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR.mandatoryTrainingProvidedToSecondLineOfDefence\x12\x96\x01\n" +
	"4mandatory_training_provided_to_third_line_of_defence\x18\t \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR-mandatoryTrainingProvidedToThirdLineOfDefence\x12\xc4\x01\n" +
	"Lmandatory_training_provided_to_third_parities_to_which_activities_outsourced\x18\n" +
	" \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainRCmandatoryTrainingProvidedToThirdParitiesToWhichActivitiesOutsourced\x12\x95\x01\n" +
	"3mandatory_training_provided_to_non_employed_workers\x18\v \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR-mandatoryTrainingProvidedToNonEmployedWorkers\x1a\xa2\x01\n" +
	"\x05Audit\x12\x98\x01\n" +
	"5entity_has_internal_audit_or_similar_testing_function\x18\x01 \x01(\v2).standards.open.v1.RT00085Z9.YesNoExplainR.entityHasInternalAuditOrSimilarTestingFunction\"K\n" +
	"\x0fRT00085Z9_batch\x128\n" +
	"\bresponse\x18\x01 \x03(\v2\x1c.standards.open.v1.RT00085Z9R\bresponseB(Z&go.alis.build/common/standards/open/v1b\x06proto3"

var (
	file_standards_open_v1_RT00085Z9_proto_rawDescOnce sync.Once
	file_standards_open_v1_RT00085Z9_proto_rawDescData []byte
)

func file_standards_open_v1_RT00085Z9_proto_rawDescGZIP() []byte {
	file_standards_open_v1_RT00085Z9_proto_rawDescOnce.Do(func() {
		file_standards_open_v1_RT00085Z9_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_standards_open_v1_RT00085Z9_proto_rawDesc), len(file_standards_open_v1_RT00085Z9_proto_rawDesc)))
	})
...
var file_standards_open_v1_RT00085Z9_proto_goTypes = []any{
...
func file_standards_open_v1_RT00085Z9_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_standards_open_v1_RT00085Z9_proto_rawDesc), len(file_standards_open_v1_RT00085Z9_proto_rawDesc)),
			NumEnums:      6,
			NumMessages:   21,
			NumExtensions: 0,
			NumServices:   0,
