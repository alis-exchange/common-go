...
type Task struct {
	...
	Metadata      *protobuf.Struct `protobuf:"bytes,7,opt,name=metadata,proto3" json:"metadata,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Part) GetAny() *protobuf.Any {
	if x != nil {
...
type Part_Any struct {
	Any *protobuf.Any `protobuf:"bytes,20,opt,name=any,proto3,oneof"`
}
...
const file_alis_open_agent_v1_agent_proto_rawDesc = "" +
	...
	" DeleteTaskPushNotificationConfig\x12;.alis.open.agent.v1.DeleteTaskPushNotificationConfigRequest\x1a\x16.google.protobuf.Empty\";\xdaA\x04name\x82\xd3\xe4\x93\x02.*,/v1/{name=tasks/*/pushNotificationConfigs/*}B)Z'go.alis.build/common/alis/open/agent/v1b\x06proto3"
...
var file_alis_open_agent_v1_agent_proto_goTypes = []any{
	...
	(*protobuf.Any)(nil),       // 57: google.protobuf.Any
	(*protobuf.Empty)(nil),     // 58: google.protobuf.Empty
}
